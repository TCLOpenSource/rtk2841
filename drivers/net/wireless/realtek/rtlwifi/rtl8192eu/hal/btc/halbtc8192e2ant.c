 ...
 *
 * ************************************************************ */
u32	glcoex_ver_date_8192e_2ant = 20201103;
		...
		IN boolean force_exec, IN u8 type)
{
	...
	case 12: /*FOR MIRACAST RX*/
		...
		break;
	// #ifdef VENDOR_EDIT
	// yifeng.huang@wifi,2020/11/05, [FAT-305354] merge RTK patch to sovle bt stuck
	case 13: 
		halbtc8192e2ant_coex_table(btcoexist, force_exec, 0x5fff5fff, 0x55555555, 0xf0ffffff, 0xb);
		break;
	// #endif /* VENDOR_EDIT */
	default:
		break;
...
void halbtc8192e2ant_action_wifi_multi_port(IN struct btc_coexist *btcoexist)
{
	...
	*/
	// #else /* VENDOR_EDIT */
	halbtc8192e2ant_coex_table_with_type(btcoexist, NORMAL_EXEC, 13);
	// #endif /* VENDOR_EDIT */
}
