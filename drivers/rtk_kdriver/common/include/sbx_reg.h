...
// Firmware Header Generate Date : 2011/2/23 11:14:36
***************************************************************/
...
#define SB1_PRIORITY_1_pcie_mask                                                     (0x00000F00)
#define SB1_PRIORITY_1_pcie(data)                                                    (0x00000F00&((data)<<8))
#define SB1_PRIORITY_1_pcie_src(data)                                                ((0x00000F00&(data))>>8)
#define SB1_PRIORITY_1_get_pcie(data)                                                ((0x00000F00&(data))>>8)
...
#define SB3_PRIORITY_1_vde2_shift                                                    (16)
#define SB3_PRIORITY_1_vde2_mask                                                     (0x000F0000)
#define SB3_PRIORITY_1_vde2(data)                                                    (0x000F0000&((data)<<16))
#define SB3_PRIORITY_1_vde2_src(data)                                                ((0x000F0000&(data))>>16)
#define SB3_PRIORITY_1_get_vde2(data)                                                ((0x000F0000&(data))>>16)
...
#define SB3_PRIORITY_2_me2_shift                                                     (24)
#define SB3_PRIORITY_2_me2_mask                                                      (0x0F000000)
#define SB3_PRIORITY_2_me2(data)                                                     (0x0F000000&((data)<<24))
#define SB3_PRIORITY_2_me2_src(data)                                                 ((0x0F000000&(data))>>24)
#define SB3_PRIORITY_2_get_me2(data)                                                 ((0x0F000000&(data))>>24)
...
#define SB3_CHANNEL_REQ_MASK                                                         0x1801C224
#define SB3_CHANNEL_REQ_MASK_reg_addr                                                "0xB801C224"
#define SB3_CHANNEL_REQ_MASK_reg                                                     0xB801C224
...
#define SB3_CHANNEL_REQ_BUSY                                                         0x1801C228
#define SB3_CHANNEL_REQ_BUSY_reg_addr                                                "0xB801C228"
#define SB3_CHANNEL_REQ_BUSY_reg                                                     0xB801C228
