...
#if 0 // only used in kernel, remove later. TerrenceFC
typedef struct {
...
typedef struct {
	...
	//VIP_SEGPK_ISE SEGPK_ISE;/*row043 Merlin2*/ //mac5p no such feature
...
typedef struct {
	...
	//unsigned char VIP_source;			/*VIP_SOURCE_TIMING*/
	...
	//unsigned char Project_ID;			/*VIP_Customer_Project_ID_ENUM*/
...
#ifdef ENABLE_VIP_VCPU_TO_SCPU
//RPC//	DRV_RPC_SCPU_ISR_INFO_TO_VCPU SCPU_ISRIINFO_TO_VCPU;
#endif
...
#define flag_of_move_from_tv002_struct_to_tv001
