...
#define BLU_LD_GLOBAL_CTRL0_ADDR                   (0x1802c200)
#define BLU_LD_GLOBAL_CTRL1_ADDR                   (0x1802c204)
#define BLU_LD_GLOBAL_CTRL2_ADDR                   (0x1802c208)
#define BLU_LD_GLOBAL_CTRL3_ADDR                   (0x1802c20c)
#define BLU_LD_GLOBAL_CTRL4_ADDR                   (0x1802c210)
#define BLU_LD_GLOBAL_CTRL5_ADDR                   (0x1802c214)
#define BLU_LD_GLOBAL_MAX_CTRL_ADDR                (0x1802c218)
#define BLU_LD_GLOBAL_HIST1_ADDR                   (0x1802c21c)
#define BLU_LD_GLOBAL_HIST2_ADDR                   (0x1802c220)
#define BLU_LD_GLOBAL_HIST3_ADDR                   (0x1802c224)
#define BLU_LD_GLOBAL_HIST4_ADDR                   (0x1802c228)
#define BLU_LD_GLOBAL_HIST5_ADDR                   (0x1802c22c)
#define BLU_LD_GLOBAL_HIST6_ADDR                   (0x1802c230)
#define BLU_LD_GLOBAL_HIST7_ADDR                   (0x1802c234)
#define BLU_LD_GLOBAL_HIST8_ADDR                   (0x1802c238)
#define BLU_LD_DECISION_CTRL1_ADDR                 (0x1802c23c)
#define BLU_LD_DECISION_CTRL2_ADDR                 (0x1802c240)
#define BLU_LD_DECISION_CTRL3_ADDR                 (0x1802c244)
#define BLU_LD_DECISION_CTRL4_ADDR                 (0x1802c248)
#define BLU_LD_DECISION_CTRL5_ADDR                 (0x1802c24c)
#define BLU_LD_SPATIAL_CTRL1_ADDR                  (0x1802c250)
#define BLU_LD_SPATIAL_CTRL2_ADDR                  (0x1802c254)
#define BLU_LD_SPATIAL_CTRL3_ADDR                  (0x1802c258)
#define BLU_LD_TEMPORAL_CTRL1_ADDR                 (0x1802c25c)
#define BLU_LD_TEMPORAL_CTRL2_ADDR                 (0x1802c260)
#define BLU_LD_TEMPORAL_CTRL3_ADDR                 (0x1802c264)
#define BLU_LD_BACKLIGHT_CTRL1_ADDR                (0x1802c268)
#define BLU_LD_DATACOMP_CTRL1_ADDR                 (0x1802c26c)
#define BLU_LD_DATACOMP_CTRL2_ADDR                 (0x1802c270)
#define BLU_LD_INTER_HCTRL1_ADDR                   (0x1802c274)
#define BLU_LD_INTER_HCTRL2_ADDR                   (0x1802c278)
#define BLU_LD_INTER_VCTRL1_ADDR                   (0x1802c27c)
#define BLU_LD_INTER_VCTRL2_ADDR                   (0x1802c280)
#define BLU_LD_VTAB_AP_ADDR                        (0x1802c284)
#define BLU_LD_VTAB_DP_ADDR                        (0x1802c288)
#define BLU_LD_HTAB_AP_ADDR                        (0x1802c28c)
#define BLU_LD_HTAB_DP_ADDR                        (0x1802c290)
#define BLU_LD_SRAM_CTRL_ADDR                      (0x1802c294)
#define BLU_LD_BLIGHT_AP_ADDR                      (0x1802c298)
#define BLU_LD_BLIGHT_DP_ADDR                      (0x1802c29c)
#define BLU_LD_INTER_HTABSEL1_ADDR                 (0x1802c2a0)
#define BLU_LD_INTER_HTABSEL2_ADDR                 (0x1802c2a4)
#define BLU_LD_INTER_HTABSEL3_ADDR                 (0x1802c2a8)
#define BLU_LD_INTER_HTABSEL4_ADDR                 (0x1802c2ac)
#define BLU_LD_INTER_HTABSEL5_ADDR                 (0x1802c2b0)
#define BLU_LD_INTER_HTABSEL6_ADDR                 (0x1802c2b4)
#define BLU_LD_INTER_HTABSEL7_ADDR                 (0x1802c2b8)
#define BLU_LD_INTER_HTABSEL8_ADDR                 (0x1802c2bc)
#define BLU_LD_INTER_VTABSEL1_ADDR                 (0x1802c2c0)
#define BLU_LD_INTER_VTABSEL2_ADDR                 (0x1802c2c4)
#define BLU_LD_INTER_VTABSEL3_ADDR                 (0x1802c2c8)
#define BLU_LD_INTER_VTABSEL4_ADDR                 (0x1802c2cc)
#define BLU_LD_INTER_VTABSEL5_ADDR                 (0x1802c2d0)
#define BLU_LD_INTER_VTABSEL6_ADDR                 (0x1802c2d4)
#define BLU_LD_INTER_VTABSEL7_ADDR                 (0x1802c2d8)
#define BLU_LD_INTER_VTABSEL8_ADDR                 (0x1802c2dc)
#define BLU_LD_DEMO_WINDOW_CTRL0_ADDR              (0x1802c2e0)
#define BLU_LD_DEMO_WINDOW_CTRL1_ADDR              (0x1802c2e4)
...
}ld_decision_ctrl3_RBUS;

typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  ld_decaccess_addr:8;
        RBus_UInt32  res1:23;
        RBus_UInt32  ld_decaccess_en:1;
    };
}ld_decision_ctrl4_RBUS;
