...
#define  OSD_SECURITY_OSD_SECURITY_c5_security_en_shift                          (29)
#define  OSD_SECURITY_OSD_SECURITY_c4_security_en_shift                          (28)
...
#define  OSD_SECURITY_OSD_SECURITY_c5_security_en_mask                           (0x20000000)
#define  OSD_SECURITY_OSD_SECURITY_c4_security_en_mask                           (0x10000000)
...
#define  OSD_SECURITY_OSD_SECURITY_c5_security_en(data)                          (0x20000000&((data)<<29))
#define  OSD_SECURITY_OSD_SECURITY_c4_security_en(data)                          (0x10000000&((data)<<28))
...
#define  OSD_SECURITY_OSD_SECURITY_get_c5_security_en(data)                      ((0x20000000&(data))>>29)
#define  OSD_SECURITY_OSD_SECURITY_get_c4_security_en(data)                      ((0x10000000&(data))>>28)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c5_plane_alpha_en_shift             (29)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c4_plane_alpha_en_shift             (28)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c5_sel_shift                        (20)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c4_sel_shift                        (16)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c5_plane_alpha_en_mask              (0x20000000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c4_plane_alpha_en_mask              (0x10000000)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c5_sel_mask                         (0x00700000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c4_sel_mask                         (0x00070000)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c5_plane_alpha_en(data)             (0x20000000&((data)<<29))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c4_plane_alpha_en(data)             (0x10000000&((data)<<28))
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c5_sel(data)                        (0x00700000&((data)<<20))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_c4_sel(data)                        (0x00070000&((data)<<16))
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_get_c5_plane_alpha_en(data)         ((0x20000000&(data))>>29)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_get_c4_plane_alpha_en(data)         ((0x10000000&(data))>>28)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_get_c5_sel(data)                    ((0x00700000&(data))>>20)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_SEL_get_c4_sel(data)                    ((0x00070000&(data))>>16)
...
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_STA_sta_l1_shift                  (0)
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_STA_sta_l4_mask                   (0x0000F000)
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_STA_sta_l1_mask                   (0x0000000F)
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_STA_sta_l4(data)                  (0x0000F000&((data)<<12))
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_STA_sta_l1(data)                  (0x0000000F&(data))
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_STA_get_sta_l4(data)              ((0x0000F000&(data))>>12)
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_STA_get_sta_l1(data)              (0x0000000F&(data))
...
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_SIZE_size_l1_shift                (0)
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_SIZE_size_l4_mask                 (0x0000F000)
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_SIZE_size_l1_mask                 (0x0000000F)
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_SIZE_size_l4(data)                (0x0000F000&((data)<<12))
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_SIZE_size_l1(data)                (0x0000000F&(data))
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_SIZE_get_size_l4(data)            ((0x0000F000&(data))>>12)
#define  OSD_SECURITY_OSD_SECURITY_LINE_BUFFER_SIZE_get_size_l1(data)            (0x0000000F&(data))
...
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_osdsr5_switch_to_shift            (16)
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_osdsr4_switch_to_shift            (12)
...
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_osdsr5_switch_to_mask             (0x00070000)
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_osdsr4_switch_to_mask             (0x00007000)
...
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_osdsr5_switch_to(data)            (0x00070000&((data)<<16))
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_osdsr4_switch_to(data)            (0x00007000&((data)<<12))
...
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_get_osdsr5_switch_to(data)        ((0x00070000&(data))>>16)
#define  OSD_SECURITY_OSD_SECURITY_GDMA_SWITCH_get_osdsr4_switch_to(data)        ((0x00007000&(data))>>12)
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB                                      0x1802E660
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_reg_addr                             "0xB802E660"
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_reg                                  0xB802E660
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_inst_addr                            "0x0010"
#define  set_OSD_SECURITY_OSD_SECURITY_MIXER_WB_reg(data)                        (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_MIXER_WB_reg)=data)
#define  get_OSD_SECURITY_OSD_SECURITY_MIXER_WB_reg                              (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_MIXER_WB_reg))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_writeback_en_shift                   (4)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_writeback_sel_shift                  (0)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_writeback_en_mask                    (0x00000010)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_writeback_sel_mask                   (0x0000000F)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_writeback_en(data)                   (0x00000010&((data)<<4))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_writeback_sel(data)                  (0x0000000F&(data))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_get_writeback_en(data)               ((0x00000010&(data))>>4)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_WB_get_writeback_sel(data)              (0x0000000F&(data))
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b1_inst_addr                            "0x0011"
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b2_inst_addr                            "0x0012"
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b3_inst_addr                            "0x0013"
...
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4                                      0x1802E67C
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_reg_addr                             "0xB802E67C"
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_reg                                  0xB802E67C
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_inst_addr                            "0x0014"
#define  set_OSD_SECURITY_OSD_SECURITY_MIXER_b4_reg(data)                        (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_MIXER_b4_reg)=data)
#define  get_OSD_SECURITY_OSD_SECURITY_MIXER_b4_reg                              (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_MIXER_b4_reg))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k1_shift                          (24)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k2_shift                          (16)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k3_shift                          (8)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k4_shift                          (0)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k1_mask                           (0x3F000000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k2_mask                           (0x003F0000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k3_mask                           (0x00003F00)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k4_mask                           (0x0000003F)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k1(data)                          (0x3F000000&((data)<<24))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k2(data)                          (0x003F0000&((data)<<16))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k3(data)                          (0x00003F00&((data)<<8))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_b4_k4(data)                          (0x0000003F&(data))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_get_b4_k1(data)                      ((0x3F000000&(data))>>24)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_get_b4_k2(data)                      ((0x003F0000&(data))>>16)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_get_b4_k3(data)                      ((0x00003F00&(data))>>8)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b4_get_b4_k4(data)                      (0x0000003F&(data))

#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5                                      0x1802E680
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_reg_addr                             "0xB802E680"
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_reg                                  0xB802E680
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_inst_addr                            "0x0015"
#define  set_OSD_SECURITY_OSD_SECURITY_MIXER_b5_reg(data)                        (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_MIXER_b5_reg)=data)
#define  get_OSD_SECURITY_OSD_SECURITY_MIXER_b5_reg                              (*((volatile unsigned int*)OSD_SECURITY_OSD_SECURITY_MIXER_b5_reg))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k1_shift                          (24)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k2_shift                          (16)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k3_shift                          (8)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k4_shift                          (0)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k1_mask                           (0x3F000000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k2_mask                           (0x003F0000)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k3_mask                           (0x00003F00)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k4_mask                           (0x0000003F)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k1(data)                          (0x3F000000&((data)<<24))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k2(data)                          (0x003F0000&((data)<<16))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k3(data)                          (0x00003F00&((data)<<8))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_b5_k4(data)                          (0x0000003F&(data))
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_get_b5_k1(data)                      ((0x3F000000&(data))>>24)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_get_b5_k2(data)                      ((0x003F0000&(data))>>16)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_get_b5_k3(data)                      ((0x00003F00&(data))>>8)
#define  OSD_SECURITY_OSD_SECURITY_MIXER_b5_get_b5_k4(data)                      (0x0000003F&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:2;
        RBus_UInt32  c5_security_en:1;
        RBus_UInt32  c4_security_en:1;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:13;
        RBus_UInt32  osdsr5_switch_to:3;
        RBus_UInt32  res2:1;
        RBus_UInt32  osdsr4_switch_to:3;
        RBus_UInt32  res3:1;
...
}osd_security_osd_security_mixer_wb_RBUS;
...
}osd_security_osd_security_mixer_b4_RBUS;
...
}osd_security_osd_security_mixer_b5_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  mixer_en:1;
        RBus_UInt32  mixero1_en:1;
        RBus_UInt32  dummy1802e604_31:30;
    };
}osd_security_osd_security_mixer_ctrl2_RBUS;
