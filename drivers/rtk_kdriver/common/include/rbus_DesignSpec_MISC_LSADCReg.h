/**
* @file rbusMacArthur3-DesignSpec-MISC_LSADCReg.h
...
#ifndef _RBUS_MACARTHUR3_DESIGNSPEC_MISC_LSADC_REG_H_
#define _RBUS_MACARTHUR3_DESIGNSPEC_MISC_LSADC_REG_H_

#include "rbus/rbus_types.h"

/*  MACARTHUR3-DESIGNSPEC-MISC_LSADC Register Address */
