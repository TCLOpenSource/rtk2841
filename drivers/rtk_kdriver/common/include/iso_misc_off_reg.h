...
#define  ISO_MISC_OFF_DUMMY1_reg_shift                                           (0)
#define  ISO_MISC_OFF_DUMMY1_reg_mask                                            (0xFFFFFFFF)
#define  ISO_MISC_OFF_DUMMY1_get_reg(data)                                       (0xFFFFFFFF&(data))
...
#define  ISO_MISC_OFF_DUMMY2_reg_shift                                           (0)
#define  ISO_MISC_OFF_DUMMY2_reg_mask                                            (0xFFFFFFFF)
#define  ISO_MISC_OFF_DUMMY2_get_reg(data)                                       (0xFFFFFFFF&(data))
