...
#define  ISO_MISC_ISR_ddc4_int_shift                                             (14)
...
#define  ISO_MISC_ISR_ddc4_int_mask                                              (0x00004000)
...
#define  ISO_MISC_ISR_ddc4_int(data)                                             (0x00004000&((data)<<14))
...
#define  ISO_MISC_ISR_get_ddc4_int(data)                                         ((0x00004000&(data))>>14)
...
#define  ISO_MISC_DDC_CTRL_ddc_u2r_pin_sel_shift                                 (2)
#define  ISO_MISC_DDC_CTRL_ddc_u2r_en_shift                                      (1)
#define  ISO_MISC_DDC_CTRL_wake_up_shift                                         (0)
#define  ISO_MISC_DDC_CTRL_ddc_u2r_pin_sel_mask                                  (0x00000004)
#define  ISO_MISC_DDC_CTRL_ddc_u2r_en_mask                                       (0x00000002)
#define  ISO_MISC_DDC_CTRL_wake_up_mask                                          (0x00000001)
#define  ISO_MISC_DDC_CTRL_ddc_u2r_pin_sel(data)                                 (0x00000004&((data)<<2))
#define  ISO_MISC_DDC_CTRL_ddc_u2r_en(data)                                      (0x00000002&((data)<<1))
#define  ISO_MISC_DDC_CTRL_wake_up(data)                                         (0x00000001&(data))
#define  ISO_MISC_DDC_CTRL_get_ddc_u2r_pin_sel(data)                             ((0x00000004&(data))>>2)
#define  ISO_MISC_DDC_CTRL_get_ddc_u2r_en(data)                                  ((0x00000002&(data))>>1)
...
#define  ISO_MISC_DUMMY1_reg_shift                                               (0)
#define  ISO_MISC_DUMMY1_reg_mask                                                (0xFFFFFFFF)
#define  ISO_MISC_DUMMY1_reg(data)                                               (0xFFFFFFFF&(data))
#define  ISO_MISC_DUMMY1_get_reg(data)                                           (0xFFFFFFFF&(data))
...
#define  ISO_MISC_DUMMY2_reg_shift                                               (0)
#define  ISO_MISC_DUMMY2_reg_mask                                                (0xFFFFFFFF)
#define  ISO_MISC_DUMMY2_reg(data)                                               (0xFFFFFFFF&(data))
#define  ISO_MISC_DUMMY2_get_reg(data)                                           (0xFFFFFFFF&(data))
