...
#define  MHL_P0_PORT0_MHL3_CTRL                                                  0x1800D700
#define  MHL_P0_PORT0_MHL3_CTRL_reg_addr                                         "0xB800D700"
#define  MHL_P0_PORT0_MHL3_CTRL_reg                                              0xB800D700
#define  MHL_P0_PORT0_MHL3_CTRL_inst_addr                                        "0x0009"
#define  set_MHL_P0_PORT0_MHL3_CTRL_reg(data)                                    (*((volatile unsigned int*)MHL_P0_PORT0_MHL3_CTRL_reg)=data)
#define  get_MHL_P0_PORT0_MHL3_CTRL_reg                                          (*((volatile unsigned int*)MHL_P0_PORT0_MHL3_CTRL_reg))
#define  MHL_P0_PORT0_MHL3_CTRL_rr_sync_clr_shift                                (13)
#define  MHL_P0_PORT0_MHL3_CTRL_debug_sel_shift                                  (10)
#define  MHL_P0_PORT0_MHL3_CTRL_pkt_type_decode_sel_shift                        (8)
#define  MHL_P0_PORT0_MHL3_CTRL_errc_sel_shift                                   (5)
#define  MHL_P0_PORT0_MHL3_CTRL_rr_mode_shift                                    (3)
#define  MHL_P0_PORT0_MHL3_CTRL_dummy_2_shift                                    (2)
#define  MHL_P0_PORT0_MHL3_CTRL_mhl_ver3_24_16_bit_sel_shift                     (1)
#define  MHL_P0_PORT0_MHL3_CTRL_mhl_ver3_en_shift                                (0)
#define  MHL_P0_PORT0_MHL3_CTRL_rr_sync_clr_mask                                 (0x00002000)
#define  MHL_P0_PORT0_MHL3_CTRL_debug_sel_mask                                   (0x00001C00)
#define  MHL_P0_PORT0_MHL3_CTRL_pkt_type_decode_sel_mask                         (0x00000300)
#define  MHL_P0_PORT0_MHL3_CTRL_errc_sel_mask                                    (0x000000E0)
#define  MHL_P0_PORT0_MHL3_CTRL_rr_mode_mask                                     (0x00000018)
#define  MHL_P0_PORT0_MHL3_CTRL_dummy_2_mask                                     (0x00000004)
#define  MHL_P0_PORT0_MHL3_CTRL_mhl_ver3_24_16_bit_sel_mask                      (0x00000002)
#define  MHL_P0_PORT0_MHL3_CTRL_mhl_ver3_en_mask                                 (0x00000001)
#define  MHL_P0_PORT0_MHL3_CTRL_rr_sync_clr(data)                                (0x00002000&((data)<<13))
#define  MHL_P0_PORT0_MHL3_CTRL_debug_sel(data)                                  (0x00001C00&((data)<<10))
#define  MHL_P0_PORT0_MHL3_CTRL_pkt_type_decode_sel(data)                        (0x00000300&((data)<<8))
#define  MHL_P0_PORT0_MHL3_CTRL_errc_sel(data)                                   (0x000000E0&((data)<<5))
#define  MHL_P0_PORT0_MHL3_CTRL_rr_mode(data)                                    (0x00000018&((data)<<3))
#define  MHL_P0_PORT0_MHL3_CTRL_dummy_2(data)                                    (0x00000004&((data)<<2))
#define  MHL_P0_PORT0_MHL3_CTRL_mhl_ver3_24_16_bit_sel(data)                     (0x00000002&((data)<<1))
#define  MHL_P0_PORT0_MHL3_CTRL_mhl_ver3_en(data)                                (0x00000001&(data))
#define  MHL_P0_PORT0_MHL3_CTRL_get_rr_sync_clr(data)                            ((0x00002000&(data))>>13)
#define  MHL_P0_PORT0_MHL3_CTRL_get_debug_sel(data)                              ((0x00001C00&(data))>>10)
#define  MHL_P0_PORT0_MHL3_CTRL_get_pkt_type_decode_sel(data)                    ((0x00000300&(data))>>8)
#define  MHL_P0_PORT0_MHL3_CTRL_get_errc_sel(data)                               ((0x000000E0&(data))>>5)
#define  MHL_P0_PORT0_MHL3_CTRL_get_rr_mode(data)                                ((0x00000018&(data))>>3)
#define  MHL_P0_PORT0_MHL3_CTRL_get_dummy_2(data)                                ((0x00000004&(data))>>2)
#define  MHL_P0_PORT0_MHL3_CTRL_get_mhl_ver3_24_16_bit_sel(data)                 ((0x00000002&(data))>>1)
#define  MHL_P0_PORT0_MHL3_CTRL_get_mhl_ver3_en(data)                            (0x00000001&(data))

#define  MHL_P0_PORT0_MHL3_STATUS                                                0x1800D704
#define  MHL_P0_PORT0_MHL3_STATUS_reg_addr                                       "0xB800D704"
#define  MHL_P0_PORT0_MHL3_STATUS_reg                                            0xB800D704
#define  MHL_P0_PORT0_MHL3_STATUS_inst_addr                                      "0x000A"
#define  set_MHL_P0_PORT0_MHL3_STATUS_reg(data)                                  (*((volatile unsigned int*)MHL_P0_PORT0_MHL3_STATUS_reg)=data)
#define  get_MHL_P0_PORT0_MHL3_STATUS_reg                                        (*((volatile unsigned int*)MHL_P0_PORT0_MHL3_STATUS_reg))
#define  MHL_P0_PORT0_MHL3_STATUS_bits_per_pixel_mode_shift                      (8)
#define  MHL_P0_PORT0_MHL3_STATUS_max_trans_symbol_err_shift                     (7)
#define  MHL_P0_PORT0_MHL3_STATUS_rr_err_shift                                   (6)
#define  MHL_P0_PORT0_MHL3_STATUS_blank_payload_len_err_shift                    (5)
#define  MHL_P0_PORT0_MHL3_STATUS_video_payload_len_err_shift                    (4)
#define  MHL_P0_PORT0_MHL3_STATUS_hdr_err_shift                                  (3)
#define  MHL_P0_PORT0_MHL3_STATUS_packet_trail_gb_err_shift                      (2)
#define  MHL_P0_PORT0_MHL3_STATUS_packet_lead_gb_err_shift                       (1)
#define  MHL_P0_PORT0_MHL3_STATUS_video_gb_err_shift                             (0)
#define  MHL_P0_PORT0_MHL3_STATUS_bits_per_pixel_mode_mask                       (0x00000300)
#define  MHL_P0_PORT0_MHL3_STATUS_max_trans_symbol_err_mask                      (0x00000080)
#define  MHL_P0_PORT0_MHL3_STATUS_rr_err_mask                                    (0x00000040)
#define  MHL_P0_PORT0_MHL3_STATUS_blank_payload_len_err_mask                     (0x00000020)
#define  MHL_P0_PORT0_MHL3_STATUS_video_payload_len_err_mask                     (0x00000010)
#define  MHL_P0_PORT0_MHL3_STATUS_hdr_err_mask                                   (0x00000008)
#define  MHL_P0_PORT0_MHL3_STATUS_packet_trail_gb_err_mask                       (0x00000004)
#define  MHL_P0_PORT0_MHL3_STATUS_packet_lead_gb_err_mask                        (0x00000002)
#define  MHL_P0_PORT0_MHL3_STATUS_video_gb_err_mask                              (0x00000001)
#define  MHL_P0_PORT0_MHL3_STATUS_bits_per_pixel_mode(data)                      (0x00000300&((data)<<8))
#define  MHL_P0_PORT0_MHL3_STATUS_max_trans_symbol_err(data)                     (0x00000080&((data)<<7))
#define  MHL_P0_PORT0_MHL3_STATUS_rr_err(data)                                   (0x00000040&((data)<<6))
#define  MHL_P0_PORT0_MHL3_STATUS_blank_payload_len_err(data)                    (0x00000020&((data)<<5))
#define  MHL_P0_PORT0_MHL3_STATUS_video_payload_len_err(data)                    (0x00000010&((data)<<4))
#define  MHL_P0_PORT0_MHL3_STATUS_hdr_err(data)                                  (0x00000008&((data)<<3))
#define  MHL_P0_PORT0_MHL3_STATUS_packet_trail_gb_err(data)                      (0x00000004&((data)<<2))
#define  MHL_P0_PORT0_MHL3_STATUS_packet_lead_gb_err(data)                       (0x00000002&((data)<<1))
#define  MHL_P0_PORT0_MHL3_STATUS_video_gb_err(data)                             (0x00000001&(data))
#define  MHL_P0_PORT0_MHL3_STATUS_get_bits_per_pixel_mode(data)                  ((0x00000300&(data))>>8)
#define  MHL_P0_PORT0_MHL3_STATUS_get_max_trans_symbol_err(data)                 ((0x00000080&(data))>>7)
#define  MHL_P0_PORT0_MHL3_STATUS_get_rr_err(data)                               ((0x00000040&(data))>>6)
#define  MHL_P0_PORT0_MHL3_STATUS_get_blank_payload_len_err(data)                ((0x00000020&(data))>>5)
#define  MHL_P0_PORT0_MHL3_STATUS_get_video_payload_len_err(data)                ((0x00000010&(data))>>4)
#define  MHL_P0_PORT0_MHL3_STATUS_get_hdr_err(data)                              ((0x00000008&(data))>>3)
#define  MHL_P0_PORT0_MHL3_STATUS_get_packet_trail_gb_err(data)                  ((0x00000004&(data))>>2)
#define  MHL_P0_PORT0_MHL3_STATUS_get_packet_lead_gb_err(data)                   ((0x00000002&(data))>>1)
#define  MHL_P0_PORT0_MHL3_STATUS_get_video_gb_err(data)                         (0x00000001&(data))

#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET                                           0x1800D708
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_reg_addr                                  "0xB800D708"
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_reg                                       0xB800D708
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_inst_addr                                 "0x000B"
#define  set_MHL_P0_PORT0_TMDS_BIT_ERR_DET_reg(data)                             (*((volatile unsigned int*)MHL_P0_PORT0_TMDS_BIT_ERR_DET_reg)=data)
#define  get_MHL_P0_PORT0_TMDS_BIT_ERR_DET_reg                                   (*((volatile unsigned int*)MHL_P0_PORT0_TMDS_BIT_ERR_DET_reg))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_thd_shift                     (16)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_irq_en_shift                      (11)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_reset_shift                       (10)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_period_shift                  (4)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_mode_shift                    (1)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_en_shift                      (0)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_thd_mask                      (0xFFFF0000)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_irq_en_mask                       (0x00000800)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_reset_mask                        (0x00000400)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_period_mask                   (0x000003F0)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_mode_mask                     (0x00000002)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_en_mask                       (0x00000001)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_thd(data)                     (0xFFFF0000&((data)<<16))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_irq_en(data)                      (0x00000800&((data)<<11))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_reset(data)                       (0x00000400&((data)<<10))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_period(data)                  (0x000003F0&((data)<<4))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_mode(data)                    (0x00000002&((data)<<1))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_bit_err_det_en(data)                      (0x00000001&(data))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_get_bit_err_det_thd(data)                 ((0xFFFF0000&(data))>>16)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_get_bit_err_irq_en(data)                  ((0x00000800&(data))>>11)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_get_bit_err_reset(data)                   ((0x00000400&(data))>>10)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_get_bit_err_det_period(data)              ((0x000003F0&(data))>>4)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_get_bit_err_det_mode(data)                ((0x00000002&(data))>>1)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_DET_get_bit_err_det_en(data)                  (0x00000001&(data))

#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS                                        0x1800D70C
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_reg_addr                               "0xB800D70C"
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_reg                                    0xB800D70C
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_inst_addr                              "0x000C"
#define  set_MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_reg(data)                          (*((volatile unsigned int*)MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_reg)=data)
#define  get_MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_reg                                (*((volatile unsigned int*)MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_reg))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_ad_max_shift                      (26)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_ad_min_shift                      (20)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_no_dis_reset_shift                (19)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_thd_shift                 (18)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_shift                     (17)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_cnt_of_shift              (16)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_cnt_shift                 (0)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_ad_max_mask                       (0xFC000000)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_ad_min_mask                       (0x03F00000)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_no_dis_reset_mask                 (0x00080000)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_thd_mask                  (0x00040000)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_mask                      (0x00020000)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_cnt_of_mask               (0x00010000)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_cnt_mask                  (0x0000FFFF)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_ad_max(data)                      (0xFC000000&((data)<<26))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_ad_min(data)                      (0x03F00000&((data)<<20))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_no_dis_reset(data)                (0x00080000&((data)<<19))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_thd(data)                 (0x00040000&((data)<<18))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err(data)                     (0x00020000&((data)<<17))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_cnt_of(data)              (0x00010000&((data)<<16))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_tmds_bit_err_cnt(data)                 (0x0000FFFF&(data))
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_get_tmds_ad_max(data)                  ((0xFC000000&(data))>>26)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_get_tmds_ad_min(data)                  ((0x03F00000&(data))>>20)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_get_tmds_no_dis_reset(data)            ((0x00080000&(data))>>19)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_get_tmds_bit_err_thd(data)             ((0x00040000&(data))>>18)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_get_tmds_bit_err(data)                 ((0x00020000&(data))>>17)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_get_tmds_bit_err_cnt_of(data)          ((0x00010000&(data))>>16)
#define  MHL_P0_PORT0_TMDS_BIT_ERR_STATUS_get_tmds_bit_err_cnt(data)             (0x0000FFFF&(data))

#define  MHL_P0_PORT0_MHL_BIST_CTRL                                              0x1800D710
#define  MHL_P0_PORT0_MHL_BIST_CTRL_reg_addr                                     "0xB800D710"
#define  MHL_P0_PORT0_MHL_BIST_CTRL_reg                                          0xB800D710
#define  MHL_P0_PORT0_MHL_BIST_CTRL_inst_addr                                    "0x000D"
#define  set_MHL_P0_PORT0_MHL_BIST_CTRL_reg(data)                                (*((volatile unsigned int*)MHL_P0_PORT0_MHL_BIST_CTRL_reg)=data)
#define  get_MHL_P0_PORT0_MHL_BIST_CTRL_reg                                      (*((volatile unsigned int*)MHL_P0_PORT0_MHL_BIST_CTRL_reg))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_frame_num_shift                         (24)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_dummy_23_shift                               (23)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_fixed10_align_en_shift                       (22)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_fixed_shift                             (12)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_fix10_inverse_shift                     (11)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_data_align_en_shift                     (10)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_data_align_num_shift                    (8)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_en_shift                                (7)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_pattern_shift                           (5)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_duration_shift                          (4)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_stop_shift                              (3)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_rdm_bypass_shift                        (2)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_cnt_mode_shift                          (1)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_fixed10_align_bypass_shift              (0)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_frame_num_mask                          (0xFF000000)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_dummy_23_mask                                (0x00800000)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_fixed10_align_en_mask                        (0x00400000)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_fixed_mask                              (0x003FF000)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_fix10_inverse_mask                      (0x00000800)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_data_align_en_mask                      (0x00000400)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_data_align_num_mask                     (0x00000300)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_en_mask                                 (0x00000080)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_pattern_mask                            (0x00000060)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_duration_mask                           (0x00000010)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_stop_mask                               (0x00000008)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_rdm_bypass_mask                         (0x00000004)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_cnt_mode_mask                           (0x00000002)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_fixed10_align_bypass_mask               (0x00000001)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_frame_num(data)                         (0xFF000000&((data)<<24))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_dummy_23(data)                               (0x00800000&((data)<<23))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_fixed10_align_en(data)                       (0x00400000&((data)<<22))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_fixed(data)                             (0x003FF000&((data)<<12))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_fix10_inverse(data)                     (0x00000800&((data)<<11))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_data_align_en(data)                     (0x00000400&((data)<<10))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_data_align_num(data)                    (0x00000300&((data)<<8))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_en(data)                                (0x00000080&((data)<<7))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_pattern(data)                           (0x00000060&((data)<<5))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_duration(data)                          (0x00000010&((data)<<4))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_stop(data)                              (0x00000008&((data)<<3))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_rdm_bypass(data)                        (0x00000004&((data)<<2))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_cnt_mode(data)                          (0x00000002&((data)<<1))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_bist_fixed10_align_bypass(data)              (0x00000001&(data))
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_frame_num(data)                     ((0xFF000000&(data))>>24)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_dummy_23(data)                           ((0x00800000&(data))>>23)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_fixed10_align_en(data)                   ((0x00400000&(data))>>22)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_fixed(data)                         ((0x003FF000&(data))>>12)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_fix10_inverse(data)                 ((0x00000800&(data))>>11)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_data_align_en(data)                 ((0x00000400&(data))>>10)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_data_align_num(data)                ((0x00000300&(data))>>8)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_en(data)                            ((0x00000080&(data))>>7)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_pattern(data)                       ((0x00000060&(data))>>5)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_duration(data)                      ((0x00000010&(data))>>4)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_stop(data)                          ((0x00000008&(data))>>3)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_rdm_bypass(data)                    ((0x00000004&(data))>>2)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_cnt_mode(data)                      ((0x00000002&(data))>>1)
#define  MHL_P0_PORT0_MHL_BIST_CTRL_get_bist_fixed10_align_bypass(data)          (0x00000001&(data))

#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT                                           0x1800D714
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_reg_addr                                  "0xB800D714"
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_reg                                       0xB800D714
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_inst_addr                                 "0x000E"
#define  set_MHL_P0_PORT0_MHL_BIST_ERR_CNT_reg(data)                             (*((volatile unsigned int*)MHL_P0_PORT0_MHL_BIST_ERR_CNT_reg)=data)
#define  get_MHL_P0_PORT0_MHL_BIST_ERR_CNT_reg                                   (*((volatile unsigned int*)MHL_P0_PORT0_MHL_BIST_ERR_CNT_reg))
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_fixed10_align_done_shift                  (16)
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_bist_err_cnt_shift                        (0)
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_fixed10_align_done_mask                   (0x00010000)
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_bist_err_cnt_mask                         (0x0000FFFF)
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_fixed10_align_done(data)                  (0x00010000&((data)<<16))
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_bist_err_cnt(data)                        (0x0000FFFF&(data))
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_get_fixed10_align_done(data)              ((0x00010000&(data))>>16)
#define  MHL_P0_PORT0_MHL_BIST_ERR_CNT_get_bist_err_cnt(data)                    (0x0000FFFF&(data))

#define  MHL_P0_PORT0_HDCP_CTRL                                                  0x1800D718
#define  MHL_P0_PORT0_HDCP_CTRL_reg_addr                                         "0xB800D718"
#define  MHL_P0_PORT0_HDCP_CTRL_reg                                              0xB800D718
#define  MHL_P0_PORT0_HDCP_CTRL_inst_addr                                        "0x000F"
#define  set_MHL_P0_PORT0_HDCP_CTRL_reg(data)                                    (*((volatile unsigned int*)MHL_P0_PORT0_HDCP_CTRL_reg)=data)
#define  get_MHL_P0_PORT0_HDCP_CTRL_reg                                          (*((volatile unsigned int*)MHL_P0_PORT0_HDCP_CTRL_reg))
#define  MHL_P0_PORT0_HDCP_CTRL_enc_window_end_shift                             (12)
#define  MHL_P0_PORT0_HDCP_CTRL_dummy_11_10_shift                                (10)
#define  MHL_P0_PORT0_HDCP_CTRL_enc_window_start_shift                           (0)
#define  MHL_P0_PORT0_HDCP_CTRL_enc_window_end_mask                              (0x001FF000)
#define  MHL_P0_PORT0_HDCP_CTRL_dummy_11_10_mask                                 (0x00000C00)
#define  MHL_P0_PORT0_HDCP_CTRL_enc_window_start_mask                            (0x000003FF)
#define  MHL_P0_PORT0_HDCP_CTRL_enc_window_end(data)                             (0x001FF000&((data)<<12))
#define  MHL_P0_PORT0_HDCP_CTRL_dummy_11_10(data)                                (0x00000C00&((data)<<10))
#define  MHL_P0_PORT0_HDCP_CTRL_enc_window_start(data)                           (0x000003FF&(data))
#define  MHL_P0_PORT0_HDCP_CTRL_get_enc_window_end(data)                         ((0x001FF000&(data))>>12)
#define  MHL_P0_PORT0_HDCP_CTRL_get_dummy_11_10(data)                            ((0x00000C00&(data))>>10)
#define  MHL_P0_PORT0_HDCP_CTRL_get_enc_window_start(data)                       (0x000003FF&(data))
...
}mhl_p0_port0_tmds_bit_err_det_RBUS;
...
}mhl_p0_port0_tmds_bit_err_status_RBUS;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  dummy1800d710_23:1;
...
}mhl_p0_port0_mhl_bist_ctrl_RBUS;
...
}mhl_p0_port0_mhl_bist_err_cnt_RBUS;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  dummy1800d718_11_10:2;
        RBus_UInt32  enc_window_start:10;
    };
}mhl_p0_port0_hdcp_ctrl_RBUS;
