...
#define  STB_SC_POL_emcu_bisr_rstn_shift                                         (28)
#define  STB_SC_POL_emcu_bisr_remap_shift                                        (27)
#define  STB_SC_POL_dummy_26_20_shift                                            (20)
...
#define  STB_SC_POL_emcu_bisr_rstn_mask                                          (0x10000000)
#define  STB_SC_POL_emcu_bisr_remap_mask                                         (0x08000000)
#define  STB_SC_POL_dummy_26_20_mask                                             (0x07F00000)
...
#define  STB_SC_POL_emcu_bisr_rstn(data)                                         (0x10000000&((data)<<28))
#define  STB_SC_POL_emcu_bisr_remap(data)                                        (0x08000000&((data)<<27))
#define  STB_SC_POL_dummy_26_20(data)                                            (0x07F00000&((data)<<20))
...
#define  STB_SC_POL_get_emcu_bisr_rstn(data)                                     ((0x10000000&(data))>>28)
#define  STB_SC_POL_get_emcu_bisr_remap(data)                                    ((0x08000000&(data))>>27)
#define  STB_SC_POL_get_dummy_26_20(data)                                        ((0x07F00000&(data))>>20)
...
#define  STB_ST_CTRL0_getn_clk_sel_rbus_shift                                    (31)
#define  STB_ST_CTRL0_getn_rstn_mask_shift                                       (30)
...
#define  STB_ST_CTRL0_getn_clk_sel_rbus_mask                                     (0x80000000)
#define  STB_ST_CTRL0_getn_rstn_mask_mask                                        (0x40000000)
...
#define  STB_ST_CTRL0_getn_clk_sel_rbus(data)                                    (0x80000000&((data)<<31))
#define  STB_ST_CTRL0_getn_rstn_mask(data)                                       (0x40000000&((data)<<30))
...
#define  STB_ST_CTRL0_get_getn_clk_sel_rbus(data)                                ((0x80000000&(data))>>31)
#define  STB_ST_CTRL0_get_getn_rstn_mask(data)                                   ((0x40000000&(data))>>30)
...
#define  STB_ST_CLKEN0_clken_getn_rbus_shift                                     (11)
...
#define  STB_ST_CLKEN0_clken_getn_rbus_mask                                      (0x00000800)
...
#define  STB_ST_CLKEN0_clken_getn_rbus(data)                                     (0x00000800&((data)<<11))
...
#define  STB_ST_CLKEN0_get_clken_getn_rbus(data)                                 ((0x00000800&(data))>>11)
...
#define  STB_ST_SRST2_inst_addr                                                  "0x0025"
...
#define  STB_ST_CLKEN2_inst_addr                                                 "0x0026"
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  dummy18060008_26_20:7;
...
typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  getn_clk_sel_rbus:1;
        RBus_UInt32  getn_rstn_mask:1;
        RBus_UInt32  res1:1;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  porl_host_s_en_n:1;
        RBus_UInt32  at_speed_pll_done:1;
        RBus_UInt32  dummy18060008_26:7;
        RBus_UInt32  emcu_bisr_remap:1;
        RBus_UInt32  emcu_bisr_rstn:1;
        RBus_UInt32  boption_otpclk_rosc:1;
        RBus_UInt32  boption_efuse:1;
