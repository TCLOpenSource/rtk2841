...
#define  MDOMAIN_DISP_DDR_MainCtrl_dummy_shift                                   (22)
...
#define  MDOMAIN_DISP_DDR_MainCtrl_dummy_mask                                    (0x00400000)
...
#define  MDOMAIN_DISP_DDR_MainCtrl_main_single_buffer_select_mask                (0x00000300)
...
#define  MDOMAIN_DISP_DDR_MainCtrl_dummy(data)                                   (0x00400000&((data)<<22))
...
#define  MDOMAIN_DISP_DDR_MainCtrl_main_single_buffer_select(data)               (0x00000300&((data)<<8))
...
#define  MDOMAIN_DISP_DDR_MainCtrl_get_dummy(data)                               ((0x00400000&(data))>>22)
...
#define  MDOMAIN_DISP_DDR_MainCtrl_get_main_single_buffer_select(data)           ((0x00000300&(data))>>8)
...
#define  MDOMAIN_DISP_DDR_MainStatus_main_block_select_mask                      (0x00000030)
...
#define  MDOMAIN_DISP_DDR_MainStatus_main_block_select(data)                     (0x00000030&((data)<<4))
...
#define  MDOMAIN_DISP_DDR_MainStatus_get_main_block_select(data)                 ((0x00000030&(data))>>4)
...
#define  MDOMAIN_DISP_dispm_decomp_irq_en_dummy_shift                            (10)
...
#define  MDOMAIN_DISP_dispm_decomp_irq_en_dummy_mask                             (0xFFFFFC00)
...
#define  MDOMAIN_DISP_dispm_decomp_irq_en_dummy(data)                            (0xFFFFFC00&((data)<<10))
...
#define  MDOMAIN_DISP_dispm_decomp_irq_en_get_dummy(data)                        ((0xFFFFFC00&(data))>>10)
...
#define  MDOMAIN_DISP_dispm_decomp_status_dummy_shift                            (9)
...
#define  MDOMAIN_DISP_dispm_decomp_status_dummy_mask                             (0xFFFFFE00)
...
#define  MDOMAIN_DISP_dispm_decomp_status_dummy(data)                            (0xFFFFFE00&((data)<<9))
...
#define  MDOMAIN_DISP_dispm_decomp_status_get_dummy(data)                        ((0xFFFFFE00&(data))>>9)
...
#define  MDOMAIN_DISP_dispm_comp_decomp_dbg_mux_dummy_shift                      (16)
#define  MDOMAIN_DISP_dispm_comp_decomp_dbg_mux_decomp_debug_mux_shift           (8)
#define  MDOMAIN_DISP_dispm_comp_decomp_dbg_mux_dummy_mask                       (0xFFFF0000)
#define  MDOMAIN_DISP_dispm_comp_decomp_dbg_mux_decomp_debug_mux_mask            (0x0000FF00)
#define  MDOMAIN_DISP_dispm_comp_decomp_dbg_mux_dummy(data)                      (0xFFFF0000&((data)<<16))
#define  MDOMAIN_DISP_dispm_comp_decomp_dbg_mux_decomp_debug_mux(data)           (0x0000FF00&((data)<<8))
#define  MDOMAIN_DISP_dispm_comp_decomp_dbg_mux_get_dummy(data)                  ((0xFFFF0000&(data))>>16)
...
#define  MDOMAIN_DISP_DDR_SubCtrl_sub_single_buffer_select_mask                  (0x00000300)
...
#define  MDOMAIN_DISP_DDR_SubCtrl_sub_single_buffer_select(data)                 (0x00000300&((data)<<8))
...
#define  MDOMAIN_DISP_DDR_SubCtrl_get_sub_single_buffer_select(data)             ((0x00000300&(data))>>8)
...
#define  MDOMAIN_DISP_DDR_SubStatus_sub_block_select_mask                        (0x00000030)
...
#define  MDOMAIN_DISP_DDR_SubStatus_sub_block_select(data)                       (0x00000030&((data)<<4))
...
#define  MDOMAIN_DISP_DDR_SubStatus_get_sub_block_select(data)                   ((0x00000030&(data))>>4)
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res4:1;
        RBus_UInt32  main_single_buffer_select:2;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res2:2;
        RBus_UInt32  main_block_select:2;
        RBus_UInt32  res3:3;
...
typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  dummy180273f4_31_10:22;
...
typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  dummy180273f8_31_9:23;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res5:1;
        RBus_UInt32  sub_single_buffer_select:2;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res2:2;
        RBus_UInt32  sub_block_select:2;
        RBus_UInt32  res3:4;
    };
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  pix_fifo_underflow_clr:1;
        RBus_UInt32  head_error_clr:1;
        RBus_UInt32  dummy180273f4_31:22;
    };
}mdomain_disp_dispm_decomp_irq_en_RBUS;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res2:3;
        RBus_UInt32  decomp_irq:1;
        RBus_UInt32  dummy180273f8_31:23;
    };
}mdomain_disp_dispm_decomp_status_RBUS;
