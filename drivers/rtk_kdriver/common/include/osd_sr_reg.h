...
#define  set_OSD_SR_OSD_SR_1_Hcoeff_reg(data)                                    (*((volatile unsigned int*)OSD_SR_OSD_SR_1_Hcoeff_reg)=data)
#define  get_OSD_SR_OSD_SR_1_Hcoeff_reg                                          (*((volatile unsigned int*)OSD_SR_OSD_SR_1_Hcoeff_reg))
...
#define  set_OSD_SR_OSD_SR_1_Vcoeff_reg(data)                                    (*((volatile unsigned int*)OSD_SR_OSD_SR_1_Vcoeff_reg)=data)
#define  get_OSD_SR_OSD_SR_1_Vcoeff_reg                                          (*((volatile unsigned int*)OSD_SR_OSD_SR_1_Vcoeff_reg))
...
#define  set_OSD_SR_OSD_SR_1_GainY_Ctrl1_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_1_GainY_Ctrl1_reg)=data)
#define  get_OSD_SR_OSD_SR_1_GainY_Ctrl1_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_1_GainY_Ctrl1_reg))
...
#define  set_OSD_SR_OSD_SR_1_GainY_Ctrl2_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_1_GainY_Ctrl2_reg)=data)
#define  get_OSD_SR_OSD_SR_1_GainY_Ctrl2_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_1_GainY_Ctrl2_reg))
...
#define  set_OSD_SR_OSD_SR_1_GainY_Ctrl3_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_1_GainY_Ctrl3_reg)=data)
#define  get_OSD_SR_OSD_SR_1_GainY_Ctrl3_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_1_GainY_Ctrl3_reg))
...
#define  set_OSD_SR_OSD_SR_1_GainY_Ctrl4_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_1_GainY_Ctrl4_reg)=data)
#define  get_OSD_SR_OSD_SR_1_GainY_Ctrl4_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_1_GainY_Ctrl4_reg))
...
#define  OSD_SR_1_UDFLOW_off_line_state_shift                             (1)
#define  OSD_SR_1_UDFLOW_osd_sr_in_udflow_shift                           (0)
#define  OSD_SR_1_UDFLOW_off_line_state_mask                              (0x00000002)
#define  OSD_SR_1_UDFLOW_osd_sr_in_udflow_mask                            (0x00000001)
#define  OSD_SR_1_UDFLOW_off_line_state(data)                             (0x00000002&((data)<<1))
#define  OSD_SR_1_UDFLOW_osd_sr_in_udflow(data)                           (0x00000001&(data))
#define  OSD_SR_1_UDFLOW_get_off_line_state(data)                         ((0x00000002&(data))>>1)
...
#define  set_OSD_SR_OSD_SR_2_Hcoeff_reg(data)                                    (*((volatile unsigned int*)OSD_SR_OSD_SR_2_Hcoeff_reg)=data)
#define  get_OSD_SR_OSD_SR_2_Hcoeff_reg                                          (*((volatile unsigned int*)OSD_SR_OSD_SR_2_Hcoeff_reg))
...
#define  set_OSD_SR_OSD_SR_2_Vcoeff_reg(data)                                    (*((volatile unsigned int*)OSD_SR_OSD_SR_2_Vcoeff_reg)=data)
#define  get_OSD_SR_OSD_SR_2_Vcoeff_reg                                          (*((volatile unsigned int*)OSD_SR_OSD_SR_2_Vcoeff_reg))
...
#define  set_OSD_SR_OSD_SR_2_GainY_Ctrl1_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_2_GainY_Ctrl1_reg)=data)
#define  get_OSD_SR_OSD_SR_2_GainY_Ctrl1_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_2_GainY_Ctrl1_reg))
...
#define  set_OSD_SR_OSD_SR_2_GainY_Ctrl2_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_2_GainY_Ctrl2_reg)=data)
#define  get_OSD_SR_OSD_SR_2_GainY_Ctrl2_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_2_GainY_Ctrl2_reg))
...
#define  set_OSD_SR_OSD_SR_2_GainY_Ctrl3_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_2_GainY_Ctrl3_reg)=data)
#define  get_OSD_SR_OSD_SR_2_GainY_Ctrl3_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_2_GainY_Ctrl3_reg))
...
#define  set_OSD_SR_OSD_SR_2_GainY_Ctrl4_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_2_GainY_Ctrl4_reg)=data)
#define  get_OSD_SR_OSD_SR_2_GainY_Ctrl4_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_2_GainY_Ctrl4_reg))
...
#define  OSD_SR_2_UDFLOW_off_line_state_shift                             (1)
#define  OSD_SR_2_UDFLOW_osd_sr_in_udflow_shift                           (0)
#define  OSD_SR_2_UDFLOW_off_line_state_mask                              (0x00000002)
#define  OSD_SR_2_UDFLOW_osd_sr_in_udflow_mask                            (0x00000001)
#define  OSD_SR_2_UDFLOW_off_line_state(data)                             (0x00000002&((data)<<1))
#define  OSD_SR_2_UDFLOW_osd_sr_in_udflow(data)                           (0x00000001&(data))
#define  OSD_SR_2_UDFLOW_get_off_line_state(data)                         ((0x00000002&(data))>>1)
...
#define  OSD_SR_3_Scaleup_Ctrl0                                           0x18029500
#define  OSD_SR_3_Scaleup_Ctrl0_reg_addr                                  "0xB8029500"
#define  OSD_SR_3_Scaleup_Ctrl0_reg                                       0xB8029500
#define  OSD_SR_3_Scaleup_Ctrl0_inst_addr                                 "0x0024"
...
#define  OSD_SR_3_Scaleup_Ctrl0_v_zoom_en_shift                           (31)
#define  OSD_SR_3_Scaleup_Ctrl0_ver_ini_shift                             (22)
#define  OSD_SR_3_Scaleup_Ctrl0_ver_tap_num_shift                         (20)
#define  OSD_SR_3_Scaleup_Ctrl0_ver_factor_shift                          (0)
#define  OSD_SR_3_Scaleup_Ctrl0_v_zoom_en_mask                            (0x80000000)
#define  OSD_SR_3_Scaleup_Ctrl0_ver_ini_mask                              (0x3FC00000)
#define  OSD_SR_3_Scaleup_Ctrl0_ver_tap_num_mask                          (0x00300000)
#define  OSD_SR_3_Scaleup_Ctrl0_ver_factor_mask                           (0x000FFFFF)
#define  OSD_SR_3_Scaleup_Ctrl0_v_zoom_en(data)                           (0x80000000&((data)<<31))
#define  OSD_SR_3_Scaleup_Ctrl0_ver_ini(data)                             (0x3FC00000&((data)<<22))
#define  OSD_SR_3_Scaleup_Ctrl0_ver_tap_num(data)                         (0x00300000&((data)<<20))
#define  OSD_SR_3_Scaleup_Ctrl0_ver_factor(data)                          (0x000FFFFF&(data))
#define  OSD_SR_3_Scaleup_Ctrl0_get_v_zoom_en(data)                       ((0x80000000&(data))>>31)
#define  OSD_SR_3_Scaleup_Ctrl0_get_ver_ini(data)                         ((0x3FC00000&(data))>>22)
#define  OSD_SR_3_Scaleup_Ctrl0_get_ver_tap_num(data)                     ((0x00300000&(data))>>20)
#define  OSD_SR_3_Scaleup_Ctrl0_get_ver_factor(data)                      (0x000FFFFF&(data))

#define  OSD_SR_3_Scaleup_Ctrl1                                           0x18029504
#define  OSD_SR_3_Scaleup_Ctrl1_reg_addr                                  "0xB8029504"
#define  OSD_SR_3_Scaleup_Ctrl1_reg                                       0xB8029504
#define  OSD_SR_3_Scaleup_Ctrl1_inst_addr                                 "0x0025"
...
#define  OSD_SR_3_Scaleup_Ctrl1_h_zoom_en_shift                           (31)
#define  OSD_SR_3_Scaleup_Ctrl1_hor_ini_shift                             (22)
#define  OSD_SR_3_Scaleup_Ctrl1_hor_factor_shift                          (0)
#define  OSD_SR_3_Scaleup_Ctrl1_h_zoom_en_mask                            (0x80000000)
#define  OSD_SR_3_Scaleup_Ctrl1_hor_ini_mask                              (0x3FC00000)
#define  OSD_SR_3_Scaleup_Ctrl1_hor_factor_mask                           (0x000FFFFF)
#define  OSD_SR_3_Scaleup_Ctrl1_h_zoom_en(data)                           (0x80000000&((data)<<31))
#define  OSD_SR_3_Scaleup_Ctrl1_hor_ini(data)                             (0x3FC00000&((data)<<22))
#define  OSD_SR_3_Scaleup_Ctrl1_hor_factor(data)                          (0x000FFFFF&(data))
#define  OSD_SR_3_Scaleup_Ctrl1_get_h_zoom_en(data)                       ((0x80000000&(data))>>31)
#define  OSD_SR_3_Scaleup_Ctrl1_get_hor_ini(data)                         ((0x3FC00000&(data))>>22)
#define  OSD_SR_3_Scaleup_Ctrl1_get_hor_factor(data)                      (0x000FFFFF&(data))

#define  OSD_SR_3_H_Location_Ctrl                                         0x18029508
#define  OSD_SR_3_H_Location_Ctrl_reg_addr                                "0xB8029508"
#define  OSD_SR_3_H_Location_Ctrl_reg                                     0xB8029508
#define  OSD_SR_3_H_Location_Ctrl_inst_addr                               "0x0026"
...
#define  OSD_SR_3_H_Location_Ctrl_osd_h_sta_shift                         (16)
#define  OSD_SR_3_H_Location_Ctrl_osd_width_shift                         (0)
#define  OSD_SR_3_H_Location_Ctrl_osd_h_sta_mask                          (0x1FFF0000)
#define  OSD_SR_3_H_Location_Ctrl_osd_width_mask                          (0x00001FFF)
#define  OSD_SR_3_H_Location_Ctrl_osd_h_sta(data)                         (0x1FFF0000&((data)<<16))
#define  OSD_SR_3_H_Location_Ctrl_osd_width(data)                         (0x00001FFF&(data))
#define  OSD_SR_3_H_Location_Ctrl_get_osd_h_sta(data)                     ((0x1FFF0000&(data))>>16)
#define  OSD_SR_3_H_Location_Ctrl_get_osd_width(data)                     (0x00001FFF&(data))

#define  OSD_SR_3_V_Location_Ctrl                                         0x1802950C
#define  OSD_SR_3_V_Location_Ctrl_reg_addr                                "0xB802950C"
#define  OSD_SR_3_V_Location_Ctrl_reg                                     0xB802950C
#define  OSD_SR_3_V_Location_Ctrl_inst_addr                               "0x0027"
...
#define  OSD_SR_3_V_Location_Ctrl_osd_v_sta_shift                         (16)
#define  OSD_SR_3_V_Location_Ctrl_osd_height_shift                        (0)
#define  OSD_SR_3_V_Location_Ctrl_osd_v_sta_mask                          (0x0FFF0000)
#define  OSD_SR_3_V_Location_Ctrl_osd_height_mask                         (0x00000FFF)
#define  OSD_SR_3_V_Location_Ctrl_osd_v_sta(data)                         (0x0FFF0000&((data)<<16))
#define  OSD_SR_3_V_Location_Ctrl_osd_height(data)                        (0x00000FFF&(data))
#define  OSD_SR_3_V_Location_Ctrl_get_osd_v_sta(data)                     ((0x0FFF0000&(data))>>16)
#define  OSD_SR_3_V_Location_Ctrl_get_osd_height(data)                    (0x00000FFF&(data))

#define  OSD_SR_3_Ctrl                                                    0x18029510
#define  OSD_SR_3_Ctrl_reg_addr                                           "0xB8029510"
#define  OSD_SR_3_Ctrl_reg                                                0xB8029510
#define  OSD_SR_3_Ctrl_inst_addr                                          "0x0028"
...
#define  OSD_SR_3_Ctrl_sr_maxmin_shift_shift                              (24)
#define  OSD_SR_3_Ctrl_sr_var_thd_shift                                   (16)
#define  OSD_SR_3_Ctrl_sr_maxmin_limit_en_shift                           (8)
#define  OSD_SR_3_Ctrl_yuv_data_shift                                     (1)
#define  OSD_SR_3_Ctrl_irq_udf_en_shift                                   (0)
#define  OSD_SR_3_Ctrl_sr_maxmin_shift_mask                               (0xFF000000)
#define  OSD_SR_3_Ctrl_sr_var_thd_mask                                    (0x00FF0000)
#define  OSD_SR_3_Ctrl_sr_maxmin_limit_en_mask                            (0x00000100)
#define  OSD_SR_3_Ctrl_yuv_data_mask                                      (0x00000002)
#define  OSD_SR_3_Ctrl_irq_udf_en_mask                                    (0x00000001)
#define  OSD_SR_3_Ctrl_sr_maxmin_shift(data)                              (0xFF000000&((data)<<24))
#define  OSD_SR_3_Ctrl_sr_var_thd(data)                                   (0x00FF0000&((data)<<16))
#define  OSD_SR_3_Ctrl_sr_maxmin_limit_en(data)                           (0x00000100&((data)<<8))
#define  OSD_SR_3_Ctrl_yuv_data(data)                                     (0x00000002&((data)<<1))
#define  OSD_SR_3_Ctrl_irq_udf_en(data)                                   (0x00000001&(data))
#define  OSD_SR_3_Ctrl_get_sr_maxmin_shift(data)                          ((0xFF000000&(data))>>24)
#define  OSD_SR_3_Ctrl_get_sr_var_thd(data)                               ((0x00FF0000&(data))>>16)
#define  OSD_SR_3_Ctrl_get_sr_maxmin_limit_en(data)                       ((0x00000100&(data))>>8)
#define  OSD_SR_3_Ctrl_get_yuv_data(data)                                 ((0x00000002&(data))>>1)
#define  OSD_SR_3_Ctrl_get_irq_udf_en(data)                               (0x00000001&(data))

#define  OSD_SR_3_Hcoeff                                                  0x18029514
#define  OSD_SR_3_Hcoeff_reg_addr                                         "0xB8029514"
#define  OSD_SR_3_Hcoeff_reg                                              0xB8029514
#define  OSD_SR_3_Hcoeff_inst_addr                                        "0x0029"
#define  set_OSD_SR_OSD_SR_3_Hcoeff_reg(data)                                    (*((volatile unsigned int*)OSD_SR_OSD_SR_3_Hcoeff_reg)=data)
#define  get_OSD_SR_OSD_SR_3_Hcoeff_reg                                          (*((volatile unsigned int*)OSD_SR_OSD_SR_3_Hcoeff_reg))
#define  OSD_SR_3_Hcoeff_sr_hor_c0_0_shift                                (24)
#define  OSD_SR_3_Hcoeff_sr_hor_c0_1_shift                                (16)
#define  OSD_SR_3_Hcoeff_sr_hor_c1_0_shift                                (8)
#define  OSD_SR_3_Hcoeff_sr_hor_c1_1_shift                                (0)
#define  OSD_SR_3_Hcoeff_sr_hor_c0_0_mask                                 (0xFF000000)
#define  OSD_SR_3_Hcoeff_sr_hor_c0_1_mask                                 (0x00FF0000)
#define  OSD_SR_3_Hcoeff_sr_hor_c1_0_mask                                 (0x0000FF00)
#define  OSD_SR_3_Hcoeff_sr_hor_c1_1_mask                                 (0x000000FF)
#define  OSD_SR_3_Hcoeff_sr_hor_c0_0(data)                                (0xFF000000&((data)<<24))
#define  OSD_SR_3_Hcoeff_sr_hor_c0_1(data)                                (0x00FF0000&((data)<<16))
#define  OSD_SR_3_Hcoeff_sr_hor_c1_0(data)                                (0x0000FF00&((data)<<8))
#define  OSD_SR_3_Hcoeff_sr_hor_c1_1(data)                                (0x000000FF&(data))
#define  OSD_SR_3_Hcoeff_get_sr_hor_c0_0(data)                            ((0xFF000000&(data))>>24)
#define  OSD_SR_3_Hcoeff_get_sr_hor_c0_1(data)                            ((0x00FF0000&(data))>>16)
#define  OSD_SR_3_Hcoeff_get_sr_hor_c1_0(data)                            ((0x0000FF00&(data))>>8)
#define  OSD_SR_3_Hcoeff_get_sr_hor_c1_1(data)                            (0x000000FF&(data))

#define  OSD_SR_3_Vcoeff                                                  0x18029518
#define  OSD_SR_3_Vcoeff_reg_addr                                         "0xB8029518"
#define  OSD_SR_3_Vcoeff_reg                                              0xB8029518
#define  OSD_SR_3_Vcoeff_inst_addr                                        "0x002A"
#define  set_OSD_SR_OSD_SR_3_Vcoeff_reg(data)                                    (*((volatile unsigned int*)OSD_SR_OSD_SR_3_Vcoeff_reg)=data)
#define  get_OSD_SR_OSD_SR_3_Vcoeff_reg                                          (*((volatile unsigned int*)OSD_SR_OSD_SR_3_Vcoeff_reg))
#define  OSD_SR_3_Vcoeff_sr_ver_c0_0_shift                                (24)
#define  OSD_SR_3_Vcoeff_sr_ver_c0_1_shift                                (16)
#define  OSD_SR_3_Vcoeff_sr_ver_c1_0_shift                                (8)
#define  OSD_SR_3_Vcoeff_sr_ver_c1_1_shift                                (0)
#define  OSD_SR_3_Vcoeff_sr_ver_c0_0_mask                                 (0xFF000000)
#define  OSD_SR_3_Vcoeff_sr_ver_c0_1_mask                                 (0x00FF0000)
#define  OSD_SR_3_Vcoeff_sr_ver_c1_0_mask                                 (0x0000FF00)
#define  OSD_SR_3_Vcoeff_sr_ver_c1_1_mask                                 (0x000000FF)
#define  OSD_SR_3_Vcoeff_sr_ver_c0_0(data)                                (0xFF000000&((data)<<24))
#define  OSD_SR_3_Vcoeff_sr_ver_c0_1(data)                                (0x00FF0000&((data)<<16))
#define  OSD_SR_3_Vcoeff_sr_ver_c1_0(data)                                (0x0000FF00&((data)<<8))
#define  OSD_SR_3_Vcoeff_sr_ver_c1_1(data)                                (0x000000FF&(data))
#define  OSD_SR_3_Vcoeff_get_sr_ver_c0_0(data)                            ((0xFF000000&(data))>>24)
#define  OSD_SR_3_Vcoeff_get_sr_ver_c0_1(data)                            ((0x00FF0000&(data))>>16)
#define  OSD_SR_3_Vcoeff_get_sr_ver_c1_0(data)                            ((0x0000FF00&(data))>>8)
#define  OSD_SR_3_Vcoeff_get_sr_ver_c1_1(data)                            (0x000000FF&(data))

#define  OSD_SR_3_Filter_Ctrl0                                            0x1802951C
#define  OSD_SR_3_Filter_Ctrl0_reg_addr                                   "0xB802951C"
#define  OSD_SR_3_Filter_Ctrl0_reg                                        0xB802951C
#define  OSD_SR_3_Filter_Ctrl0_inst_addr                                  "0x002B"
...
#define  OSD_SR_3_Filter_Ctrl0_sr_maxmin_thd_shift                        (16)
#define  OSD_SR_3_Filter_Ctrl0_sr_maxmin_mode_shift                       (9)
#define  OSD_SR_3_Filter_Ctrl0_sr_maxmin_range_shift                      (8)
#define  OSD_SR_3_Filter_Ctrl0_sr_delta_gain_shift                        (5)
#define  OSD_SR_3_Filter_Ctrl0_sr_edge_range_shift                        (4)
#define  OSD_SR_3_Filter_Ctrl0_sr_lpf_range_shift                         (0)
#define  OSD_SR_3_Filter_Ctrl0_sr_maxmin_thd_mask                         (0x00FF0000)
#define  OSD_SR_3_Filter_Ctrl0_sr_maxmin_mode_mask                        (0x00000200)
#define  OSD_SR_3_Filter_Ctrl0_sr_maxmin_range_mask                       (0x00000100)
#define  OSD_SR_3_Filter_Ctrl0_sr_delta_gain_mask                         (0x00000060)
#define  OSD_SR_3_Filter_Ctrl0_sr_edge_range_mask                         (0x00000010)
#define  OSD_SR_3_Filter_Ctrl0_sr_lpf_range_mask                          (0x00000001)
#define  OSD_SR_3_Filter_Ctrl0_sr_maxmin_thd(data)                        (0x00FF0000&((data)<<16))
#define  OSD_SR_3_Filter_Ctrl0_sr_maxmin_mode(data)                       (0x00000200&((data)<<9))
#define  OSD_SR_3_Filter_Ctrl0_sr_maxmin_range(data)                      (0x00000100&((data)<<8))
#define  OSD_SR_3_Filter_Ctrl0_sr_delta_gain(data)                        (0x00000060&((data)<<5))
#define  OSD_SR_3_Filter_Ctrl0_sr_edge_range(data)                        (0x00000010&((data)<<4))
#define  OSD_SR_3_Filter_Ctrl0_sr_lpf_range(data)                         (0x00000001&(data))
#define  OSD_SR_3_Filter_Ctrl0_get_sr_maxmin_thd(data)                    ((0x00FF0000&(data))>>16)
#define  OSD_SR_3_Filter_Ctrl0_get_sr_maxmin_mode(data)                   ((0x00000200&(data))>>9)
#define  OSD_SR_3_Filter_Ctrl0_get_sr_maxmin_range(data)                  ((0x00000100&(data))>>8)
#define  OSD_SR_3_Filter_Ctrl0_get_sr_delta_gain(data)                    ((0x00000060&(data))>>5)
#define  OSD_SR_3_Filter_Ctrl0_get_sr_edge_range(data)                    ((0x00000010&(data))>>4)
#define  OSD_SR_3_Filter_Ctrl0_get_sr_lpf_range(data)                     (0x00000001&(data))

#define  OSD_SR_3_GainY_Ctrl0                                             0x18029520
#define  OSD_SR_3_GainY_Ctrl0_reg_addr                                    "0xB8029520"
#define  OSD_SR_3_GainY_Ctrl0_reg                                         0xB8029520
#define  OSD_SR_3_GainY_Ctrl0_inst_addr                                   "0x002C"
...
#define  OSD_SR_3_GainY_Ctrl0_sr_by_pgain0_shift                          (24)
#define  OSD_SR_3_GainY_Ctrl0_sr_by_ngain0_shift                          (16)
#define  OSD_SR_3_GainY_Ctrl0_sr_lpf_gain_shift                           (10)
#define  OSD_SR_3_GainY_Ctrl0_sr_by_gain_en_shift                         (0)
#define  OSD_SR_3_GainY_Ctrl0_sr_by_pgain0_mask                           (0xFF000000)
#define  OSD_SR_3_GainY_Ctrl0_sr_by_ngain0_mask                           (0x00FF0000)
#define  OSD_SR_3_GainY_Ctrl0_sr_lpf_gain_mask                            (0x0000FC00)
#define  OSD_SR_3_GainY_Ctrl0_sr_by_gain_en_mask                          (0x00000001)
#define  OSD_SR_3_GainY_Ctrl0_sr_by_pgain0(data)                          (0xFF000000&((data)<<24))
#define  OSD_SR_3_GainY_Ctrl0_sr_by_ngain0(data)                          (0x00FF0000&((data)<<16))
#define  OSD_SR_3_GainY_Ctrl0_sr_lpf_gain(data)                           (0x0000FC00&((data)<<10))
#define  OSD_SR_3_GainY_Ctrl0_sr_by_gain_en(data)                         (0x00000001&(data))
#define  OSD_SR_3_GainY_Ctrl0_get_sr_by_pgain0(data)                      ((0xFF000000&(data))>>24)
#define  OSD_SR_3_GainY_Ctrl0_get_sr_by_ngain0(data)                      ((0x00FF0000&(data))>>16)
#define  OSD_SR_3_GainY_Ctrl0_get_sr_lpf_gain(data)                       ((0x0000FC00&(data))>>10)
#define  OSD_SR_3_GainY_Ctrl0_get_sr_by_gain_en(data)                     (0x00000001&(data))

#define  OSD_SR_3_GainY_Ctrl1                                             0x18029524
#define  OSD_SR_3_GainY_Ctrl1_reg_addr                                    "0xB8029524"
#define  OSD_SR_3_GainY_Ctrl1_reg                                         0xB8029524
#define  OSD_SR_3_GainY_Ctrl1_inst_addr                                   "0x002D"
#define  set_OSD_SR_OSD_SR_3_GainY_Ctrl1_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_3_GainY_Ctrl1_reg)=data)
#define  get_OSD_SR_OSD_SR_3_GainY_Ctrl1_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_3_GainY_Ctrl1_reg))
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain1_shift                          (24)
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain2_shift                          (16)
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain3_shift                          (8)
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain4_shift                          (0)
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain1_mask                           (0xFF000000)
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain2_mask                           (0x00FF0000)
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain3_mask                           (0x0000FF00)
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain4_mask                           (0x000000FF)
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain1(data)                          (0xFF000000&((data)<<24))
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain2(data)                          (0x00FF0000&((data)<<16))
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain3(data)                          (0x0000FF00&((data)<<8))
#define  OSD_SR_3_GainY_Ctrl1_sr_by_pgain4(data)                          (0x000000FF&(data))
#define  OSD_SR_3_GainY_Ctrl1_get_sr_by_pgain1(data)                      ((0xFF000000&(data))>>24)
#define  OSD_SR_3_GainY_Ctrl1_get_sr_by_pgain2(data)                      ((0x00FF0000&(data))>>16)
#define  OSD_SR_3_GainY_Ctrl1_get_sr_by_pgain3(data)                      ((0x0000FF00&(data))>>8)
#define  OSD_SR_3_GainY_Ctrl1_get_sr_by_pgain4(data)                      (0x000000FF&(data))

#define  OSD_SR_3_GainY_Ctrl2                                             0x18029528
#define  OSD_SR_3_GainY_Ctrl2_reg_addr                                    "0xB8029528"
#define  OSD_SR_3_GainY_Ctrl2_reg                                         0xB8029528
#define  OSD_SR_3_GainY_Ctrl2_inst_addr                                   "0x002E"
#define  set_OSD_SR_OSD_SR_3_GainY_Ctrl2_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_3_GainY_Ctrl2_reg)=data)
#define  get_OSD_SR_OSD_SR_3_GainY_Ctrl2_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_3_GainY_Ctrl2_reg))
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain5_shift                          (24)
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain6_shift                          (16)
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain7_shift                          (8)
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain8_shift                          (0)
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain5_mask                           (0xFF000000)
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain6_mask                           (0x00FF0000)
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain7_mask                           (0x0000FF00)
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain8_mask                           (0x000000FF)
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain5(data)                          (0xFF000000&((data)<<24))
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain6(data)                          (0x00FF0000&((data)<<16))
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain7(data)                          (0x0000FF00&((data)<<8))
#define  OSD_SR_3_GainY_Ctrl2_sr_by_pgain8(data)                          (0x000000FF&(data))
#define  OSD_SR_3_GainY_Ctrl2_get_sr_by_pgain5(data)                      ((0xFF000000&(data))>>24)
#define  OSD_SR_3_GainY_Ctrl2_get_sr_by_pgain6(data)                      ((0x00FF0000&(data))>>16)
#define  OSD_SR_3_GainY_Ctrl2_get_sr_by_pgain7(data)                      ((0x0000FF00&(data))>>8)
#define  OSD_SR_3_GainY_Ctrl2_get_sr_by_pgain8(data)                      (0x000000FF&(data))

#define  OSD_SR_3_GainY_Ctrl3                                             0x1802952C
#define  OSD_SR_3_GainY_Ctrl3_reg_addr                                    "0xB802952C"
#define  OSD_SR_3_GainY_Ctrl3_reg                                         0xB802952C
#define  OSD_SR_3_GainY_Ctrl3_inst_addr                                   "0x002F"
#define  set_OSD_SR_OSD_SR_3_GainY_Ctrl3_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_3_GainY_Ctrl3_reg)=data)
#define  get_OSD_SR_OSD_SR_3_GainY_Ctrl3_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_3_GainY_Ctrl3_reg))
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain1_shift                          (24)
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain2_shift                          (16)
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain3_shift                          (8)
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain4_shift                          (0)
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain1_mask                           (0xFF000000)
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain2_mask                           (0x00FF0000)
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain3_mask                           (0x0000FF00)
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain4_mask                           (0x000000FF)
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain1(data)                          (0xFF000000&((data)<<24))
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain2(data)                          (0x00FF0000&((data)<<16))
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain3(data)                          (0x0000FF00&((data)<<8))
#define  OSD_SR_3_GainY_Ctrl3_sr_by_ngain4(data)                          (0x000000FF&(data))
#define  OSD_SR_3_GainY_Ctrl3_get_sr_by_ngain1(data)                      ((0xFF000000&(data))>>24)
#define  OSD_SR_3_GainY_Ctrl3_get_sr_by_ngain2(data)                      ((0x00FF0000&(data))>>16)
#define  OSD_SR_3_GainY_Ctrl3_get_sr_by_ngain3(data)                      ((0x0000FF00&(data))>>8)
#define  OSD_SR_3_GainY_Ctrl3_get_sr_by_ngain4(data)                      (0x000000FF&(data))

#define  OSD_SR_3_GainY_Ctrl4                                             0x18029530
#define  OSD_SR_3_GainY_Ctrl4_reg_addr                                    "0xB8029530"
#define  OSD_SR_3_GainY_Ctrl4_reg                                         0xB8029530
#define  OSD_SR_3_GainY_Ctrl4_inst_addr                                   "0x0030"
#define  set_OSD_SR_OSD_SR_3_GainY_Ctrl4_reg(data)                               (*((volatile unsigned int*)OSD_SR_OSD_SR_3_GainY_Ctrl4_reg)=data)
#define  get_OSD_SR_OSD_SR_3_GainY_Ctrl4_reg                                     (*((volatile unsigned int*)OSD_SR_OSD_SR_3_GainY_Ctrl4_reg))
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain5_shift                          (24)
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain6_shift                          (16)
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain7_shift                          (8)
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain8_shift                          (0)
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain5_mask                           (0xFF000000)
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain6_mask                           (0x00FF0000)
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain7_mask                           (0x0000FF00)
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain8_mask                           (0x000000FF)
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain5(data)                          (0xFF000000&((data)<<24))
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain6(data)                          (0x00FF0000&((data)<<16))
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain7(data)                          (0x0000FF00&((data)<<8))
#define  OSD_SR_3_GainY_Ctrl4_sr_by_ngain8(data)                          (0x000000FF&(data))
#define  OSD_SR_3_GainY_Ctrl4_get_sr_by_ngain5(data)                      ((0xFF000000&(data))>>24)
#define  OSD_SR_3_GainY_Ctrl4_get_sr_by_ngain6(data)                      ((0x00FF0000&(data))>>16)
#define  OSD_SR_3_GainY_Ctrl4_get_sr_by_ngain7(data)                      ((0x0000FF00&(data))>>8)
#define  OSD_SR_3_GainY_Ctrl4_get_sr_by_ngain8(data)                      (0x000000FF&(data))

#define  OSD_SR_3_GainMap_Ctrl0                                           0x18029534
#define  OSD_SR_3_GainMap_Ctrl0_reg_addr                                  "0xB8029534"
#define  OSD_SR_3_GainMap_Ctrl0_reg                                       0xB8029534
#define  OSD_SR_3_GainMap_Ctrl0_inst_addr                                 "0x0031"
...
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_thd_shift                    (24)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_gain_shift                   (19)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_step_shift                   (17)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_en_shift                     (16)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_thd_shift                     (8)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_gain_shift                    (3)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_step_shift                    (1)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_en_shift                      (0)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_thd_mask                     (0xFF000000)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_gain_mask                    (0x00F80000)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_step_mask                    (0x00060000)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_en_mask                      (0x00010000)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_thd_mask                      (0x0000FF00)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_gain_mask                     (0x000000F8)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_step_mask                     (0x00000006)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_en_mask                       (0x00000001)
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_thd(data)                    (0xFF000000&((data)<<24))
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_gain(data)                   (0x00F80000&((data)<<19))
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_step(data)                   (0x00060000&((data)<<17))
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_range_en(data)                     (0x00010000&((data)<<16))
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_thd(data)                     (0x0000FF00&((data)<<8))
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_gain(data)                    (0x000000F8&((data)<<3))
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_step(data)                    (0x00000006&((data)<<1))
#define  OSD_SR_3_GainMap_Ctrl0_sr_lpf_edge_en(data)                      (0x00000001&(data))
#define  OSD_SR_3_GainMap_Ctrl0_get_sr_lpf_range_thd(data)                ((0xFF000000&(data))>>24)
#define  OSD_SR_3_GainMap_Ctrl0_get_sr_lpf_range_gain(data)               ((0x00F80000&(data))>>19)
#define  OSD_SR_3_GainMap_Ctrl0_get_sr_lpf_range_step(data)               ((0x00060000&(data))>>17)
#define  OSD_SR_3_GainMap_Ctrl0_get_sr_lpf_range_en(data)                 ((0x00010000&(data))>>16)
#define  OSD_SR_3_GainMap_Ctrl0_get_sr_lpf_edge_thd(data)                 ((0x0000FF00&(data))>>8)
#define  OSD_SR_3_GainMap_Ctrl0_get_sr_lpf_edge_gain(data)                ((0x000000F8&(data))>>3)
#define  OSD_SR_3_GainMap_Ctrl0_get_sr_lpf_edge_step(data)                ((0x00000006&(data))>>1)
#define  OSD_SR_3_GainMap_Ctrl0_get_sr_lpf_edge_en(data)                  (0x00000001&(data))

#define  OSD_SR_3_UDFLOW                                                  0x1802953C
#define  OSD_SR_3_UDFLOW_reg_addr                                         "0xB802953C"
#define  OSD_SR_3_UDFLOW_reg                                              0xB802953C
#define  OSD_SR_3_UDFLOW_inst_addr                                        "0x0032"
...
#define  OSD_SR_3_UDFLOW_off_line_state_shift                             (1)
#define  OSD_SR_3_UDFLOW_osd_sr_in_udflow_shift                           (0)
#define  OSD_SR_3_UDFLOW_off_line_state_mask                              (0x00000002)
#define  OSD_SR_3_UDFLOW_osd_sr_in_udflow_mask                            (0x00000001)
#define  OSD_SR_3_UDFLOW_off_line_state(data)                             (0x00000002&((data)<<1))
#define  OSD_SR_3_UDFLOW_osd_sr_in_udflow(data)                           (0x00000001&(data))
#define  OSD_SR_3_UDFLOW_get_off_line_state(data)                         ((0x00000002&(data))>>1)
#define  OSD_SR_3_UDFLOW_get_osd_sr_in_udflow(data)                       (0x00000001&(data))

#define  OSD_SR_3_Debug0                                                  0x18029540
#define  OSD_SR_3_Debug0_reg_addr                                         "0xB8029540"
#define  OSD_SR_3_Debug0_reg                                              0xB8029540
#define  OSD_SR_3_Debug0_inst_addr                                        "0x0033"
...
#define  OSD_SR_3_Debug0_sr_dbg_mode_shift                                (8)
#define  OSD_SR_3_Debug0_sr_dbg_inv_shift                                 (4)
#define  OSD_SR_3_Debug0_sr_dbg_en_shift                                  (0)
#define  OSD_SR_3_Debug0_sr_dbg_mode_mask                                 (0x00000F00)
#define  OSD_SR_3_Debug0_sr_dbg_inv_mask                                  (0x00000010)
#define  OSD_SR_3_Debug0_sr_dbg_en_mask                                   (0x00000001)
#define  OSD_SR_3_Debug0_sr_dbg_mode(data)                                (0x00000F00&((data)<<8))
#define  OSD_SR_3_Debug0_sr_dbg_inv(data)                                 (0x00000010&((data)<<4))
#define  OSD_SR_3_Debug0_sr_dbg_en(data)                                  (0x00000001&(data))
#define  OSD_SR_3_Debug0_get_sr_dbg_mode(data)                            ((0x00000F00&(data))>>8)
#define  OSD_SR_3_Debug0_get_sr_dbg_inv(data)                             ((0x00000010&(data))>>4)
#define  OSD_SR_3_Debug0_get_sr_dbg_en(data)                              (0x00000001&(data))

#define  OSD_SR_3_Debug1                                                  0x18029544
#define  OSD_SR_3_Debug1_reg_addr                                         "0xB8029544"
#define  OSD_SR_3_Debug1_reg                                              0xB8029544
#define  OSD_SR_3_Debug1_inst_addr                                        "0x0034"
...
#define  OSD_SR_3_Debug1_sr_dbg_h_sta_shift                               (16)
#define  OSD_SR_3_Debug1_sr_dbg_h_end_shift                               (0)
#define  OSD_SR_3_Debug1_sr_dbg_h_sta_mask                                (0x1FFF0000)
#define  OSD_SR_3_Debug1_sr_dbg_h_end_mask                                (0x00001FFF)
#define  OSD_SR_3_Debug1_sr_dbg_h_sta(data)                               (0x1FFF0000&((data)<<16))
#define  OSD_SR_3_Debug1_sr_dbg_h_end(data)                               (0x00001FFF&(data))
#define  OSD_SR_3_Debug1_get_sr_dbg_h_sta(data)                           ((0x1FFF0000&(data))>>16)
#define  OSD_SR_3_Debug1_get_sr_dbg_h_end(data)                           (0x00001FFF&(data))

#define  OSD_SR_3_Debug2                                                  0x18029548
#define  OSD_SR_3_Debug2_reg_addr                                         "0xB8029548"
#define  OSD_SR_3_Debug2_reg                                              0xB8029548
#define  OSD_SR_3_Debug2_inst_addr                                        "0x0035"
...
#define  OSD_SR_3_Debug2_sr_dbg_v_sta_shift                               (16)
#define  OSD_SR_3_Debug2_sr_dbg_v_end_shift                               (0)
#define  OSD_SR_3_Debug2_sr_dbg_v_sta_mask                                (0x0FFF0000)
#define  OSD_SR_3_Debug2_sr_dbg_v_end_mask                                (0x00000FFF)
#define  OSD_SR_3_Debug2_sr_dbg_v_sta(data)                               (0x0FFF0000&((data)<<16))
#define  OSD_SR_3_Debug2_sr_dbg_v_end(data)                               (0x00000FFF&(data))
#define  OSD_SR_3_Debug2_get_sr_dbg_v_sta(data)                           ((0x0FFF0000&(data))>>16)
#define  OSD_SR_3_Debug2_get_sr_dbg_v_end(data)                           (0x00000FFF&(data))

#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl                                       0x18029580
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_reg_addr                              "0xB8029580"
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_reg                                   0xB8029580
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_inst_addr                             "0x0036"
#define  set_OSD_SR_OSD_BYPASS_4_Location_Ctrl_reg(data)                         (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_Location_Ctrl_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_4_Location_Ctrl_reg                               (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_Location_Ctrl_reg))
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_osd_h_sta_shift                       (16)
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_irq_udf_en_shift                      (12)
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_osd_v_sta_shift                       (0)
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_osd_h_sta_mask                        (0x1FFF0000)
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_irq_udf_en_mask                       (0x00001000)
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_osd_v_sta_mask                        (0x00000FFF)
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_osd_h_sta(data)                       (0x1FFF0000&((data)<<16))
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_irq_udf_en(data)                      (0x00001000&((data)<<12))
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_osd_v_sta(data)                       (0x00000FFF&(data))
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_get_osd_h_sta(data)                   ((0x1FFF0000&(data))>>16)
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_get_irq_udf_en(data)                  ((0x00001000&(data))>>12)
#define  OSD_SR_OSD_BYPASS_4_Location_Ctrl_get_osd_v_sta(data)                   (0x00000FFF&(data))

#define  OSD_SR_OSD_BYPASS_4_UDFLOW                                              0x18029584
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_reg_addr                                     "0xB8029584"
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_reg                                          0xB8029584
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_inst_addr                                    "0x0037"
#define  set_OSD_SR_OSD_BYPASS_4_UDFLOW_reg(data)                                (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_UDFLOW_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_4_UDFLOW_reg                                      (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_UDFLOW_reg))
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_off_line_state_shift                         (1)
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_osd_sr_in_udflow_shift                       (0)
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_off_line_state_mask                          (0x00000002)
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_osd_sr_in_udflow_mask                        (0x00000001)
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_off_line_state(data)                         (0x00000002&((data)<<1))
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_osd_sr_in_udflow(data)                       (0x00000001&(data))
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_get_off_line_state(data)                     ((0x00000002&(data))>>1)
#define  OSD_SR_OSD_BYPASS_4_UDFLOW_get_osd_sr_in_udflow(data)                   (0x00000001&(data))

#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl                                       0x18029590
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_reg_addr                              "0xB8029590"
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_reg                                   0xB8029590
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_inst_addr                             "0x0038"
#define  set_OSD_SR_OSD_BYPASS_5_Location_Ctrl_reg(data)                         (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_Location_Ctrl_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_5_Location_Ctrl_reg                               (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_Location_Ctrl_reg))
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_osd_h_sta_shift                       (16)
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_irq_udf_en_shift                      (12)
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_osd_v_sta_shift                       (0)
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_osd_h_sta_mask                        (0x1FFF0000)
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_irq_udf_en_mask                       (0x00001000)
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_osd_v_sta_mask                        (0x00000FFF)
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_osd_h_sta(data)                       (0x1FFF0000&((data)<<16))
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_irq_udf_en(data)                      (0x00001000&((data)<<12))
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_osd_v_sta(data)                       (0x00000FFF&(data))
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_get_osd_h_sta(data)                   ((0x1FFF0000&(data))>>16)
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_get_irq_udf_en(data)                  ((0x00001000&(data))>>12)
#define  OSD_SR_OSD_BYPASS_5_Location_Ctrl_get_osd_v_sta(data)                   (0x00000FFF&(data))

#define  OSD_SR_OSD_BYPASS_5_UDFLOW                                              0x18029594
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_reg_addr                                     "0xB8029594"
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_reg                                          0xB8029594
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_inst_addr                                    "0x0039"
#define  set_OSD_SR_OSD_BYPASS_5_UDFLOW_reg(data)                                (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_UDFLOW_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_5_UDFLOW_reg                                      (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_UDFLOW_reg))
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_off_line_state_shift                         (1)
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_osd_sr_in_udflow_shift                       (0)
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_off_line_state_mask                          (0x00000002)
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_osd_sr_in_udflow_mask                        (0x00000001)
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_off_line_state(data)                         (0x00000002&((data)<<1))
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_osd_sr_in_udflow(data)                       (0x00000001&(data))
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_get_off_line_state(data)                     ((0x00000002&(data))>>1)
#define  OSD_SR_OSD_BYPASS_5_UDFLOW_get_osd_sr_in_udflow(data)                   (0x00000001&(data))
...
#define  OSD_SR_1_CRC_Ctrl1_inst_addr                                     "0x003A"
...
#define  OSD_SR_1_CRC_Result_inst_addr                                    "0x003B"
...
#define  OSD_SR_1_CRC_Result_odd                                          0x180295A8
#define  OSD_SR_1_CRC_Result_odd_reg_addr                                 "0xB80295A8"
#define  OSD_SR_1_CRC_Result_odd_reg                                      0xB80295A8
#define  OSD_SR_1_CRC_Result_odd_inst_addr                                "0x003C"
#define  set_OSD_SR_OSD_SR_1_CRC_Result_odd_reg(data)                            (*((volatile unsigned int*)OSD_SR_OSD_SR_1_CRC_Result_odd_reg)=data)
#define  get_OSD_SR_OSD_SR_1_CRC_Result_odd_reg                                  (*((volatile unsigned int*)OSD_SR_OSD_SR_1_CRC_Result_odd_reg))
#define  OSD_SR_1_CRC_Result_odd_sr_crc_result_odd_shift                  (0)
#define  OSD_SR_1_CRC_Result_odd_sr_crc_result_odd_mask                   (0xFFFFFFFF)
#define  OSD_SR_1_CRC_Result_odd_sr_crc_result_odd(data)                  (0xFFFFFFFF&(data))
#define  OSD_SR_1_CRC_Result_odd_get_sr_crc_result_odd(data)              (0xFFFFFFFF&(data))
...
#define  OSD_SR_2_CRC_Ctrl1_inst_addr                                     "0x003D"
...
#define  OSD_SR_2_CRC_Result_inst_addr                                    "0x003E"
...
#define  OSD_SR_2_CRC_Result_odd                                          0x180295B8
#define  OSD_SR_2_CRC_Result_odd_reg_addr                                 "0xB80295B8"
#define  OSD_SR_2_CRC_Result_odd_reg                                      0xB80295B8
#define  OSD_SR_2_CRC_Result_odd_inst_addr                                "0x003F"
#define  set_OSD_SR_OSD_SR_2_CRC_Result_odd_reg(data)                            (*((volatile unsigned int*)OSD_SR_OSD_SR_2_CRC_Result_odd_reg)=data)
#define  get_OSD_SR_OSD_SR_2_CRC_Result_odd_reg                                  (*((volatile unsigned int*)OSD_SR_OSD_SR_2_CRC_Result_odd_reg))
#define  OSD_SR_2_CRC_Result_odd_sr_crc_result_odd_shift                  (0)
#define  OSD_SR_2_CRC_Result_odd_sr_crc_result_odd_mask                   (0xFFFFFFFF)
#define  OSD_SR_2_CRC_Result_odd_sr_crc_result_odd(data)                  (0xFFFFFFFF&(data))
#define  OSD_SR_2_CRC_Result_odd_get_sr_crc_result_odd(data)              (0xFFFFFFFF&(data))

#define  OSD_SR_3_CRC_Ctrl1                                               0x180295C0
#define  OSD_SR_3_CRC_Ctrl1_reg_addr                                      "0xB80295C0"
#define  OSD_SR_3_CRC_Ctrl1_reg                                           0xB80295C0
#define  OSD_SR_3_CRC_Ctrl1_inst_addr                                     "0x0040"
...
#define  OSD_SR_3_CRC_Ctrl1_sr_crc_conti_shift                            (1)
#define  OSD_SR_3_CRC_Ctrl1_sr_crc_start_shift                            (0)
#define  OSD_SR_3_CRC_Ctrl1_sr_crc_conti_mask                             (0x00000002)
#define  OSD_SR_3_CRC_Ctrl1_sr_crc_start_mask                             (0x00000001)
#define  OSD_SR_3_CRC_Ctrl1_sr_crc_conti(data)                            (0x00000002&((data)<<1))
#define  OSD_SR_3_CRC_Ctrl1_sr_crc_start(data)                            (0x00000001&(data))
#define  OSD_SR_3_CRC_Ctrl1_get_sr_crc_conti(data)                        ((0x00000002&(data))>>1)
#define  OSD_SR_3_CRC_Ctrl1_get_sr_crc_start(data)                        (0x00000001&(data))

#define  OSD_SR_3_CRC_Result                                              0x180295C4
#define  OSD_SR_3_CRC_Result_reg_addr                                     "0xB80295C4"
#define  OSD_SR_3_CRC_Result_reg                                          0xB80295C4
#define  OSD_SR_3_CRC_Result_inst_addr                                    "0x0041"
...
#define  OSD_SR_3_CRC_Result_sr_crc_result_shift                          (0)
#define  OSD_SR_3_CRC_Result_sr_crc_result_mask                           (0xFFFFFFFF)
#define  OSD_SR_3_CRC_Result_sr_crc_result(data)                          (0xFFFFFFFF&(data))
#define  OSD_SR_3_CRC_Result_get_sr_crc_result(data)                      (0xFFFFFFFF&(data))

#define  OSD_SR_3_CRC_Result_odd                                          0x180295C8
#define  OSD_SR_3_CRC_Result_odd_reg_addr                                 "0xB80295C8"
#define  OSD_SR_3_CRC_Result_odd_reg                                      0xB80295C8
#define  OSD_SR_3_CRC_Result_odd_inst_addr                                "0x0042"
#define  set_OSD_SR_OSD_SR_3_CRC_Result_odd_reg(data)                            (*((volatile unsigned int*)OSD_SR_OSD_SR_3_CRC_Result_odd_reg)=data)
#define  get_OSD_SR_OSD_SR_3_CRC_Result_odd_reg                                  (*((volatile unsigned int*)OSD_SR_OSD_SR_3_CRC_Result_odd_reg))
#define  OSD_SR_3_CRC_Result_odd_sr_crc_result_odd_shift                  (0)
#define  OSD_SR_3_CRC_Result_odd_sr_crc_result_odd_mask                   (0xFFFFFFFF)
#define  OSD_SR_3_CRC_Result_odd_sr_crc_result_odd(data)                  (0xFFFFFFFF&(data))
#define  OSD_SR_3_CRC_Result_odd_get_sr_crc_result_odd(data)              (0xFFFFFFFF&(data))

#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1                                           0x180295D0
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_reg_addr                                  "0xB80295D0"
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_reg                                       0xB80295D0
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_inst_addr                                 "0x0043"
#define  set_OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_reg(data)                             (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_reg                                   (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_reg))
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_sr_crc_conti_shift                        (1)
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_sr_crc_start_shift                        (0)
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_sr_crc_conti_mask                         (0x00000002)
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_sr_crc_start_mask                         (0x00000001)
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_sr_crc_conti(data)                        (0x00000002&((data)<<1))
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_sr_crc_start(data)                        (0x00000001&(data))
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_get_sr_crc_conti(data)                    ((0x00000002&(data))>>1)
#define  OSD_SR_OSD_BYPASS_4_CRC_Ctrl1_get_sr_crc_start(data)                    (0x00000001&(data))

#define  OSD_SR_OSD_BYPASS_4_CRC_Result                                          0x180295D4
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_reg_addr                                 "0xB80295D4"
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_reg                                      0xB80295D4
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_inst_addr                                "0x0044"
#define  set_OSD_SR_OSD_BYPASS_4_CRC_Result_reg(data)                            (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_CRC_Result_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_4_CRC_Result_reg                                  (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_CRC_Result_reg))
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_sr_crc_result_shift                      (0)
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_sr_crc_result_mask                       (0xFFFFFFFF)
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_sr_crc_result(data)                      (0xFFFFFFFF&(data))
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_get_sr_crc_result(data)                  (0xFFFFFFFF&(data))

#define  OSD_SR_OSD_BYPASS_4_CRC_Result_odd                                      0x180295D8
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_odd_reg_addr                             "0xB80295D8"
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_odd_reg                                  0xB80295D8
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_odd_inst_addr                            "0x0045"
#define  set_OSD_SR_OSD_BYPASS_4_CRC_Result_odd_reg(data)                        (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_CRC_Result_odd_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_4_CRC_Result_odd_reg                              (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_4_CRC_Result_odd_reg))
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_odd_sr_crc_result_odd_shift              (0)
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_odd_sr_crc_result_odd_mask               (0xFFFFFFFF)
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_odd_sr_crc_result_odd(data)              (0xFFFFFFFF&(data))
#define  OSD_SR_OSD_BYPASS_4_CRC_Result_odd_get_sr_crc_result_odd(data)          (0xFFFFFFFF&(data))

#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1                                           0x180295E0
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_reg_addr                                  "0xB80295E0"
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_reg                                       0xB80295E0
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_inst_addr                                 "0x0046"
#define  set_OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_reg(data)                             (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_reg                                   (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_reg))
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_sr_crc_conti_shift                        (1)
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_sr_crc_start_shift                        (0)
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_sr_crc_conti_mask                         (0x00000002)
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_sr_crc_start_mask                         (0x00000001)
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_sr_crc_conti(data)                        (0x00000002&((data)<<1))
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_sr_crc_start(data)                        (0x00000001&(data))
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_get_sr_crc_conti(data)                    ((0x00000002&(data))>>1)
#define  OSD_SR_OSD_BYPASS_5_CRC_Ctrl1_get_sr_crc_start(data)                    (0x00000001&(data))

#define  OSD_SR_OSD_BYPASS_5_CRC_Result                                          0x180295E4
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_reg_addr                                 "0xB80295E4"
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_reg                                      0xB80295E4
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_inst_addr                                "0x0047"
#define  set_OSD_SR_OSD_BYPASS_5_CRC_Result_reg(data)                            (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_CRC_Result_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_5_CRC_Result_reg                                  (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_CRC_Result_reg))
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_sr_crc_result_shift                      (0)
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_sr_crc_result_mask                       (0xFFFFFFFF)
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_sr_crc_result(data)                      (0xFFFFFFFF&(data))
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_get_sr_crc_result(data)                  (0xFFFFFFFF&(data))

#define  OSD_SR_OSD_BYPASS_5_CRC_Result_odd                                      0x180295E8
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_odd_reg_addr                             "0xB80295E8"
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_odd_reg                                  0xB80295E8
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_odd_inst_addr                            "0x0048"
#define  set_OSD_SR_OSD_BYPASS_5_CRC_Result_odd_reg(data)                        (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_CRC_Result_odd_reg)=data)
#define  get_OSD_SR_OSD_BYPASS_5_CRC_Result_odd_reg                              (*((volatile unsigned int*)OSD_SR_OSD_BYPASS_5_CRC_Result_odd_reg))
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_odd_sr_crc_result_odd_shift              (0)
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_odd_sr_crc_result_odd_mask               (0xFFFFFFFF)
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_odd_sr_crc_result_odd(data)              (0xFFFFFFFF&(data))
#define  OSD_SR_OSD_BYPASS_5_CRC_Result_odd_get_sr_crc_result_odd(data)          (0xFFFFFFFF&(data))
...
}osd_sr_osd_bypass_4_location_ctrl_RBUS;
...
}osd_sr_osd_bypass_4_udflow_RBUS;
...
}osd_sr_osd_bypass_5_location_ctrl_RBUS;
...
}osd_sr_osd_bypass_5_udflow_RBUS;
...
typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  sr_crc_result_odd:32;
    };
}osd_sr_1_crc_result_odd_RBUS;
...
}osd_sr_osd_bypass_4_crc_ctrl1_RBUS;
...
}osd_sr_osd_bypass_4_crc_result_RBUS;
...
}osd_sr_osd_bypass_4_crc_result_odd_RBUS;
...
}osd_sr_osd_bypass_5_crc_ctrl1_RBUS;
...
}osd_sr_osd_bypass_5_crc_result_RBUS;
...
}osd_sr_osd_bypass_5_crc_result_odd_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  sr_crc_start:1;
        RBus_UInt32  sr_crc_conti:1;
        RBus_UInt32  dummy180295a0_31:30;
    };
}osd_sr_1_crc_ctrl1_RBUS;
