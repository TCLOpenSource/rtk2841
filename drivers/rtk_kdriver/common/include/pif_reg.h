...
#define  PIF_MLVDS_Reset_Pul_CTRL_mlvds_rst_dummy_shift                          (24)
#define  PIF_MLVDS_Reset_Pul_CTRL_mlvds_reset_pul_sel_shift                      (0)
#define  PIF_MLVDS_Reset_Pul_CTRL_mlvds_rst_dummy_mask                           (0xFF000000)
#define  PIF_MLVDS_Reset_Pul_CTRL_mlvds_reset_pul_sel_mask                       (0x00FFFFFF)
#define  PIF_MLVDS_Reset_Pul_CTRL_mlvds_rst_dummy(data)                          (0xFF000000&((data)<<24))
#define  PIF_MLVDS_Reset_Pul_CTRL_mlvds_reset_pul_sel(data)                      (0x00FFFFFF&(data))
#define  PIF_MLVDS_Reset_Pul_CTRL_get_mlvds_rst_dummy(data)                      ((0xFF000000&(data))>>24)
...
#define  PIF_LVDS_pair_select_ctrl_0_inst_addr                                   "0x003B"
...
#define  PIF_LVDS_pair_select_ctrl_1_inst_addr                                   "0x003C"
...
#define  PIF_LVDS_pair_select_ctrl_2_inst_addr                                   "0x003D"
...
#define  PIF_LVDS_pair_select_ctrl_3                                             0x1802D10C
#define  PIF_LVDS_pair_select_ctrl_3_reg_addr                                    "0xB802D10C"
#define  PIF_LVDS_pair_select_ctrl_3_reg                                         0xB802D10C
#define  PIF_LVDS_pair_select_ctrl_3_inst_addr                                   "0x003E"
...
#define  PIF_LVDS_pair_select_ctrl_3_lvds_a_g_pair_sel_shift                     (12)
#define  PIF_LVDS_pair_select_ctrl_3_lvds_b_g_pair_sel_shift                     (8)
#define  PIF_LVDS_pair_select_ctrl_3_lvds_c_g_pair_sel_shift                     (4)
#define  PIF_LVDS_pair_select_ctrl_3_lvds_d_g_pair_sel_shift                     (0)
#define  PIF_LVDS_pair_select_ctrl_3_lvds_a_g_pair_sel_mask                      (0x0000F000)
#define  PIF_LVDS_pair_select_ctrl_3_lvds_b_g_pair_sel_mask                      (0x00000F00)
#define  PIF_LVDS_pair_select_ctrl_3_lvds_c_g_pair_sel_mask                      (0x000000F0)
#define  PIF_LVDS_pair_select_ctrl_3_lvds_d_g_pair_sel_mask                      (0x0000000F)
#define  PIF_LVDS_pair_select_ctrl_3_lvds_a_g_pair_sel(data)                     (0x0000F000&((data)<<12))
#define  PIF_LVDS_pair_select_ctrl_3_lvds_b_g_pair_sel(data)                     (0x00000F00&((data)<<8))
#define  PIF_LVDS_pair_select_ctrl_3_lvds_c_g_pair_sel(data)                     (0x000000F0&((data)<<4))
#define  PIF_LVDS_pair_select_ctrl_3_lvds_d_g_pair_sel(data)                     (0x0000000F&(data))
#define  PIF_LVDS_pair_select_ctrl_3_get_lvds_a_g_pair_sel(data)                 ((0x0000F000&(data))>>12)
#define  PIF_LVDS_pair_select_ctrl_3_get_lvds_b_g_pair_sel(data)                 ((0x00000F00&(data))>>8)
#define  PIF_LVDS_pair_select_ctrl_3_get_lvds_c_g_pair_sel(data)                 ((0x000000F0&(data))>>4)
#define  PIF_LVDS_pair_select_ctrl_3_get_lvds_d_g_pair_sel(data)                 (0x0000000F&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:16;
        RBus_UInt32  lvds_a_g_pair_sel:4;
        RBus_UInt32  lvds_b_g_pair_sel:4;
        RBus_UInt32  lvds_c_g_pair_sel:4;
        RBus_UInt32  lvds_d_g_pair_sel:4;
    };
