...
#define  VBY1_VIDEO_FORMAT_vby1_dphy2_in_sel_mask                                (0x80000000)
...
#define  VBY1_VIDEO_FORMAT_vby1_aphy16_23_in_sel_mask                            (0x03000000)
...
#define  VBY1_VIDEO_FORMAT_vby1_dphy2_in_sel(data)                               (0x80000000&((data)<<31))
...
#define  VBY1_VIDEO_FORMAT_vby1_aphy16_23_in_sel(data)                           (0x03000000&((data)<<24))
...
#define  VBY1_VIDEO_FORMAT_get_vby1_dphy2_in_sel(data)                           ((0x80000000&(data))>>31)
...
#define  VBY1_VIDEO_FORMAT_get_vby1_aphy16_23_in_sel(data)                       ((0x03000000&(data))>>24)
...
#define  VBY1_TRANSMIT_STATUS_reset_sel_shift                                    (7)
#define  VBY1_TRANSMIT_STATUS_num_check_fail_shift                               (6)
#define  VBY1_TRANSMIT_STATUS_aln_finish_shift                                   (5)
#define  VBY1_TRANSMIT_STATUS_initial_finish_shift                               (4)
#define  VBY1_TRANSMIT_STATUS_cdr_out_en_shift                                   (3)
#define  VBY1_TRANSMIT_STATUS_video_en_shift                                     (2)
#define  VBY1_TRANSMIT_STATUS_aln_en_shift                                       (1)
#define  VBY1_TRANSMIT_STATUS_initial_en_shift                                   (0)
#define  VBY1_TRANSMIT_STATUS_dummy_31_8_mask                                    (0xFFFFFF00)
#define  VBY1_TRANSMIT_STATUS_reset_sel_mask                                     (0x00000080)
#define  VBY1_TRANSMIT_STATUS_num_check_fail_mask                                (0x00000040)
#define  VBY1_TRANSMIT_STATUS_aln_finish_mask                                    (0x00000020)
#define  VBY1_TRANSMIT_STATUS_initial_finish_mask                                (0x00000010)
#define  VBY1_TRANSMIT_STATUS_cdr_out_en_mask                                    (0x00000008)
#define  VBY1_TRANSMIT_STATUS_video_en_mask                                      (0x00000004)
#define  VBY1_TRANSMIT_STATUS_aln_en_mask                                        (0x00000002)
#define  VBY1_TRANSMIT_STATUS_initial_en_mask                                    (0x00000001)
#define  VBY1_TRANSMIT_STATUS_dummy_31_8(data)                                   (0xFFFFFF00&((data)<<8))
#define  VBY1_TRANSMIT_STATUS_reset_sel(data)                                    (0x00000080&((data)<<7))
#define  VBY1_TRANSMIT_STATUS_num_check_fail(data)                               (0x00000040&((data)<<6))
#define  VBY1_TRANSMIT_STATUS_aln_finish(data)                                   (0x00000020&((data)<<5))
#define  VBY1_TRANSMIT_STATUS_initial_finish(data)                               (0x00000010&((data)<<4))
#define  VBY1_TRANSMIT_STATUS_cdr_out_en(data)                                   (0x00000008&((data)<<3))
#define  VBY1_TRANSMIT_STATUS_video_en(data)                                     (0x00000004&((data)<<2))
#define  VBY1_TRANSMIT_STATUS_aln_en(data)                                       (0x00000002&((data)<<1))
#define  VBY1_TRANSMIT_STATUS_initial_en(data)                                   (0x00000001&(data))
#define  VBY1_TRANSMIT_STATUS_get_dummy_31_8(data)                               ((0xFFFFFF00&(data))>>8)
#define  VBY1_TRANSMIT_STATUS_get_reset_sel(data)                                ((0x00000080&(data))>>7)
#define  VBY1_TRANSMIT_STATUS_get_num_check_fail(data)                           ((0x00000040&(data))>>6)
#define  VBY1_TRANSMIT_STATUS_get_aln_finish(data)                               ((0x00000020&(data))>>5)
#define  VBY1_TRANSMIT_STATUS_get_initial_finish(data)                           ((0x00000010&(data))>>4)
#define  VBY1_TRANSMIT_STATUS_get_cdr_out_en(data)                               ((0x00000008&(data))>>3)
...
#define  VBY1_TRANSMIT_STATUS_get_initial_en(data)                               (0x00000001&(data))
...
#define  VBY1_BYTE_REPEAT_DROP                                                   0x1802D740
#define  VBY1_BYTE_REPEAT_DROP_reg_addr                                          "0xB802D740"
#define  VBY1_BYTE_REPEAT_DROP_reg                                               0xB802D740
#define  VBY1_BYTE_REPEAT_DROP_inst_addr                                         "0x000A"
#define  set_VBY1_BYTE_REPEAT_DROP_reg(data)                                     (*((volatile unsigned int*)VBY1_BYTE_REPEAT_DROP_reg)=data)
#define  get_VBY1_BYTE_REPEAT_DROP_reg                                           (*((volatile unsigned int*)VBY1_BYTE_REPEAT_DROP_reg))
#define  VBY1_BYTE_REPEAT_DROP_drop_1_byte_shift                                 (1)
#define  VBY1_BYTE_REPEAT_DROP_repeat_1_byte_shift                               (0)
#define  VBY1_BYTE_REPEAT_DROP_drop_1_byte_mask                                  (0x00000002)
#define  VBY1_BYTE_REPEAT_DROP_repeat_1_byte_mask                                (0x00000001)
#define  VBY1_BYTE_REPEAT_DROP_drop_1_byte(data)                                 (0x00000002&((data)<<1))
#define  VBY1_BYTE_REPEAT_DROP_repeat_1_byte(data)                               (0x00000001&(data))
#define  VBY1_BYTE_REPEAT_DROP_get_drop_1_byte(data)                             ((0x00000002&(data))>>1)
#define  VBY1_BYTE_REPEAT_DROP_get_repeat_1_byte(data)                           (0x00000001&(data))
...
#define  VBY1_ASYNC_FIFO_RST_inst_addr                                           "0x000B"
...
#define  VBY1_ASYNC_FIFO_RST_fifo_vs_rst_en_mask                                 (0x00010000)
#define  VBY1_ASYNC_FIFO_RST_fifo_vs_rst_delay_mask                              (0x0000FFFF)
#define  VBY1_ASYNC_FIFO_RST_fifo_vs_rst_en(data)                                (0x00010000&((data)<<16))
#define  VBY1_ASYNC_FIFO_RST_fifo_vs_rst_delay(data)                             (0x0000FFFF&(data))
#define  VBY1_ASYNC_FIFO_RST_get_fifo_vs_rst_en(data)                            ((0x00010000&(data))>>16)
...
#define  VBY1_VBY1_DEBUG_inst_addr                                               "0x000C"
...
#define  VBY1_VBY1_DEBUG_debug_mode_shift                                        (0)
#define  VBY1_VBY1_DEBUG_debug_mode_mask                                         (0x0000003F)
#define  VBY1_VBY1_DEBUG_debug_mode(data)                                        (0x0000003F&(data))
#define  VBY1_VBY1_DEBUG_get_debug_mode(data)                                    (0x0000003F&(data))
...
#define  VBY1_VBY1_STATUS_FW_CTRL_inst_addr                                      "0x000D"
...
#define  VBY1_LANE_CRC_CONTROL_inst_addr                                         "0x000E"
...
#define  VBY1_LANE_CRC_CONTROL_lane_8_crc_conti_shift                            (15)
#define  VBY1_LANE_CRC_CONTROL_lane_8_crc_start_shift                            (14)
#define  VBY1_LANE_CRC_CONTROL_lane_9_crc_conti_shift                            (13)
#define  VBY1_LANE_CRC_CONTROL_lane_9_crc_start_shift                            (12)
#define  VBY1_LANE_CRC_CONTROL_lane_10_crc_conti_shift                           (11)
#define  VBY1_LANE_CRC_CONTROL_lane_10_crc_start_shift                           (10)
#define  VBY1_LANE_CRC_CONTROL_lane_11_crc_conti_shift                           (9)
#define  VBY1_LANE_CRC_CONTROL_lane_11_crc_start_shift                           (8)
#define  VBY1_LANE_CRC_CONTROL_lane_12_crc_conti_shift                           (7)
#define  VBY1_LANE_CRC_CONTROL_lane_12_crc_start_shift                           (6)
#define  VBY1_LANE_CRC_CONTROL_lane_13_crc_conti_shift                           (5)
#define  VBY1_LANE_CRC_CONTROL_lane_13_crc_start_shift                           (4)
#define  VBY1_LANE_CRC_CONTROL_lane_14_crc_conti_shift                           (3)
#define  VBY1_LANE_CRC_CONTROL_lane_14_crc_start_shift                           (2)
#define  VBY1_LANE_CRC_CONTROL_lane_15_crc_conti_shift                           (1)
#define  VBY1_LANE_CRC_CONTROL_lane_15_crc_start_shift                           (0)
...
#define  VBY1_LANE_CRC_CONTROL_lane_8_crc_conti_mask                             (0x00008000)
#define  VBY1_LANE_CRC_CONTROL_lane_8_crc_start_mask                             (0x00004000)
#define  VBY1_LANE_CRC_CONTROL_lane_9_crc_conti_mask                             (0x00002000)
#define  VBY1_LANE_CRC_CONTROL_lane_9_crc_start_mask                             (0x00001000)
#define  VBY1_LANE_CRC_CONTROL_lane_10_crc_conti_mask                            (0x00000800)
#define  VBY1_LANE_CRC_CONTROL_lane_10_crc_start_mask                            (0x00000400)
#define  VBY1_LANE_CRC_CONTROL_lane_11_crc_conti_mask                            (0x00000200)
#define  VBY1_LANE_CRC_CONTROL_lane_11_crc_start_mask                            (0x00000100)
#define  VBY1_LANE_CRC_CONTROL_lane_12_crc_conti_mask                            (0x00000080)
#define  VBY1_LANE_CRC_CONTROL_lane_12_crc_start_mask                            (0x00000040)
#define  VBY1_LANE_CRC_CONTROL_lane_13_crc_conti_mask                            (0x00000020)
#define  VBY1_LANE_CRC_CONTROL_lane_13_crc_start_mask                            (0x00000010)
#define  VBY1_LANE_CRC_CONTROL_lane_14_crc_conti_mask                            (0x00000008)
#define  VBY1_LANE_CRC_CONTROL_lane_14_crc_start_mask                            (0x00000004)
#define  VBY1_LANE_CRC_CONTROL_lane_15_crc_conti_mask                            (0x00000002)
#define  VBY1_LANE_CRC_CONTROL_lane_15_crc_start_mask                            (0x00000001)
...
#define  VBY1_LANE_CRC_CONTROL_lane_8_crc_conti(data)                            (0x00008000&((data)<<15))
#define  VBY1_LANE_CRC_CONTROL_lane_8_crc_start(data)                            (0x00004000&((data)<<14))
#define  VBY1_LANE_CRC_CONTROL_lane_9_crc_conti(data)                            (0x00002000&((data)<<13))
#define  VBY1_LANE_CRC_CONTROL_lane_9_crc_start(data)                            (0x00001000&((data)<<12))
#define  VBY1_LANE_CRC_CONTROL_lane_10_crc_conti(data)                           (0x00000800&((data)<<11))
#define  VBY1_LANE_CRC_CONTROL_lane_10_crc_start(data)                           (0x00000400&((data)<<10))
#define  VBY1_LANE_CRC_CONTROL_lane_11_crc_conti(data)                           (0x00000200&((data)<<9))
#define  VBY1_LANE_CRC_CONTROL_lane_11_crc_start(data)                           (0x00000100&((data)<<8))
#define  VBY1_LANE_CRC_CONTROL_lane_12_crc_conti(data)                           (0x00000080&((data)<<7))
#define  VBY1_LANE_CRC_CONTROL_lane_12_crc_start(data)                           (0x00000040&((data)<<6))
#define  VBY1_LANE_CRC_CONTROL_lane_13_crc_conti(data)                           (0x00000020&((data)<<5))
#define  VBY1_LANE_CRC_CONTROL_lane_13_crc_start(data)                           (0x00000010&((data)<<4))
#define  VBY1_LANE_CRC_CONTROL_lane_14_crc_conti(data)                           (0x00000008&((data)<<3))
#define  VBY1_LANE_CRC_CONTROL_lane_14_crc_start(data)                           (0x00000004&((data)<<2))
#define  VBY1_LANE_CRC_CONTROL_lane_15_crc_conti(data)                           (0x00000002&((data)<<1))
#define  VBY1_LANE_CRC_CONTROL_lane_15_crc_start(data)                           (0x00000001&(data))
...
#define  VBY1_LANE_CRC_CONTROL_get_lane_8_crc_conti(data)                        ((0x00008000&(data))>>15)
#define  VBY1_LANE_CRC_CONTROL_get_lane_8_crc_start(data)                        ((0x00004000&(data))>>14)
#define  VBY1_LANE_CRC_CONTROL_get_lane_9_crc_conti(data)                        ((0x00002000&(data))>>13)
#define  VBY1_LANE_CRC_CONTROL_get_lane_9_crc_start(data)                        ((0x00001000&(data))>>12)
#define  VBY1_LANE_CRC_CONTROL_get_lane_10_crc_conti(data)                       ((0x00000800&(data))>>11)
#define  VBY1_LANE_CRC_CONTROL_get_lane_10_crc_start(data)                       ((0x00000400&(data))>>10)
#define  VBY1_LANE_CRC_CONTROL_get_lane_11_crc_conti(data)                       ((0x00000200&(data))>>9)
#define  VBY1_LANE_CRC_CONTROL_get_lane_11_crc_start(data)                       ((0x00000100&(data))>>8)
#define  VBY1_LANE_CRC_CONTROL_get_lane_12_crc_conti(data)                       ((0x00000080&(data))>>7)
#define  VBY1_LANE_CRC_CONTROL_get_lane_12_crc_start(data)                       ((0x00000040&(data))>>6)
#define  VBY1_LANE_CRC_CONTROL_get_lane_13_crc_conti(data)                       ((0x00000020&(data))>>5)
#define  VBY1_LANE_CRC_CONTROL_get_lane_13_crc_start(data)                       ((0x00000010&(data))>>4)
#define  VBY1_LANE_CRC_CONTROL_get_lane_14_crc_conti(data)                       ((0x00000008&(data))>>3)
#define  VBY1_LANE_CRC_CONTROL_get_lane_14_crc_start(data)                       ((0x00000004&(data))>>2)
#define  VBY1_LANE_CRC_CONTROL_get_lane_15_crc_conti(data)                       ((0x00000002&(data))>>1)
#define  VBY1_LANE_CRC_CONTROL_get_lane_15_crc_start(data)                       (0x00000001&(data))
...
#define  VBY1_LANE_0_CRC_RESULT_inst_addr                                        "0x000F"
...
#define  VBY1_LANE_1_CRC_RESULT_inst_addr                                        "0x0010"
...
#define  VBY1_LANE_2_CRC_RESULT_inst_addr                                        "0x0011"
...
#define  VBY1_LANE_3_CRC_RESULT_inst_addr                                        "0x0012"
...
#define  VBY1_LANE_4_CRC_RESULT_inst_addr                                        "0x0013"
...
#define  VBY1_LANE_5_CRC_RESULT_inst_addr                                        "0x0014"
...
#define  VBY1_LANE_6_CRC_RESULT_inst_addr                                        "0x0015"
...
#define  VBY1_LANE_7_CRC_RESULT_inst_addr                                        "0x0016"
...
#define  VBY1_LANE_8_CRC_RESULT                                                  0x1802D790
#define  VBY1_LANE_8_CRC_RESULT_reg_addr                                         "0xB802D790"
#define  VBY1_LANE_8_CRC_RESULT_reg                                              0xB802D790
#define  VBY1_LANE_8_CRC_RESULT_inst_addr                                        "0x0017"
#define  set_VBY1_LANE_8_CRC_RESULT_reg(data)                                    (*((volatile unsigned int*)VBY1_LANE_8_CRC_RESULT_reg)=data)
#define  get_VBY1_LANE_8_CRC_RESULT_reg                                          (*((volatile unsigned int*)VBY1_LANE_8_CRC_RESULT_reg))
#define  VBY1_LANE_8_CRC_RESULT_lane_8_crc_result_shift                          (0)
#define  VBY1_LANE_8_CRC_RESULT_lane_8_crc_result_mask                           (0xFFFFFFFF)
#define  VBY1_LANE_8_CRC_RESULT_lane_8_crc_result(data)                          (0xFFFFFFFF&(data))
#define  VBY1_LANE_8_CRC_RESULT_get_lane_8_crc_result(data)                      (0xFFFFFFFF&(data))

#define  VBY1_LANE_9_CRC_RESULT                                                  0x1802D794
#define  VBY1_LANE_9_CRC_RESULT_reg_addr                                         "0xB802D794"
#define  VBY1_LANE_9_CRC_RESULT_reg                                              0xB802D794
#define  VBY1_LANE_9_CRC_RESULT_inst_addr                                        "0x0018"
#define  set_VBY1_LANE_9_CRC_RESULT_reg(data)                                    (*((volatile unsigned int*)VBY1_LANE_9_CRC_RESULT_reg)=data)
#define  get_VBY1_LANE_9_CRC_RESULT_reg                                          (*((volatile unsigned int*)VBY1_LANE_9_CRC_RESULT_reg))
#define  VBY1_LANE_9_CRC_RESULT_lane_9_crc_result_shift                          (0)
#define  VBY1_LANE_9_CRC_RESULT_lane_9_crc_result_mask                           (0xFFFFFFFF)
#define  VBY1_LANE_9_CRC_RESULT_lane_9_crc_result(data)                          (0xFFFFFFFF&(data))
#define  VBY1_LANE_9_CRC_RESULT_get_lane_9_crc_result(data)                      (0xFFFFFFFF&(data))

#define  VBY1_LANE_10_CRC_RESULT                                                 0x1802D798
#define  VBY1_LANE_10_CRC_RESULT_reg_addr                                        "0xB802D798"
#define  VBY1_LANE_10_CRC_RESULT_reg                                             0xB802D798
#define  VBY1_LANE_10_CRC_RESULT_inst_addr                                       "0x0019"
#define  set_VBY1_LANE_10_CRC_RESULT_reg(data)                                   (*((volatile unsigned int*)VBY1_LANE_10_CRC_RESULT_reg)=data)
#define  get_VBY1_LANE_10_CRC_RESULT_reg                                         (*((volatile unsigned int*)VBY1_LANE_10_CRC_RESULT_reg))
#define  VBY1_LANE_10_CRC_RESULT_lane_10_crc_result_shift                        (0)
#define  VBY1_LANE_10_CRC_RESULT_lane_10_crc_result_mask                         (0xFFFFFFFF)
#define  VBY1_LANE_10_CRC_RESULT_lane_10_crc_result(data)                        (0xFFFFFFFF&(data))
#define  VBY1_LANE_10_CRC_RESULT_get_lane_10_crc_result(data)                    (0xFFFFFFFF&(data))

#define  VBY1_LANE_11_CRC_RESULT                                                 0x1802D79C
#define  VBY1_LANE_11_CRC_RESULT_reg_addr                                        "0xB802D79C"
#define  VBY1_LANE_11_CRC_RESULT_reg                                             0xB802D79C
#define  VBY1_LANE_11_CRC_RESULT_inst_addr                                       "0x001A"
#define  set_VBY1_LANE_11_CRC_RESULT_reg(data)                                   (*((volatile unsigned int*)VBY1_LANE_11_CRC_RESULT_reg)=data)
#define  get_VBY1_LANE_11_CRC_RESULT_reg                                         (*((volatile unsigned int*)VBY1_LANE_11_CRC_RESULT_reg))
#define  VBY1_LANE_11_CRC_RESULT_lane_11_crc_result_shift                        (0)
#define  VBY1_LANE_11_CRC_RESULT_lane_11_crc_result_mask                         (0xFFFFFFFF)
#define  VBY1_LANE_11_CRC_RESULT_lane_11_crc_result(data)                        (0xFFFFFFFF&(data))
#define  VBY1_LANE_11_CRC_RESULT_get_lane_11_crc_result(data)                    (0xFFFFFFFF&(data))

#define  VBY1_LANE_12_CRC_RESULT                                                 0x1802D7A0
#define  VBY1_LANE_12_CRC_RESULT_reg_addr                                        "0xB802D7A0"
#define  VBY1_LANE_12_CRC_RESULT_reg                                             0xB802D7A0
#define  VBY1_LANE_12_CRC_RESULT_inst_addr                                       "0x001B"
#define  set_VBY1_LANE_12_CRC_RESULT_reg(data)                                   (*((volatile unsigned int*)VBY1_LANE_12_CRC_RESULT_reg)=data)
#define  get_VBY1_LANE_12_CRC_RESULT_reg                                         (*((volatile unsigned int*)VBY1_LANE_12_CRC_RESULT_reg))
#define  VBY1_LANE_12_CRC_RESULT_lane_12_crc_result_shift                        (0)
#define  VBY1_LANE_12_CRC_RESULT_lane_12_crc_result_mask                         (0xFFFFFFFF)
#define  VBY1_LANE_12_CRC_RESULT_lane_12_crc_result(data)                        (0xFFFFFFFF&(data))
#define  VBY1_LANE_12_CRC_RESULT_get_lane_12_crc_result(data)                    (0xFFFFFFFF&(data))

#define  VBY1_LANE_13_CRC_RESULT                                                 0x1802D7A4
#define  VBY1_LANE_13_CRC_RESULT_reg_addr                                        "0xB802D7A4"
#define  VBY1_LANE_13_CRC_RESULT_reg                                             0xB802D7A4
#define  VBY1_LANE_13_CRC_RESULT_inst_addr                                       "0x001C"
#define  set_VBY1_LANE_13_CRC_RESULT_reg(data)                                   (*((volatile unsigned int*)VBY1_LANE_13_CRC_RESULT_reg)=data)
#define  get_VBY1_LANE_13_CRC_RESULT_reg                                         (*((volatile unsigned int*)VBY1_LANE_13_CRC_RESULT_reg))
#define  VBY1_LANE_13_CRC_RESULT_lane_13_crc_result_shift                        (0)
#define  VBY1_LANE_13_CRC_RESULT_lane_13_crc_result_mask                         (0xFFFFFFFF)
#define  VBY1_LANE_13_CRC_RESULT_lane_13_crc_result(data)                        (0xFFFFFFFF&(data))
#define  VBY1_LANE_13_CRC_RESULT_get_lane_13_crc_result(data)                    (0xFFFFFFFF&(data))

#define  VBY1_LANE_14_CRC_RESULT                                                 0x1802D7A8
#define  VBY1_LANE_14_CRC_RESULT_reg_addr                                        "0xB802D7A8"
#define  VBY1_LANE_14_CRC_RESULT_reg                                             0xB802D7A8
#define  VBY1_LANE_14_CRC_RESULT_inst_addr                                       "0x001D"
#define  set_VBY1_LANE_14_CRC_RESULT_reg(data)                                   (*((volatile unsigned int*)VBY1_LANE_14_CRC_RESULT_reg)=data)
#define  get_VBY1_LANE_14_CRC_RESULT_reg                                         (*((volatile unsigned int*)VBY1_LANE_14_CRC_RESULT_reg))
#define  VBY1_LANE_14_CRC_RESULT_lane_14_crc_result_shift                        (0)
#define  VBY1_LANE_14_CRC_RESULT_lane_14_crc_result_mask                         (0xFFFFFFFF)
#define  VBY1_LANE_14_CRC_RESULT_lane_14_crc_result(data)                        (0xFFFFFFFF&(data))
#define  VBY1_LANE_14_CRC_RESULT_get_lane_14_crc_result(data)                    (0xFFFFFFFF&(data))

#define  VBY1_LANE_15_CRC_RESULT                                                 0x1802D7AC
#define  VBY1_LANE_15_CRC_RESULT_reg_addr                                        "0xB802D7AC"
#define  VBY1_LANE_15_CRC_RESULT_reg                                             0xB802D7AC
#define  VBY1_LANE_15_CRC_RESULT_inst_addr                                       "0x001E"
#define  set_VBY1_LANE_15_CRC_RESULT_reg(data)                                   (*((volatile unsigned int*)VBY1_LANE_15_CRC_RESULT_reg)=data)
#define  get_VBY1_LANE_15_CRC_RESULT_reg                                         (*((volatile unsigned int*)VBY1_LANE_15_CRC_RESULT_reg))
#define  VBY1_LANE_15_CRC_RESULT_lane_15_crc_result_shift                        (0)
#define  VBY1_LANE_15_CRC_RESULT_lane_15_crc_result_mask                         (0xFFFFFFFF)
#define  VBY1_LANE_15_CRC_RESULT_lane_15_crc_result(data)                        (0xFFFFFFFF&(data))
#define  VBY1_LANE_15_CRC_RESULT_get_lane_15_crc_result(data)                    (0xFFFFFFFF&(data))

#define  VBY1_DATA_CAPTURE                                                       0x1802D7B0
#define  VBY1_DATA_CAPTURE_reg_addr                                              "0xB802D7B0"
#define  VBY1_DATA_CAPTURE_reg                                                   0xB802D7B0
#define  VBY1_DATA_CAPTURE_inst_addr                                             "0x001F"
...
#define  VBY1_DATA_CAPTURE_1_inst_addr                                           "0x0020"
...
#define  VBY1_DATA_CAPTURE_1_capture_data_39_32_shift                            (0)
#define  VBY1_DATA_CAPTURE_1_capture_data_39_32_mask                             (0x000000FF)
#define  VBY1_DATA_CAPTURE_1_capture_data_39_32(data)                            (0x000000FF&(data))
#define  VBY1_DATA_CAPTURE_1_get_capture_data_39_32(data)                        (0x000000FF&(data))
...
#define  VBY1_DATA_CAPTURE_2_inst_addr                                           "0x0021"
...
#define  VBY1_DATA_CAPTURE_2_capture_data_31_0_shift                             (0)
#define  VBY1_DATA_CAPTURE_2_capture_data_31_0_mask                              (0xFFFFFFFF)
#define  VBY1_DATA_CAPTURE_2_capture_data_31_0(data)                             (0xFFFFFFFF&(data))
#define  VBY1_DATA_CAPTURE_2_get_capture_data_31_0(data)                         (0xFFFFFFFF&(data))
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  lane_8_crc_conti:1;
        RBus_UInt32  lane_8_crc_start:1;
        RBus_UInt32  lane_9_crc_conti:1;
        RBus_UInt32  lane_9_crc_start:1;
        RBus_UInt32  lane_10_crc_conti:1;
        RBus_UInt32  lane_10_crc_start:1;
        RBus_UInt32  lane_11_crc_conti:1;
        RBus_UInt32  lane_11_crc_start:1;
        RBus_UInt32  lane_12_crc_conti:1;
        RBus_UInt32  lane_12_crc_start:1;
        RBus_UInt32  lane_13_crc_conti:1;
        RBus_UInt32  lane_13_crc_start:1;
        RBus_UInt32  lane_14_crc_conti:1;
        RBus_UInt32  lane_14_crc_start:1;
        RBus_UInt32  lane_15_crc_conti:1;
        RBus_UInt32  lane_15_crc_start:1;
    };
...
typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  lane_8_crc_result:32;
    };
}vby1_lane_8_crc_result_RBUS;

typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  lane_9_crc_result:32;
    };
}vby1_lane_9_crc_result_RBUS;

typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  lane_10_crc_result:32;
    };
}vby1_lane_10_crc_result_RBUS;

typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  lane_11_crc_result:32;
    };
}vby1_lane_11_crc_result_RBUS;

typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  lane_12_crc_result:32;
    };
}vby1_lane_12_crc_result_RBUS;

typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  lane_13_crc_result:32;
    };
}vby1_lane_13_crc_result_RBUS;

typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  lane_14_crc_result:32;
    };
}vby1_lane_14_crc_result_RBUS;

typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  lane_15_crc_result:32;
    };
}vby1_lane_15_crc_result_RBUS;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  num_check_fail:1;
        RBus_UInt32  reset_sel:1;
        RBus_UInt32  dummy1802d714_31:24;
    };
}vby1_transmit_status_RBUS;
