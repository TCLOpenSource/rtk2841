...
#define  MDOMAIN_VI_SUB_SUB_DMACTL_dummy_30_9_shift                              (9)
...
#define  MDOMAIN_VI_SUB_SUB_DMACTL_dummy_30_9_mask                               (0x7FFFFE00)
...
#define  MDOMAIN_VI_SUB_SUB_DMACTL_dummy_30_9(data)                              (0x7FFFFE00&((data)<<9))
...
#define  MDOMAIN_VI_SUB_SUB_DMACTL_get_dummy_30_9(data)                          ((0x7FFFFE00&(data))>>9)
...
#define  MDOMAIN_VI_SUB_SUB_Y1BUF_y_water_lvl_mask                               (0x0003FC00)
#define  MDOMAIN_VI_SUB_SUB_Y1BUF_y_water_lvl(data)                              (0x0003FC00&((data)<<10))
#define  MDOMAIN_VI_SUB_SUB_Y1BUF_get_y_water_lvl(data)                          ((0x0003FC00&(data))>>10)
...
#define  MDOMAIN_VI_SUB_SUB_C1BUF_c_water_lvl_mask                               (0x0FF00000)
#define  MDOMAIN_VI_SUB_SUB_C1BUF_c_water_lvl(data)                              (0x0FF00000&((data)<<20))
#define  MDOMAIN_VI_SUB_SUB_C1BUF_get_c_water_lvl(data)                          ((0x0FF00000&(data))>>20)
...
#define  MDOMAIN_VI_SUB_SUB_DMACTL1_dummy_15_0(data)                             (0x0000FFFF&(data))
...
#define  MDOMAIN_VI_SUB_SUB_DMACTL1_get_dummy_15_0(data)                         (0x0000FFFF&(data))
...
#define  MDOMAIN_VI_SUB_SUB_DMA_MIN_TIME_dummy_24_0_shift                        (0)
#define  MDOMAIN_VI_SUB_SUB_DMA_MIN_TIME_y1c1_min_time_mask                      (0x1E000000)
#define  MDOMAIN_VI_SUB_SUB_DMA_MIN_TIME_dummy_24_0_mask                         (0x01FFFFFF)
#define  MDOMAIN_VI_SUB_SUB_DMA_MIN_TIME_y1c1_min_time(data)                     (0x1E000000&((data)<<25))
#define  MDOMAIN_VI_SUB_SUB_DMA_MIN_TIME_dummy_24_0(data)                        (0x01FFFFFF&(data))
#define  MDOMAIN_VI_SUB_SUB_DMA_MIN_TIME_get_y1c1_min_time(data)                 ((0x1E000000&(data))>>25)
#define  MDOMAIN_VI_SUB_SUB_DMA_MIN_TIME_get_dummy_24_0(data)                    (0x01FFFFFF&(data))
...
#define  MDOMAIN_VI_SUB_SUB_INTEN_dma_fifo_of_int_en_shift                       (6)
#define  MDOMAIN_VI_SUB_SUB_INTEN_dma_fifo_uf_int_en_shift                       (5)
...
#define  MDOMAIN_VI_SUB_SUB_INTEN_dma_fifo_of_int_en_mask                        (0x00000040)
#define  MDOMAIN_VI_SUB_SUB_INTEN_dma_fifo_uf_int_en_mask                        (0x00000020)
...
#define  MDOMAIN_VI_SUB_SUB_INTEN_dma_fifo_of_int_en(data)                       (0x00000040&((data)<<6))
#define  MDOMAIN_VI_SUB_SUB_INTEN_dma_fifo_uf_int_en(data)                       (0x00000020&((data)<<5))
...
#define  MDOMAIN_VI_SUB_SUB_INTEN_get_dma_fifo_of_int_en(data)                   ((0x00000040&(data))>>6)
#define  MDOMAIN_VI_SUB_SUB_INTEN_get_dma_fifo_uf_int_en(data)                   ((0x00000020&(data))>>5)
...
#define  MDOMAIN_VI_SUB_SUB_INTST_dma_fifo_of_shift                              (6)
#define  MDOMAIN_VI_SUB_SUB_INTST_dma_fifo_uf_shift                              (5)
...
#define  MDOMAIN_VI_SUB_SUB_INTST_dma_fifo_of_mask                               (0x00000040)
#define  MDOMAIN_VI_SUB_SUB_INTST_dma_fifo_uf_mask                               (0x00000020)
...
#define  MDOMAIN_VI_SUB_SUB_INTST_dma_fifo_of(data)                              (0x00000040&((data)<<6))
#define  MDOMAIN_VI_SUB_SUB_INTST_dma_fifo_uf(data)                              (0x00000020&((data)<<5))
...
#define  MDOMAIN_VI_SUB_SUB_INTST_get_dma_fifo_of(data)                          ((0x00000040&(data))>>6)
#define  MDOMAIN_VI_SUB_SUB_INTST_get_dma_fifo_uf(data)                          ((0x00000020&(data))>>5)
...
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform                             0x18027174
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_reg_addr                    "0xB8027174"
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_reg                         0xB8027174
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_inst_addr                   "0x000F"
#define  set_MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_reg(data)               (*((volatile unsigned int*)MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_reg)=data)
#define  get_MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_reg                     (*((volatile unsigned int*)MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_reg))
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_line_step_shift             (3)
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_vi_addcmd_trans_en_shift    (0)
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_line_step_mask              (0xFFFFFFF8)
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_vi_addcmd_trans_en_mask     (0x00000001)
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_line_step(data)             (0xFFFFFFF8&((data)<<3))
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_vi_addcmd_trans_en(data)    (0x00000001&(data))
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_get_line_step(data)         ((0xFFFFFFF8&(data))>>3)
#define  MDOMAIN_VI_SUB_mdom_sub_vi_addcmd_transform_get_vi_addcmd_trans_en(data) (0x00000001&(data))

#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y                                  0x18027178
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_reg_addr                         "0xB8027178"
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_reg                              0xB8027178
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_inst_addr                        "0x0010"
#define  set_MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_reg(data)                    (*((volatile unsigned int*)MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_reg)=data)
#define  get_MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_reg                          (*((volatile unsigned int*)MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_reg))
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_y_ads_start_shift                (3)
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_y_ads_start_mask                 (0xFFFFFFF8)
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_y_ads_start(data)                (0xFFFFFFF8&((data)<<3))
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_y_get_y_ads_start(data)            ((0xFFFFFFF8&(data))>>3)

#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c                                  0x1802717C
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_reg_addr                         "0xB802717C"
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_reg                              0xB802717C
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_inst_addr                        "0x0011"
#define  set_MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_reg(data)                    (*((volatile unsigned int*)MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_reg)=data)
#define  get_MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_reg                          (*((volatile unsigned int*)MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_reg))
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_c_ads_start_shift                (3)
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_c_ads_start_mask                 (0xFFFFFFF8)
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_c_ads_start(data)                (0xFFFFFFF8&((data)<<3))
#define  MDOMAIN_VI_SUB_mdom_sub_vi_ads_start_c_get_c_ads_start(data)            ((0xFFFFFFF8&(data))>>3)
...
}mdomain_vi_sub_mdom_sub_vi_addcmd_transform_RBUS;
...
}mdomain_vi_sub_mdom_sub_vi_ads_start_y_RBUS;
...
}mdomain_vi_sub_mdom_sub_vi_ads_start_c_RBUS;
