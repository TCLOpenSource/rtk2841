...
#define  MDOMAIN_VI_MAIN_DMACTL_dummy_shift                                      (9)
...
#define  MDOMAIN_VI_MAIN_DMACTL_dummy_mask                                       (0x7FFFFE00)
...
#define  MDOMAIN_VI_MAIN_DMACTL_dummy(data)                                      (0x7FFFFE00&((data)<<9))
...
#define  MDOMAIN_VI_MAIN_DMACTL_get_dummy(data)                                  ((0x7FFFFE00&(data))>>9)
...
#define  MDOMAIN_VI_MAIN_Y1BUF_y_water_lvl_mask                                  (0x0000FC00)
#define  MDOMAIN_VI_MAIN_Y1BUF_y_water_lvl(data)                                 (0x0000FC00&((data)<<10))
#define  MDOMAIN_VI_MAIN_Y1BUF_get_y_water_lvl(data)                             ((0x0000FC00&(data))>>10)
...
#define  MDOMAIN_VI_MAIN_C1BUF_c_water_lvl_mask                                  (0x03F00000)
#define  MDOMAIN_VI_MAIN_C1BUF_c_water_lvl(data)                                 (0x03F00000&((data)<<20))
#define  MDOMAIN_VI_MAIN_C1BUF_get_c_water_lvl(data)                             ((0x03F00000&(data))>>20)
...
#define  MDOMAIN_VI_MAIN_DMACTL1_dummy(data)                                     (0x0000FFFF&(data))
...
#define  MDOMAIN_VI_MAIN_DMACTL1_get_dummy(data)                                 (0x0000FFFF&(data))
...
#define  MDOMAIN_VI_MAIN_DMA_MIN_TIME_dummy_shift                                (0)
#define  MDOMAIN_VI_MAIN_DMA_MIN_TIME_y1c1_min_time_mask                         (0x1E000000)
#define  MDOMAIN_VI_MAIN_DMA_MIN_TIME_dummy_mask                                 (0x01FFFFFF)
#define  MDOMAIN_VI_MAIN_DMA_MIN_TIME_y1c1_min_time(data)                        (0x1E000000&((data)<<25))
#define  MDOMAIN_VI_MAIN_DMA_MIN_TIME_dummy(data)                                (0x01FFFFFF&(data))
#define  MDOMAIN_VI_MAIN_DMA_MIN_TIME_get_y1c1_min_time(data)                    ((0x1E000000&(data))>>25)
#define  MDOMAIN_VI_MAIN_DMA_MIN_TIME_get_dummy(data)                            (0x01FFFFFF&(data))
...
#define  MDOMAIN_VI_MAIN_Y1OBUFF_y_buf_start_mask                                (0x01FF0000)
#define  MDOMAIN_VI_MAIN_Y1OBUFF_y_buf_end_mask                                  (0x000001FF)
#define  MDOMAIN_VI_MAIN_Y1OBUFF_y_buf_start(data)                               (0x01FF0000&((data)<<16))
#define  MDOMAIN_VI_MAIN_Y1OBUFF_y_buf_end(data)                                 (0x000001FF&(data))
#define  MDOMAIN_VI_MAIN_Y1OBUFF_get_y_buf_start(data)                           ((0x01FF0000&(data))>>16)
#define  MDOMAIN_VI_MAIN_Y1OBUFF_get_y_buf_end(data)                             (0x000001FF&(data))
...
#define  MDOMAIN_VI_MAIN_C1OBUFF_c_buf_start_mask                                (0x01FF0000)
#define  MDOMAIN_VI_MAIN_C1OBUFF_c_buf_end_mask                                  (0x000001FF)
#define  MDOMAIN_VI_MAIN_C1OBUFF_c_buf_start(data)                               (0x01FF0000&((data)<<16))
#define  MDOMAIN_VI_MAIN_C1OBUFF_c_buf_end(data)                                 (0x000001FF&(data))
#define  MDOMAIN_VI_MAIN_C1OBUFF_get_c_buf_start(data)                           ((0x01FF0000&(data))>>16)
#define  MDOMAIN_VI_MAIN_C1OBUFF_get_c_buf_end(data)                             (0x000001FF&(data))
