...
#define  OFFMS_MES_RESULT_VSTA_END_off_vx_sta_mask                               (0x1FFF0000)
#define  OFFMS_MES_RESULT_VSTA_END_off_vx_end_mask                               (0x00001FFF)
#define  OFFMS_MES_RESULT_VSTA_END_off_vx_sta(data)                              (0x1FFF0000&((data)<<16))
#define  OFFMS_MES_RESULT_VSTA_END_off_vx_end(data)                              (0x00001FFF&(data))
#define  OFFMS_MES_RESULT_VSTA_END_get_off_vx_sta(data)                          ((0x1FFF0000&(data))>>16)
#define  OFFMS_MES_RESULT_VSTA_END_get_off_vx_end(data)                          (0x00001FFF&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:3;
        RBus_UInt32  off_vx_sta:13;
        RBus_UInt32  res2:3;
        RBus_UInt32  off_vx_end:13;
    };
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  ie_off_vs_high_to:1;
        RBus_UInt32  ie_off_vs_per_to:1;
        RBus_UInt32  dummy1802111c_11:4;
        RBus_UInt32  res1:19;
        RBus_UInt32  ie_off_msdone:1;
    };
}offms_sp_ms3ie_RBUS;
