...
#define  H3DDMA_VI_IDMA_Y1BUF_y_water_lvl_mask                                   (0x0000FC00)
#define  H3DDMA_VI_IDMA_Y1BUF_y_water_lvl(data)                                  (0x0000FC00&((data)<<10))
#define  H3DDMA_VI_IDMA_Y1BUF_get_y_water_lvl(data)                              ((0x0000FC00&(data))>>10)
...
#define  H3DDMA_VI_IDMA_C1BUF_c_water_lvl_mask                                   (0x03F00000)
#define  H3DDMA_VI_IDMA_C1BUF_c_water_lvl(data)                                  (0x03F00000&((data)<<20))
#define  H3DDMA_VI_IDMA_C1BUF_get_c_water_lvl(data)                              ((0x03F00000&(data))>>20)
...
#define  H3DDMA_VI_IDMA_Y1OBUFF_y_buf_start_mask                                 (0x01FF0000)
#define  H3DDMA_VI_IDMA_Y1OBUFF_y_buf_end_mask                                   (0x000001FF)
#define  H3DDMA_VI_IDMA_Y1OBUFF_y_buf_start(data)                                (0x01FF0000&((data)<<16))
#define  H3DDMA_VI_IDMA_Y1OBUFF_y_buf_end(data)                                  (0x000001FF&(data))
#define  H3DDMA_VI_IDMA_Y1OBUFF_get_y_buf_start(data)                            ((0x01FF0000&(data))>>16)
#define  H3DDMA_VI_IDMA_Y1OBUFF_get_y_buf_end(data)                              (0x000001FF&(data))
...
#define  H3DDMA_VI_IDMA_C1OBUFF_c_buf_start_mask                                 (0x01FF0000)
#define  H3DDMA_VI_IDMA_C1OBUFF_c_buf_end_mask                                   (0x000001FF)
#define  H3DDMA_VI_IDMA_C1OBUFF_c_buf_start(data)                                (0x01FF0000&((data)<<16))
#define  H3DDMA_VI_IDMA_C1OBUFF_c_buf_end(data)                                  (0x000001FF&(data))
#define  H3DDMA_VI_IDMA_C1OBUFF_get_c_buf_start(data)                            ((0x01FF0000&(data))>>16)
#define  H3DDMA_VI_IDMA_C1OBUFF_get_c_buf_end(data)                              (0x000001FF&(data))
...
#define  H3DDMA_VI_vi_doublebuffer                                               0x18025B70
#define  H3DDMA_VI_vi_doublebuffer_reg_addr                                      "0xB8025B70"
#define  H3DDMA_VI_vi_doublebuffer_reg                                           0xB8025B70
#define  H3DDMA_VI_vi_doublebuffer_inst_addr                                     "0x000E"
#define  set_H3DDMA_VI_vi_doublebuffer_reg(data)                                 (*((volatile unsigned int*)H3DDMA_VI_vi_doublebuffer_reg)=data)
#define  get_H3DDMA_VI_vi_doublebuffer_reg                                       (*((volatile unsigned int*)H3DDMA_VI_vi_doublebuffer_reg))
#define  H3DDMA_VI_vi_doublebuffer_vi_db_apply_shift                             (2)
#define  H3DDMA_VI_vi_doublebuffer_vi_db_sel_shift                               (1)
#define  H3DDMA_VI_vi_doublebuffer_vi_db_en_shift                                (0)
#define  H3DDMA_VI_vi_doublebuffer_vi_db_apply_mask                              (0x00000004)
#define  H3DDMA_VI_vi_doublebuffer_vi_db_sel_mask                                (0x00000002)
#define  H3DDMA_VI_vi_doublebuffer_vi_db_en_mask                                 (0x00000001)
#define  H3DDMA_VI_vi_doublebuffer_vi_db_apply(data)                             (0x00000004&((data)<<2))
#define  H3DDMA_VI_vi_doublebuffer_vi_db_sel(data)                               (0x00000002&((data)<<1))
#define  H3DDMA_VI_vi_doublebuffer_vi_db_en(data)                                (0x00000001&(data))
#define  H3DDMA_VI_vi_doublebuffer_get_vi_db_apply(data)                         ((0x00000004&(data))>>2)
#define  H3DDMA_VI_vi_doublebuffer_get_vi_db_sel(data)                           ((0x00000002&(data))>>1)
#define  H3DDMA_VI_vi_doublebuffer_get_vi_db_en(data)                            (0x00000001&(data))
...
}h3ddma_vi_vi_doublebuffer_RBUS;
