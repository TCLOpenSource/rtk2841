...
unsigned int     reserved_0:8;
unsigned int     num:24;
}OSDCOMP_OSD1_SEG0_3D;

typedef struct 
{
unsigned int     a:32;
}OSDCOMP_WDMA_ADR_SEG0;

typedef struct 
{
unsigned int     a:32;
}OSDCOMP_WDMA_ADR_SEG0_3D;
