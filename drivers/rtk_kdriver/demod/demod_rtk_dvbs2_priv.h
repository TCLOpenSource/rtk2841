#ifndef  __DEMOD_REALTEK_I_DVBS2_PRIV_H__
#define  __DEMOD_REALTEK_I_DVBS2_PRIV_H__
...
} REALTEK_I_DVBS2_DRIVER_DATA;


#define DECODE_LOCK(x)      ((x==YES) ? DTV_SIGNAL_LOCK : DTV_SIGNAL_NOT_LOCK)


extern REALTEK_I_DVBS2_DRIVER_DATA* AllocRealtekIDvbs2Driver(
    COMM*               pComm,
    unsigned char       Addr,
    unsigned long       CrystalFreq
);

extern void ReleaseRealtekIDvbs2Driver(REALTEK_I_DVBS2_DRIVER_DATA *pDriver);
...
*/
#endif // __DEMOD_REALTEK_I_DVBS2_PRIV_H__
