...
#define REALTEK_H_DTMB_BASE_DBG(fmt, args...)         rtd_printk(KERN_DEBUG, "DEMO","Dtmb Debug, " fmt, ##args);
#define REALTEK_H_DTMB_BASE_INFO(fmt, args...)        rtd_printk(KERN_INFO, "DEMO","Dtmb Info, " fmt, ##args);
#define REALTEK_H_DTMB_BASE_WARNING(fmt, args...)     rtd_printk(KERN_WARNING, "DEMO","Dtmb Warning, " fmt, ##args);
