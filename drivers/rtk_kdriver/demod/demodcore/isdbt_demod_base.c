...
@brief   ISDBT demod default function definition

ISDBT demod default functions.
...
@see   ISDBT_DEMOD_FP_SET_REG_PAGE
	...
	)
{
	...
	//       start_bit + (DeviceAddr | writing_bit) + ISDBT_DEMOD_PAGE_REG_ADDR + PageNo + stop_bit
	WritingBytes[0] = ISDBT_DEMOD_PAGE_REG_ADDR;
...
@see   ISDBT_DEMOD_FP_SET_REG_BITS_WITH_PAGE
...
@see   ISDBT_DEMOD_FP_GET_REG_BITS_WITH_PAGE
