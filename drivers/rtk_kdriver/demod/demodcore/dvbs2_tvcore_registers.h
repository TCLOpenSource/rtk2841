...
#define TVCORE_VERSION_MINOR 0x09
...
/* Error flags */
#define TV_REG_ERROR_CODE 43

/* Warning flags */
#define TV_REG_WARNING_CODE 44

/* Write to this register to check if the currently selected vector transfer has completed. */
#define TV_REG_DEBUG_VECTOR_TRANSFER_STATUS 45

/* Write to this register to enable / disable ensigma SDK log wrap */
#define TV_REG_ENSIGMA_SDK_LOG_WRAP_CTRL 46

/* Total number of registers for tvcore */
#define TV_REG_NUM_COMMON_REG (47)
