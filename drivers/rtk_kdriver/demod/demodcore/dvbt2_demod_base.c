...
@brief   DVBT2 demod default function definition

DVBT2 demod default functions.
...
@see   DVBT2_DEMOD_FP_SET_REG_PAGE
	...
	)
{
	...
	//       start_bit + (DeviceAddr | writing_bit) + DVBT2_DEMOD_PAGE_REG_ADDR + PageNo + stop_bit
	WritingBytes[0] = DVBT2_DEMOD_PAGE_REG_ADDR;
...
@see   DVBT2_DEMOD_FP_SET_REG_BYTES
...
@see   DVBT2_DEMOD_FP_GET_REG_BYTES
...
@see   DVBT2_DEMOD_FP_SET_REG_MASK_BITS
...
@see   DVBT2_DEMOD_FP_GET_REG_MASK_BITS
...
@see   DVBT2_DEMOD_FP_SET_REG_BITS
...
@see   DVBT2_DEMOD_FP_GET_REG_BITS
...
@see   DVBT2_DEMOD_FP_SET_REG_BITS_WITH_PAGE
...
@see   DVBT2_DEMOD_FP_GET_REG_BITS_WITH_PAGE
...
/*
    Direct write hardware register
*/
...
)
{
    ...
    if(SetHwRegValue(RegAddr, RegVal) != FUNCTION_SUCCESS)
		goto error_status_set_demod_registers;
...
)
{
    ...
    if(GetHwRegValue(RegAddr, RegVal) != FUNCTION_SUCCESS)
		goto error_status_get_demod_registers;
