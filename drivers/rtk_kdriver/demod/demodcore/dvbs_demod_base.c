...
@brief   DVBS demod default function definition

DVBS demod default functions.
...
*/
int
dvbs_demod_addr_8bit_default_SetRegPage(
...
*/
int
dvbs_demod_addr_8bit_default_SetRegBytes(
	DVBS_DEMOD_MODULE *pDemod,
...
@see   DVBSDEMOD_FP_GET_REG_BYTES

*/
int
dvbs_demod_addr_8bit_default_GetRegBytes(
	DVBS_DEMOD_MODULE *pDemod,
	unsigned char RegStartAddr,
...
@see   DVBSDEMOD_FP_SET_REG_MASK_BITS

*/
int
dvbs_demod_addr_8bit_default_SetRegMaskBits(
	DVBS_DEMOD_MODULE *pDemod,
	unsigned char RegStartAddr,
	unsigned char Msb,
	unsigned char Lsb,
...
@see   DVBSDEMOD_FP_GET_REG_MASK_BITS

*/
int
dvbs_demod_addr_8bit_default_GetRegMaskBits(
	DVBS_DEMOD_MODULE *pDemod,
	unsigned char RegStartAddr,
	unsigned char Msb,
	unsigned char Lsb,
...
@see   DVBSDEMOD_FP_SET_REG_BITS

*/
int
dvbs_demod_addr_8bit_default_SetRegBits(
	DVBS_DEMOD_MODULE *pDemod,
	int RegBitName,
	const unsigned long WritingValue
	)
...
@see   DVBSDEMOD_FP_GET_REG_BITS

*/
int
dvbs_demod_addr_8bit_default_GetRegBits(
	DVBS_DEMOD_MODULE *pDemod,
	int RegBitName,
	unsigned long *pReadingValue
	)
...
@see   DVBSDEMOD_FP_SET_REG_BITS_WITH_PAGE

*/
int
dvbs_demod_addr_8bit_default_SetRegBitsWithPage(
	DVBS_DEMOD_MODULE *pDemod,
	int RegBitName,
	const unsigned long WritingValue
	)
...
@see   DVBSDEMOD_FP_GET_REG_BITS_WITH_PAGE

*/
int
dvbs_demod_addr_8bit_default_GetRegBitsWithPage(
	DVBS_DEMOD_MODULE *pDemod,
	int RegBitName,
	unsigned long *pReadingValue
	)
...
@see   DVBSDEMOD_FP_SET_REG_BYTES

*/
int
dvbs_demod_addr_16bit_default_SetRegBytes(
	DVBS_DEMOD_MODULE *pDemod,
...
*/
int
dvbs_demod_addr_16bit_default_GetRegBytes(
	DVBS_DEMOD_MODULE *pDemod,
	unsigned short RegStartAddr,
	unsigned char *pReadingBytes,
	unsigned long ByteNum
...
*/
int
dvbs_demod_addr_16bit_default_SetRegMaskBits(
	DVBS_DEMOD_MODULE *pDemod,
	unsigned short RegStartAddr,
	unsigned char Msb,
	unsigned char Lsb,
...
*/
int
dvbs_demod_addr_16bit_default_GetRegMaskBits(
	DVBS_DEMOD_MODULE *pDemod,
	unsigned short RegStartAddr,
	unsigned char Msb,
	unsigned char Lsb,
...
)
{
    ...
    REALTEK_I_DVBS_BASE_DBG("\033[1;32;31m" "TV_REG_TUNER_CFG_OVERRIDE = 0x%x\n" "\033[m", TunerCfg);
...
)
{
    ...
    REALTEK_I_DVBS_BASE_DBG("\033[1;32;31m" "TV_REG_PFM_SET_IF_GAIN_CTRL = 0x%x\n" "\033[m", TunerGainCtrl);
...
)
{
    ...
    REALTEK_I_DVBS_BASE_DBG("\033[1;32;31m" "TV_REG_PFM_FLAGS = 0x%x\n" "\033[m", Flags);
...
)
{
    ...
    REALTEK_I_DVBS_BASE_DBG("\033[1;32;31m" "TV_REG_PFM_IF_FREQ = 0x%x\n" "\033[m", IfFreq);
...
)
{
    ...
    REALTEK_I_DVBS_BASE_DBG("\033[1;32;31m" "TV_REG_PFM_OVERRIDE = 0x%x\n" "\033[m", PlatformCfg);
...
)
{
    ...
    REALTEK_I_DVBS_BASE_DBG("\033[1;32;31m" "TV_REG_PFM_IF_CLK_FREQUENCY = 0x%x\n" "\033[m", IfClk);
...
)
{
    ...
    REALTEK_I_DVBS_BASE_DBG("\033[1;32;31m" "TV_REG_PFM_LDPC_CLK_FREQUENCY = 0x%x\n" "\033[m", LdpcClk);
...
)
{
    ...
    REALTEK_I_DVBS_BASE_DBG("\033[1;32;31m" "TV_REG_PFM_UCC_CLK_FREQUENCY = 0x%x\n" "\033[m", UccClk);
...
)
{
    ...
    REALTEK_I_DVBS_BASE_DBG("\033[1;32;31m" "TV_REG_PFM_MCU_CLK_FREQUENCY = 0x%x\n" "\033[m", McuClk);
