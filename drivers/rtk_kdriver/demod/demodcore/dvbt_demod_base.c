...
@brief   DVBT demod default function definition

DVBT demod default functions.

*/
//#include <stdio.h>
//#include <string.h>
#include "dvbt_demod_base.h"
#include "dvbt_tvcore_registers.h"
...
)
{
	...
	//if(access("/usr/local/etc/dvdplayer/disabledemod", 0) == 0)
		//return FUNCTION_SUCCESS;
...
{
    REALTEK_I_DVBT_BASE_INFO("%s %s %d\n", __FILE__, __func__, __LINE__);
