...
#define  DISEQC_DSCU_CTL_tx_env_mode_shift                                       (30)
...
#define  DISEQC_DSCU_CTL_tx_env_mode_mask                                        (0x40000000)
...
#define  DISEQC_DSCU_CTL_tx_env_mode(data)                                       (0x40000000&((data)<<30))
...
#define  DISEQC_DSCU_CTL_get_tx_env_mode(data)                                   ((0x40000000&(data))>>30)
