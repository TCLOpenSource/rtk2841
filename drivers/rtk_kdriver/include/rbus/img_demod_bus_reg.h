/**
* @file Mac5-DesignSpec-IMG_DEMOD_BUS
...
#define  IMG_DEMOD_BUS_img_mem_bus_ctrl1_dw_wdone_sel_shift                      (5)
...
#define  IMG_DEMOD_BUS_img_mem_bus_ctrl1_dw_wdone_sel_mask                       (0x00000020)
...
#define  IMG_DEMOD_BUS_img_mem_bus_ctrl1_dw_wdone_sel(data)                      (0x00000020&((data)<<5))
...
#define  IMG_DEMOD_BUS_img_mem_bus_ctrl1_get_dw_wdone_sel(data)                  ((0x00000020&(data))>>5)
...
#define  IMG_DEMOD_BUS_sram_ctrl                                                 0x18072228
#define  IMG_DEMOD_BUS_sram_ctrl_reg_addr                                        "0xB8072228"
#define  IMG_DEMOD_BUS_sram_ctrl_reg                                             0xB8072228
#define  IMG_DEMOD_BUS_sram_ctrl_inst_addr                                       "0x0029"
#define  set_IMG_DEMOD_BUS_sram_ctrl_reg(data)                                   (*((volatile unsigned int*)IMG_DEMOD_BUS_sram_ctrl_reg)=data)
#define  get_IMG_DEMOD_BUS_sram_ctrl_reg                                         (*((volatile unsigned int*)IMG_DEMOD_BUS_sram_ctrl_reg))
#define  IMG_DEMOD_BUS_sram_ctrl_img_demod_rm_shift                              (4)
#define  IMG_DEMOD_BUS_sram_ctrl_img_demod_rme_shift                             (0)
#define  IMG_DEMOD_BUS_sram_ctrl_img_demod_rm_mask                               (0x000000F0)
#define  IMG_DEMOD_BUS_sram_ctrl_img_demod_rme_mask                              (0x00000001)
#define  IMG_DEMOD_BUS_sram_ctrl_img_demod_rm(data)                              (0x000000F0&((data)<<4))
#define  IMG_DEMOD_BUS_sram_ctrl_img_demod_rme(data)                             (0x00000001&(data))
#define  IMG_DEMOD_BUS_sram_ctrl_get_img_demod_rm(data)                          ((0x000000F0&(data))>>4)
#define  IMG_DEMOD_BUS_sram_ctrl_get_img_demod_rme(data)                         (0x00000001&(data))
...
#define  IMG_DEMOD_BUS_DEMOD_MP_TP                                               0x18072238
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_reg_addr                                      "0xB8072238"
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_reg                                           0xB8072238
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_inst_addr                                     "0x002B"
#define  set_IMG_DEMOD_BUS_DEMOD_MP_TP_reg(data)                                 (*((volatile unsigned int*)IMG_DEMOD_BUS_DEMOD_MP_TP_reg)=data)
#define  get_IMG_DEMOD_BUS_DEMOD_MP_TP_reg                                       (*((volatile unsigned int*)IMG_DEMOD_BUS_DEMOD_MP_TP_reg))
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_val_shift                        (13)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_sync_shift                       (12)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_data_shift                       (4)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_en_shift                         (0)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_val_mask                         (0x00002000)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_sync_mask                        (0x00001000)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_data_mask                        (0x00000FF0)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_en_mask                          (0x00000001)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_val(data)                        (0x00002000&((data)<<13))
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_sync(data)                       (0x00001000&((data)<<12))
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_data(data)                       (0x00000FF0&((data)<<4))
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_demod_tp_fix_en(data)                         (0x00000001&(data))
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_get_demod_tp_fix_val(data)                    ((0x00002000&(data))>>13)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_get_demod_tp_fix_sync(data)                   ((0x00001000&(data))>>12)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_get_demod_tp_fix_data(data)                   ((0x00000FF0&(data))>>4)
#define  IMG_DEMOD_BUS_DEMOD_MP_TP_get_demod_tp_fix_en(data)                     (0x00000001&(data))

#define  IMG_DEMOD_BUS_RTK_DEMOD                                                 0x1807223C
#define  IMG_DEMOD_BUS_RTK_DEMOD_reg_addr                                        "0xB807223C"
#define  IMG_DEMOD_BUS_RTK_DEMOD_reg                                             0xB807223C
#define  IMG_DEMOD_BUS_RTK_DEMOD_inst_addr                                       "0x002C"
#define  set_IMG_DEMOD_BUS_RTK_DEMOD_reg(data)                                   (*((volatile unsigned int*)IMG_DEMOD_BUS_RTK_DEMOD_reg)=data)
#define  get_IMG_DEMOD_BUS_RTK_DEMOD_reg                                         (*((volatile unsigned int*)IMG_DEMOD_BUS_RTK_DEMOD_reg))
#define  IMG_DEMOD_BUS_RTK_DEMOD_rtk_int_en_shift                                (4)
#define  IMG_DEMOD_BUS_RTK_DEMOD_bootcode_en_shift                               (0)
#define  IMG_DEMOD_BUS_RTK_DEMOD_rtk_int_en_mask                                 (0x00000010)
#define  IMG_DEMOD_BUS_RTK_DEMOD_bootcode_en_mask                                (0x00000001)
#define  IMG_DEMOD_BUS_RTK_DEMOD_rtk_int_en(data)                                (0x00000010&((data)<<4))
#define  IMG_DEMOD_BUS_RTK_DEMOD_bootcode_en(data)                               (0x00000001&(data))
#define  IMG_DEMOD_BUS_RTK_DEMOD_get_rtk_int_en(data)                            ((0x00000010&(data))>>4)
#define  IMG_DEMOD_BUS_RTK_DEMOD_get_bootcode_en(data)                           (0x00000001&(data))

#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL                                             0x18072260
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_reg_addr                                    "0xB8072260"
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_reg                                         0xB8072260
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_inst_addr                                   "0x002D"
#define  set_IMG_DEMOD_BUS_DEBUGDMA_CTRL_reg(data)                               (*((volatile unsigned int*)IMG_DEMOD_BUS_DEBUGDMA_CTRL_reg)=data)
#define  get_IMG_DEMOD_BUS_DEBUGDMA_CTRL_reg                                     (*((volatile unsigned int*)IMG_DEMOD_BUS_DEBUGDMA_CTRL_reg))
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_dump_sel_shift                              (24)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_dtv_debugdma_en_shift                       (20)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_demod_debugdma_circular_num_shift           (16)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_demod_debugdma_blen_shift                   (8)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_demod_debugdma_waterlvl_shift               (0)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_dump_sel_mask                               (0x07000000)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_dtv_debugdma_en_mask                        (0x00100000)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_demod_debugdma_circular_num_mask            (0x000F0000)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_demod_debugdma_blen_mask                    (0x00003F00)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_demod_debugdma_waterlvl_mask                (0x0000003F)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_dump_sel(data)                              (0x07000000&((data)<<24))
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_dtv_debugdma_en(data)                       (0x00100000&((data)<<20))
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_demod_debugdma_circular_num(data)           (0x000F0000&((data)<<16))
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_demod_debugdma_blen(data)                   (0x00003F00&((data)<<8))
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_demod_debugdma_waterlvl(data)               (0x0000003F&(data))
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_get_dump_sel(data)                          ((0x07000000&(data))>>24)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_get_dtv_debugdma_en(data)                   ((0x00100000&(data))>>20)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_get_demod_debugdma_circular_num(data)       ((0x000F0000&(data))>>16)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_get_demod_debugdma_blen(data)               ((0x00003F00&(data))>>8)
#define  IMG_DEMOD_BUS_DEBUGDMA_CTRL_get_demod_debugdma_waterlvl(data)           (0x0000003F&(data))

#define  IMG_DEMOD_BUS_DEBUGDMA_START_ADDR                                       0x18072264
#define  IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_reg_addr                              "0xB8072264"
#define  IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_reg                                   0xB8072264
#define  IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_inst_addr                             "0x002E"
#define  set_IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_reg(data)                         (*((volatile unsigned int*)IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_reg)=data)
#define  get_IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_reg                               (*((volatile unsigned int*)IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_reg))
#define  IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_demod_debugdma_startaddr_shift        (0)
#define  IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_demod_debugdma_startaddr_mask         (0x1FFFFFFF)
#define  IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_demod_debugdma_startaddr(data)        (0x1FFFFFFF&(data))
#define  IMG_DEMOD_BUS_DEBUGDMA_START_ADDR_get_demod_debugdma_startaddr(data)    (0x1FFFFFFF&(data))

#define  IMG_DEMOD_BUS_DEBUGDMA_END_ADDR                                         0x18072268
#define  IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_reg_addr                                "0xB8072268"
#define  IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_reg                                     0xB8072268
#define  IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_inst_addr                               "0x002F"
#define  set_IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_reg(data)                           (*((volatile unsigned int*)IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_reg)=data)
#define  get_IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_reg                                 (*((volatile unsigned int*)IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_reg))
#define  IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_demod_debugdma_endaddr_shift            (0)
#define  IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_demod_debugdma_endaddr_mask             (0x1FFFFFFF)
#define  IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_demod_debugdma_endaddr(data)            (0x1FFFFFFF&(data))
#define  IMG_DEMOD_BUS_DEBUGDMA_END_ADDR_get_demod_debugdma_endaddr(data)        (0x1FFFFFFF&(data))

#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS                                           0x1807226C
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_reg_addr                                  "0xB807226C"
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_reg                                       0xB807226C
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_inst_addr                                 "0x0030"
#define  set_IMG_DEMOD_BUS_DEBUGDMA_STATUS_reg(data)                             (*((volatile unsigned int*)IMG_DEMOD_BUS_DEBUGDMA_STATUS_reg)=data)
#define  get_IMG_DEMOD_BUS_DEBUGDMA_STATUS_reg                                   (*((volatile unsigned int*)IMG_DEMOD_BUS_DEBUGDMA_STATUS_reg))
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_underflow_clr_shift              (5)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_overflow_clr_shift               (4)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_underflow_shift                  (1)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_overflow_shift                   (0)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_underflow_clr_mask               (0x00000020)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_overflow_clr_mask                (0x00000010)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_underflow_mask                   (0x00000002)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_overflow_mask                    (0x00000001)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_underflow_clr(data)              (0x00000020&((data)<<5))
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_overflow_clr(data)               (0x00000010&((data)<<4))
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_underflow(data)                  (0x00000002&((data)<<1))
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_debugdma_overflow(data)                   (0x00000001&(data))
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_get_debugdma_underflow_clr(data)          ((0x00000020&(data))>>5)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_get_debugdma_overflow_clr(data)           ((0x00000010&(data))>>4)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_get_debugdma_underflow(data)              ((0x00000002&(data))>>1)
#define  IMG_DEMOD_BUS_DEBUGDMA_STATUS_get_debugdma_overflow(data)               (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_BIST_MODE                                          0x18072270
#define  IMG_DEMOD_BUS_DBGDMA_BIST_MODE_reg_addr                                 "0xB8072270"
#define  IMG_DEMOD_BUS_DBGDMA_BIST_MODE_reg                                      0xB8072270
#define  IMG_DEMOD_BUS_DBGDMA_BIST_MODE_inst_addr                                "0x0031"
#define  set_IMG_DEMOD_BUS_DBGDMA_BIST_MODE_reg(data)                            (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_MODE_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_BIST_MODE_reg                                  (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_MODE_reg))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_MODE_bist_mode_debugdma_shift                 (0)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_MODE_bist_mode_debugdma_mask                  (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_MODE_bist_mode_debugdma(data)                 (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_MODE_get_bist_mode_debugdma(data)             (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE                                      0x18072274
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_reg_addr                             "0xB8072274"
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_reg                                  0xB8072274
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_inst_addr                            "0x0032"
#define  set_IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_reg(data)                        (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_reg                              (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_reg))
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_drf_bist_mode_debugdma_shift         (0)
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_drf_bist_mode_debugdma_mask          (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_drf_bist_mode_debugdma(data)         (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_MODE_get_drf_bist_mode_debugdma(data)     (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE                                    0x18072278
#define  IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_reg_addr                           "0xB8072278"
#define  IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_reg                                0xB8072278
#define  IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_inst_addr                          "0x0033"
#define  set_IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_reg(data)                      (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_reg                            (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_reg))
#define  IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_drf_test_resume_debugdma_shift     (0)
#define  IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_drf_test_resume_debugdma_mask      (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_drf_test_resume_debugdma(data)     (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_DRF_RESUME_MODE_get_drf_test_resume_debugdma(data) (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVS                                           0x1807227C
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVS_reg_addr                                  "0xB807227C"
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVS_reg                                       0xB807227C
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVS_inst_addr                                 "0x0034"
#define  set_IMG_DEMOD_BUS_DBGDMA_BIST_DVS_reg(data)                             (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_DVS_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_BIST_DVS_reg                                   (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_DVS_reg))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVS_mbist_debugdma_dvs_shift                  (0)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVS_mbist_debugdma_dvs_mask                   (0x0000000F)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVS_mbist_debugdma_dvs(data)                  (0x0000000F&(data))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVS_get_mbist_debugdma_dvs(data)              (0x0000000F&(data))

#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVSE                                          0x18072280
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_reg_addr                                 "0xB8072280"
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_reg                                      0xB8072280
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_inst_addr                                "0x0035"
#define  set_IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_reg(data)                            (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_reg                                  (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_reg))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_mbist_debugdma_dvse_shift                (0)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_mbist_debugdma_dvse_mask                 (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_mbist_debugdma_dvse(data)                (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DVSE_get_mbist_debugdma_dvse(data)            (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_BIST_LS                                            0x18072284
#define  IMG_DEMOD_BUS_DBGDMA_BIST_LS_reg_addr                                   "0xB8072284"
#define  IMG_DEMOD_BUS_DBGDMA_BIST_LS_reg                                        0xB8072284
#define  IMG_DEMOD_BUS_DBGDMA_BIST_LS_inst_addr                                  "0x0036"
#define  set_IMG_DEMOD_BUS_DBGDMA_BIST_LS_reg(data)                              (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_LS_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_BIST_LS_reg                                    (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_LS_reg))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_LS_mbist_debugdma_ls_shift                    (0)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_LS_mbist_debugdma_ls_mask                     (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_LS_mbist_debugdma_ls(data)                    (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_LS_get_mbist_debugdma_ls(data)                (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_BIST_DONE                                          0x18072288
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DONE_reg_addr                                 "0xB8072288"
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DONE_reg                                      0xB8072288
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DONE_inst_addr                                "0x0037"
#define  set_IMG_DEMOD_BUS_DBGDMA_BIST_DONE_reg(data)                            (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_DONE_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_BIST_DONE_reg                                  (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_DONE_reg))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DONE_bist_done_debugdma_shift                 (0)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DONE_bist_done_debugdma_mask                  (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DONE_bist_done_debugdma(data)                 (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DONE_get_bist_done_debugdma(data)             (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_BIST_FAIL                                          0x1807228C
#define  IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_reg_addr                                 "0xB807228C"
#define  IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_reg                                      0xB807228C
#define  IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_inst_addr                                "0x0038"
#define  set_IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_reg(data)                            (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_reg                                  (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_reg))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_bist_fail_debugdma_shift                 (0)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_bist_fail_debugdma_mask                  (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_bist_fail_debugdma(data)                 (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_FAIL_get_bist_fail_debugdma(data)             (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE                                      0x18072290
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_reg_addr                             "0xB8072290"
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_reg                                  0xB8072290
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_inst_addr                            "0x0039"
#define  set_IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_reg(data)                        (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_reg                              (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_reg))
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_drf_bist_done_debugdma_shift         (0)
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_drf_bist_done_debugdma_mask          (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_drf_bist_done_debugdma(data)         (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_DONE_get_drf_bist_done_debugdma(data)     (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL                                      0x18072294
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_reg_addr                             "0xB8072294"
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_reg                                  0xB8072294
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_inst_addr                            "0x003A"
#define  set_IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_reg(data)                        (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_reg                              (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_reg))
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_drf_bist_fail_debugdma_shift         (0)
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_drf_bist_fail_debugdma_mask          (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_drf_bist_fail_debugdma(data)         (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_DRF_BIST_FAIL_get_drf_bist_fail_debugdma(data)     (0x00000001&(data))

#define  IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE                               0x18072298
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_reg_addr                      "0xB8072298"
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_reg                           0xB8072298
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_inst_addr                     "0x003B"
#define  set_IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_reg(data)                 (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_reg)=data)
#define  get_IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_reg                       (*((volatile unsigned int*)IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_reg))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_drf_start_pause_debugdma_shift (0)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_drf_start_pause_debugdma_mask (0x00000001)
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_drf_start_pause_debugdma(data) (0x00000001&(data))
#define  IMG_DEMOD_BUS_DBGDMA_BIST_DRF_START_PAUSE_get_drf_start_pause_debugdma(data) (0x00000001&(data))
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:24;
        RBus_UInt32  img_demod_rm:4;
        RBus_UInt32  res2:3;
        RBus_UInt32  img_demod_rme:1;
    };
}img_demod_bus_sram_ctrl_RBUS;
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  demod_tp_fix_data:8;
        RBus_UInt32  res2:3;
        RBus_UInt32  demod_tp_fix_en:1;
    };
}img_demod_bus_demod_mp_tp_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:27;
        RBus_UInt32  rtk_int_en:1;
        RBus_UInt32  res2:3;
        RBus_UInt32  bootcode_en:1;
    };
}img_demod_bus_rtk_demod_RBUS;
...
}img_demod_bus_debugdma_ctrl_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:3;
        RBus_UInt32  demod_debugdma_startaddr:29;
    };
}img_demod_bus_debugdma_start_addr_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:3;
        RBus_UInt32  demod_debugdma_endaddr:29;
    };
}img_demod_bus_debugdma_end_addr_RBUS;
...
}img_demod_bus_debugdma_status_RBUS;
...
}img_demod_bus_dbgdma_bist_mode_RBUS;
...
}img_demod_bus_dbgdma_drf_bist_mode_RBUS;
...
}img_demod_bus_dbgdma_drf_resume_mode_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:28;
        RBus_UInt32  mbist_debugdma_dvs:4;
    };
}img_demod_bus_dbgdma_bist_dvs_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:31;
        RBus_UInt32  mbist_debugdma_dvse:1;
    };
}img_demod_bus_dbgdma_bist_dvse_RBUS;
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:31;
        RBus_UInt32  mbist_debugdma_ls:1;
    };
}img_demod_bus_dbgdma_bist_ls_RBUS;
...
}img_demod_bus_dbgdma_bist_done_RBUS;
...
}img_demod_bus_dbgdma_bist_fail_RBUS;
...
}img_demod_bus_dbgdma_drf_bist_done_RBUS;
...
}img_demod_bus_dbgdma_drf_bist_fail_RBUS;
...
}img_demod_bus_dbgdma_bist_drf_start_pause_RBUS;
