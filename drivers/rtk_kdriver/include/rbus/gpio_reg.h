/**
* @file Macarthur5-DesignSpec-ISO_MISC_GPIO
...
#define  GPIO_GPDIR_1_gpdir_mask                                                 (0x0FFFFFFF)
#define  GPIO_GPDIR_1_gpdir(data)                                                (0x0FFFFFFF&(data))
#define  GPIO_GPDIR_1_get_gpdir(data)                                            (0x0FFFFFFF&(data))
...
#define  GPIO_GPDATO_1_gpdato_mask                                               (0x0FFFFFFF)
#define  GPIO_GPDATO_1_gpdato(data)                                              (0x0FFFFFFF&(data))
#define  GPIO_GPDATO_1_get_gpdato(data)                                          (0x0FFFFFFF&(data))
...
#define  GPIO_GPDATI_1_gpdati_mask                                               (0x0FFFFFFF)
#define  GPIO_GPDATI_1_gpdati(data)                                              (0x0FFFFFFF&(data))
#define  GPIO_GPDATI_1_get_gpdati(data)                                          (0x0FFFFFFF&(data))
...
#define  GPIO_GPIE_1_gp_mask                                                     (0x0FFFFFFF)
#define  GPIO_GPIE_1_gp(data)                                                    (0x0FFFFFFF&(data))
#define  GPIO_GPIE_1_get_gp(data)                                                (0x0FFFFFFF&(data))
...
#define  GPIO_GPDP_1_gpha_mask                                                   (0x0FFFFFFF)
#define  GPIO_GPDP_1_gpha(data)                                                  (0x0FFFFFFF&(data))
#define  GPIO_GPDP_1_get_gpha(data)                                              (0x0FFFFFFF&(data))
...
#define  GPIO_ISR_GPI_ASSERT_int1_a_shift                                        (2)
#define  GPIO_ISR_GPI_ASSERT_int0_a_shift                                        (1)
#define  GPIO_ISR_GPI_ASSERT_write_data_shift                                    (0)
#define  GPIO_ISR_GPI_ASSERT_int1_a_mask                                         (0x00000004)
#define  GPIO_ISR_GPI_ASSERT_int0_a_mask                                         (0x00000002)
#define  GPIO_ISR_GPI_ASSERT_write_data_mask                                     (0x00000001)
#define  GPIO_ISR_GPI_ASSERT_int1_a(data)                                        (0x00000004&((data)<<2))
#define  GPIO_ISR_GPI_ASSERT_int0_a(data)                                        (0x00000002&((data)<<1))
#define  GPIO_ISR_GPI_ASSERT_write_data(data)                                    (0x00000001&(data))
#define  GPIO_ISR_GPI_ASSERT_get_int1_a(data)                                    ((0x00000004&(data))>>2)
#define  GPIO_ISR_GPI_ASSERT_get_int0_a(data)                                    ((0x00000002&(data))>>1)
#define  GPIO_ISR_GPI_ASSERT_get_write_data(data)                                (0x00000001&(data))
...
#define  GPIO_ISR_GPI_DEASSERT_int1_da_shift                                     (2)
#define  GPIO_ISR_GPI_DEASSERT_int0_da_shift                                     (1)
#define  GPIO_ISR_GPI_DEASSERT_write_data_shift                                  (0)
#define  GPIO_ISR_GPI_DEASSERT_int1_da_mask                                      (0x00000004)
#define  GPIO_ISR_GPI_DEASSERT_int0_da_mask                                      (0x00000002)
#define  GPIO_ISR_GPI_DEASSERT_write_data_mask                                   (0x00000001)
#define  GPIO_ISR_GPI_DEASSERT_int1_da(data)                                     (0x00000004&((data)<<2))
#define  GPIO_ISR_GPI_DEASSERT_int0_da(data)                                     (0x00000002&((data)<<1))
#define  GPIO_ISR_GPI_DEASSERT_write_data(data)                                  (0x00000001&(data))
#define  GPIO_ISR_GPI_DEASSERT_get_int1_da(data)                                 ((0x00000004&(data))>>2)
#define  GPIO_ISR_GPI_DEASSERT_get_int0_da(data)                                 ((0x00000002&(data))>>1)
#define  GPIO_ISR_GPI_DEASSERT_get_write_data(data)                              (0x00000001&(data))
