/**
* @file Mac5-DesignSpec-D-Domain_Subtitle_Overlay
...
#define  SUBTOVL_Mixer_CTRL1_dummy_31_17_shift                                   (17)
#define  SUBTOVL_Mixer_CTRL1_subt_other_ch_ble_sel_shift                         (16)
#define  SUBTOVL_Mixer_CTRL1_dummy_15_13_shift                                   (13)
#define  SUBTOVL_Mixer_CTRL1_subt_dis_conbri_shift                               (12)
#define  SUBTOVL_Mixer_CTRL1_dummy_11_shift                                      (11)
...
#define  SUBTOVL_Mixer_CTRL1_dummy_5_shift                                       (5)
#define  SUBTOVL_Mixer_CTRL1_subt_blending_en_shift                              (4)
#define  SUBTOVL_Mixer_CTRL1_dummy_3_1_shift                                     (1)
#define  SUBTOVL_Mixer_CTRL1_subt_en_shift                                       (0)
#define  SUBTOVL_Mixer_CTRL1_dummy_31_17_mask                                    (0xFFFE0000)
#define  SUBTOVL_Mixer_CTRL1_subt_other_ch_ble_sel_mask                          (0x00010000)
#define  SUBTOVL_Mixer_CTRL1_dummy_15_13_mask                                    (0x0000E000)
#define  SUBTOVL_Mixer_CTRL1_subt_dis_conbri_mask                                (0x00001000)
#define  SUBTOVL_Mixer_CTRL1_dummy_11_mask                                       (0x00000800)
...
#define  SUBTOVL_Mixer_CTRL1_dummy_5_mask                                        (0x00000020)
#define  SUBTOVL_Mixer_CTRL1_subt_blending_en_mask                               (0x00000010)
#define  SUBTOVL_Mixer_CTRL1_dummy_3_1_mask                                      (0x0000000E)
#define  SUBTOVL_Mixer_CTRL1_subt_en_mask                                        (0x00000001)
#define  SUBTOVL_Mixer_CTRL1_dummy_31_17(data)                                   (0xFFFE0000&((data)<<17))
#define  SUBTOVL_Mixer_CTRL1_subt_other_ch_ble_sel(data)                         (0x00010000&((data)<<16))
#define  SUBTOVL_Mixer_CTRL1_dummy_15_13(data)                                   (0x0000E000&((data)<<13))
#define  SUBTOVL_Mixer_CTRL1_subt_dis_conbri(data)                               (0x00001000&((data)<<12))
#define  SUBTOVL_Mixer_CTRL1_dummy_11(data)                                      (0x00000800&((data)<<11))
...
#define  SUBTOVL_Mixer_CTRL1_dummy_5(data)                                       (0x00000020&((data)<<5))
#define  SUBTOVL_Mixer_CTRL1_subt_blending_en(data)                              (0x00000010&((data)<<4))
#define  SUBTOVL_Mixer_CTRL1_dummy_3_1(data)                                     (0x0000000E&((data)<<1))
#define  SUBTOVL_Mixer_CTRL1_subt_en(data)                                       (0x00000001&(data))
#define  SUBTOVL_Mixer_CTRL1_get_dummy_31_17(data)                               ((0xFFFE0000&(data))>>17)
#define  SUBTOVL_Mixer_CTRL1_get_subt_other_ch_ble_sel(data)                     ((0x00010000&(data))>>16)
#define  SUBTOVL_Mixer_CTRL1_get_dummy_15_13(data)                               ((0x0000E000&(data))>>13)
#define  SUBTOVL_Mixer_CTRL1_get_subt_dis_conbri(data)                           ((0x00001000&(data))>>12)
#define  SUBTOVL_Mixer_CTRL1_get_dummy_11(data)                                  ((0x00000800&(data))>>11)
...
#define  SUBTOVL_Mixer_CTRL1_get_dummy_5(data)                                   ((0x00000020&(data))>>5)
#define  SUBTOVL_Mixer_CTRL1_get_subt_blending_en(data)                          ((0x00000010&(data))>>4)
#define  SUBTOVL_Mixer_CTRL1_get_dummy_3_1(data)                                 ((0x0000000E&(data))>>1)
...
typedef union
{
    ...
    struct{
        RBus_UInt32  dummy1802bf00_31_17:15;
        RBus_UInt32  subt_other_ch_ble_sel:1;
        RBus_UInt32  dummy1802bf00_15_13:3;
        RBus_UInt32  subt_dis_conbri:1;
        RBus_UInt32  dummy1802bf00_11:1;
        ...
        RBus_UInt32  dummy1802bf00_5:1;
        RBus_UInt32  subt_blending_en:1;
        RBus_UInt32  dummy1802bf00_3_1:3;
