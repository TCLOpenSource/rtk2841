/**
* @file MacArthur5-DesignSpec-I-Domain_SmartFIT
...
#define  SMARTFIT_AUTO_PHASE_CTRL0_new_ap_en_shift                               (30)
...
#define  SMARTFIT_AUTO_PHASE_CTRL0_new_ap_en_mask                                (0x40000000)
...
#define  SMARTFIT_AUTO_PHASE_CTRL0_new_ap_en(data)                               (0x40000000&((data)<<30))
...
#define  SMARTFIT_AUTO_PHASE_CTRL0_get_new_ap_en(data)                           ((0x40000000&(data))>>30)
...
#define  SMARTFIT_PLLPHASE_CTRL                                                  0x18022028
#define  SMARTFIT_PLLPHASE_CTRL_reg_addr                                         "0xB8022028"
#define  SMARTFIT_PLLPHASE_CTRL_reg                                              0xB8022028
#define  SMARTFIT_PLLPHASE_CTRL_inst_addr                                        "0x000A"
#define  set_SMARTFIT_PLLPHASE_CTRL_reg(data)                                    (*((volatile unsigned int*)SMARTFIT_PLLPHASE_CTRL_reg)=data)
#define  get_SMARTFIT_PLLPHASE_CTRL_reg                                          (*((volatile unsigned int*)SMARTFIT_PLLPHASE_CTRL_reg))
#define  SMARTFIT_PLLPHASE_CTRL_pll2_ph_lut_shift                                (22)
#define  SMARTFIT_PLLPHASE_CTRL_pll2d2_shift                                     (20)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_d2x_shift                                   (19)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_d2y_shift                                   (18)
#define  SMARTFIT_PLLPHASE_CTRL_pll2x_shift                                      (17)
#define  SMARTFIT_PLLPHASE_CTRL_pll2y_shift                                      (16)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_psel_shift                                  (8)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_ph_lut_index_msb_shift                      (6)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_ph_lut_index_shift                          (0)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_ph_lut_mask                                 (0x00400000)
#define  SMARTFIT_PLLPHASE_CTRL_pll2d2_mask                                      (0x00100000)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_d2x_mask                                    (0x00080000)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_d2y_mask                                    (0x00040000)
#define  SMARTFIT_PLLPHASE_CTRL_pll2x_mask                                       (0x00020000)
#define  SMARTFIT_PLLPHASE_CTRL_pll2y_mask                                       (0x00010000)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_psel_mask                                   (0x00001F00)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_ph_lut_index_msb_mask                       (0x00000040)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_ph_lut_index_mask                           (0x0000003F)
#define  SMARTFIT_PLLPHASE_CTRL_pll2_ph_lut(data)                                (0x00400000&((data)<<22))
#define  SMARTFIT_PLLPHASE_CTRL_pll2d2(data)                                     (0x00100000&((data)<<20))
#define  SMARTFIT_PLLPHASE_CTRL_pll2_d2x(data)                                   (0x00080000&((data)<<19))
#define  SMARTFIT_PLLPHASE_CTRL_pll2_d2y(data)                                   (0x00040000&((data)<<18))
#define  SMARTFIT_PLLPHASE_CTRL_pll2x(data)                                      (0x00020000&((data)<<17))
#define  SMARTFIT_PLLPHASE_CTRL_pll2y(data)                                      (0x00010000&((data)<<16))
#define  SMARTFIT_PLLPHASE_CTRL_pll2_psel(data)                                  (0x00001F00&((data)<<8))
#define  SMARTFIT_PLLPHASE_CTRL_pll2_ph_lut_index_msb(data)                      (0x00000040&((data)<<6))
#define  SMARTFIT_PLLPHASE_CTRL_pll2_ph_lut_index(data)                          (0x0000003F&(data))
#define  SMARTFIT_PLLPHASE_CTRL_get_pll2_ph_lut(data)                            ((0x00400000&(data))>>22)
#define  SMARTFIT_PLLPHASE_CTRL_get_pll2d2(data)                                 ((0x00100000&(data))>>20)
#define  SMARTFIT_PLLPHASE_CTRL_get_pll2_d2x(data)                               ((0x00080000&(data))>>19)
#define  SMARTFIT_PLLPHASE_CTRL_get_pll2_d2y(data)                               ((0x00040000&(data))>>18)
#define  SMARTFIT_PLLPHASE_CTRL_get_pll2x(data)                                  ((0x00020000&(data))>>17)
#define  SMARTFIT_PLLPHASE_CTRL_get_pll2y(data)                                  ((0x00010000&(data))>>16)
#define  SMARTFIT_PLLPHASE_CTRL_get_pll2_psel(data)                              ((0x00001F00&(data))>>8)
#define  SMARTFIT_PLLPHASE_CTRL_get_pll2_ph_lut_index_msb(data)                  ((0x00000040&(data))>>6)
#define  SMARTFIT_PLLPHASE_CTRL_get_pll2_ph_lut_index(data)                      (0x0000003F&(data))

#define  SMARTFIT_AUTO_RESULT_PHASE_2_M                                          0x1802202C
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_reg_addr                                 "0xB802202C"
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_reg                                      0xB802202C
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_inst_addr                                "0x000B"
#define  set_SMARTFIT_AUTO_RESULT_PHASE_2_M_reg(data)                            (*((volatile unsigned int*)SMARTFIT_AUTO_RESULT_PHASE_2_M_reg)=data)
#define  get_SMARTFIT_AUTO_RESULT_PHASE_2_M_reg                                  (*((volatile unsigned int*)SMARTFIT_AUTO_RESULT_PHASE_2_M_reg))
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_max_2nd_ph_shift                         (10)
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_acc_2nd_41_32_shift                      (0)
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_max_2nd_ph_mask                          (0x0001FC00)
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_acc_2nd_41_32_mask                       (0x000003FF)
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_max_2nd_ph(data)                         (0x0001FC00&((data)<<10))
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_acc_2nd_41_32(data)                      (0x000003FF&(data))
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_get_max_2nd_ph(data)                     ((0x0001FC00&(data))>>10)
#define  SMARTFIT_AUTO_RESULT_PHASE_2_M_get_acc_2nd_41_32(data)                  (0x000003FF&(data))

#define  SMARTFIT_AUTO_RESULT_PHASE_2_L                                          0x18022030
#define  SMARTFIT_AUTO_RESULT_PHASE_2_L_reg_addr                                 "0xB8022030"
#define  SMARTFIT_AUTO_RESULT_PHASE_2_L_reg                                      0xB8022030
#define  SMARTFIT_AUTO_RESULT_PHASE_2_L_inst_addr                                "0x000C"
#define  set_SMARTFIT_AUTO_RESULT_PHASE_2_L_reg(data)                            (*((volatile unsigned int*)SMARTFIT_AUTO_RESULT_PHASE_2_L_reg)=data)
#define  get_SMARTFIT_AUTO_RESULT_PHASE_2_L_reg                                  (*((volatile unsigned int*)SMARTFIT_AUTO_RESULT_PHASE_2_L_reg))
#define  SMARTFIT_AUTO_RESULT_PHASE_2_L_acc_2nd_31_0_shift                       (0)
#define  SMARTFIT_AUTO_RESULT_PHASE_2_L_acc_2nd_31_0_mask                        (0xFFFFFFFF)
#define  SMARTFIT_AUTO_RESULT_PHASE_2_L_acc_2nd_31_0(data)                       (0xFFFFFFFF&(data))
#define  SMARTFIT_AUTO_RESULT_PHASE_2_L_get_acc_2nd_31_0(data)                   (0xFFFFFFFF&(data))
...
}smartfit_auto_result_phase_2_m_RBUS;
...
}smartfit_auto_result_phase_2_l_RBUS;
