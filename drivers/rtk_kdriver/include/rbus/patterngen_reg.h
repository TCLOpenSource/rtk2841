/**
* @file MacArthur5-DesignSpec-I-Domain-PatternGen
...
#define  PATTERNGEN_PTG_TG_ptg_clk_gate_off_shift                                (2)
...
#define  PATTERNGEN_PTG_TG_ptg_clk_gate_off_mask                                 (0x00000004)
...
#define  PATTERNGEN_PTG_TG_ptg_clk_gate_off(data)                                (0x00000004&((data)<<2))
...
#define  PATTERNGEN_PTG_TG_get_ptg_clk_gate_off(data)                            ((0x00000004&(data))>>2)
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res3:1;
        RBus_UInt32  ptg_clk_gate_off:1;
