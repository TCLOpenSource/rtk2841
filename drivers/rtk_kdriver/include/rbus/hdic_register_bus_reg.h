/**
* @file Mac5-DesignSpec-DEMOD_HDIC_Wrapper
...
#define  HDIC_REGISTER_BUS_hdic_mem_bus_ctrl1_hdic_wrapper_wdone_sel_shift       (5)
...
#define  HDIC_REGISTER_BUS_hdic_mem_bus_ctrl1_hdic_wrapper_wdone_sel_mask        (0x00000020)
...
#define  HDIC_REGISTER_BUS_hdic_mem_bus_ctrl1_hdic_wrapper_wdone_sel(data)       (0x00000020&((data)<<5))
...
#define  HDIC_REGISTER_BUS_hdic_mem_bus_ctrl1_get_hdic_wrapper_wdone_sel(data)   ((0x00000020&(data))>>5)
...
typedef union
{
    ...
    struct{
        ...
        RBus_UInt32  res2:6;
        RBus_UInt32  res3:10;
        RBus_UInt32  hdic_wrapper_wdone_sel:1;
