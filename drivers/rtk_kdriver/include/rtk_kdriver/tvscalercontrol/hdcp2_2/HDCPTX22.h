...
#include <tvscalercontrol/hdcp2_2/HDCP_TXRX_CMD.h>
#include <tvscalercontrol/hdcp2_2/HDCP_ERROR.h>
...
//#define spu_SetCertRx(v)         RTK_RCP_SET_CW_HDCP2(SRAM_CERT_RX_ENTRY + 1, (unsigned char*) v, CERT_RX_SIZE)
//#define spu_GetCertRx(v)         RTK_RCP_GET_CW_HDCP2(SRAM_CERT_RX_ENTRY + 1, (unsigned char*) v, CERT_RX_SIZE)

//#define spu_SetKPrivRx(v)        RTK_RCP_SET_CW_HDCP2(SRAM_KPRIV_RX_ENTRY + 1, (unsigned char*) v, KPRIVRX_SIZE)
//#define spu_GetKPrivRx(v)        RTK_RCP_GET_CW_HDCP2(SRAM_KPRIV_RX_ENTRY + 1, (unsigned char*) v, KPRIVRX_SIZE)
...
#define spu_SetKM(v)             RTK_RCP_SET_CW_HDCP2(SRAM_KM_ENTRY , (unsigned char*) v, KM_SIZE)
#define spu_GetKM(v)             RTK_RCP_GET_CW_HDCP2(SRAM_KM_ENTRY , (unsigned char*) v, KM_SIZE)
