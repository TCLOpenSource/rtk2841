...
#include <rbus/iso_misc_off_uart_reg.h>
	...
	#undef SERIAL_PORT_DFNS
		...
		#define SERIAL_PORT_DFNS    \
         ...
         { 0, (UART_CLOCK>>4), 0, IRQ_CEC, UPF_SHARE_IRQ|UPF_BOOT_AUTOCONF, 0, UPIO_MEM32, (unsigned char *)(GET_MAPPED_RBUS_ADDR(ISO_MISC_OFF_UART_U0RBR_THR_DLL_reg)), 2, IRQF_SHARED}, /* ttyS1 */
	#endif
#endif
