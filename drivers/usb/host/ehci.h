...
#define  MAX_QTD_TRACE_SIZE 256
struct ehci_qtd_log {
	struct timespec ts;
	unsigned int action;
	struct ehci_qtd snapshot_qtd;
};

struct qtd_trace {
	struct ehci_qtd_log qtd_logs[MAX_QTD_TRACE_SIZE];
	size_t max_qtd_trace_size;
	unsigned long qtd_count;
};
