...
typedef struct {
	unsigned int rtdlog_level;
	unsigned int rtdlog_module;
	unsigned int rtdlog_module_ex;
	unsigned int rtdlog_option;
} rtk_rtdlog_info_t;
...
typedef enum _RT_MSG {
...
#if 1 //#ifdef ENABLE_NIKE_UPGRADE
	RT_MSG_SI_NEED_UPGRADE,
#endif
	RT_MSG_SI_EMERGENCY_UPDATE,
	RT_MSG_SI_UNMATCH_CASID,
	RT_MSG_SI_NO_PROGRAM,
        RT_MSG_SI_CLEAR_STREAM,
	RT_MSG_SI_SERVICE_UPDATE,
#ifdef ENABLE_SYSTEM_SOFTWARE_UPDATE
	RT_MSG_SI_SSU_SWINFO_NOT_FOUND,
	RT_MSG_SI_SSU_SWINFO_READY,
	RT_MSG_SI_SSU_SW_VERIFY_ERROR,
	RT_MSG_SI_SSU_SW_DOWNLOAD_ERROR,
	RT_MSG_SI_SSU_SW_DOWNLOAD_UPDATE,
	RT_MSG_SI_SSU_SW_VERIFY_UPDATE,
	RT_MSG_SI_SSU_SW_DOWNLOAD_OK,
	RT_MSG_SI_SSU_BKGD_SCAN_FIND_IMAGE,
#endif
 ...
 //frank@0323 mark ap not process msg    RT_MSG_SLR_SEARCH_MODE,		//Gilbert ==> Mode Searching Message
...
#endif
	RT_MSG_AWB_MESSAGE,
#if defined ENABLE_NEW_DVB_2 || (defined BUILD_TV005_1_ATV) || (defined BUILD_TV005_1_ATSC)	 || defined(BUILD_TV008_2_ATV) // alex.lin 20120319 for audio software DD
	RT_MSG_MTS_DETECT,
...
#if (defined BUILD_TV013_1_ATV) || (defined BUILD_TV013_1_ISDB) || (defined BUILD_TV035_1_DTMB)
	//RT_MSG_RATIO_16_9_SETED,
	RT_MSG_EG_PIC_REFRESH,  //jacklong2012/08/14
#endif

#if defined(BUILD_TV015_1_ATV)||(defined BUILD_TV020_1_ATV)
	...
	RT_MSG_VERIFIER_OSD_UPDATE,

	RT_MSG_TV_SYSTEM_UPDATE,

	RT_MSG_BT_SCMST_MUTE,

	RT_MSG_FACTORY_MENU_AUTOUP,
	RT_MSG_FACTORY_MENU_AUTOEXIT,
	RT_MSG_UPDATE_STB_INFO,

    RT_MSG_DTV_CI_RESTART_CUR_CH,

#ifdef BUILD_TV015_2
	RT_MSG_ENTER_DFM_STATE,
	RT_MSG_EXIT_DFM_STATE,
#endif
} RT_MSG;
...
typedef enum _CI_MSG {
	...
	RT_MSG_CI_UPGRADE_PROGRESS = 4,
	RT_MSG_CI_AUTOTEST_MESSAGE_SHOWN = 5,
	RT_MSG_CI_OP_RESET_NOTIFY = 6
}CI_MSG;
