...
/*No need to define BOOT_MEMORY_START/BOOT_MEMORY_END. 
Use VBM overlay region for snapshot booting reserved area.
*/
#if 0
#define BOOT_MEMORY_START	(GAL_MEM_ADDR_START + GAL_MEM_SIZE)
#define BOOT_MEMORY_END		(GAL_MEM_ADDR_START + 0x10000000)
#endif
